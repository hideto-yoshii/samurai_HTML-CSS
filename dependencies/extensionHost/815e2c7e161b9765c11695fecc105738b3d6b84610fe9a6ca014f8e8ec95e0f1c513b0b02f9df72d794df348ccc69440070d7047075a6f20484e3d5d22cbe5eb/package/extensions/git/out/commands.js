...
class CreateBranchFromItem {
    ...
    get label() { return localize('create branch from', '$(plus) Create new branch from...'); }
    get description() { return ''; }
    get alwaysShow() { return true; }
    async run(repository) {
        await this.cc.branch(repository);
...
class AddRemoteItem {
    ...
    get label() { return localize('add remote', '$(plus) Add a new remote...'); }
    get description() { return ''; }
    get alwaysShow() { return true; }
    async run(repository) {
...
class TagItem {
    ...
    get label() { var _a; return _a = this.ref.name, (_a !== null && _a !== void 0 ? _a : ''); }
    get description() { var _a, _b; return _b = (_a = this.ref.commit) === null || _a === void 0 ? void 0 : _a.substr(0, 8), (_b !== null && _b !== void 0 ? _b : ''); }
}
var PushType;
(function (PushType) {
...
class CommandCenter {
    ...
    async smartCommit(repository, getCommitMessage, opts) {
        ...
        if (opts.all && config.get('smartCommitChanges') === 'tracked') {
            opts.all = 'tracked';
        }
    ...
    async promptForBranchName(defaultName) {
        const config = vscode_1.workspace.getConfiguration('git');
