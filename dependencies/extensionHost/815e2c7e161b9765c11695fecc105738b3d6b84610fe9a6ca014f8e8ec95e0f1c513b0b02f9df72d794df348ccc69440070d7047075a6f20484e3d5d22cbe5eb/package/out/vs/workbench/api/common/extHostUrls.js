    ...
    class ExtHostUrls {
        ...
        createAppUri(uri) {
            return __awaiter(this, void 0, void 0, function* () {
                return uri_1.URI.revive(yield this._proxy.$createAppUri(uri));
            });
        }
        proposedCreateAppUri(extensionId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                return uri_1.URI.revive(yield this._proxy.$proposedCreateAppUri(extensionId, options));
            });
        }
    }
