    ...
    class MainThreadTextEditorProperties {
        ...
        static _readOptionsFromCodeEditor(previousProperties, model, codeEditor) {
            ...
            if (codeEditor) {
                ...
                const lineNumbersOpts = options.get(47 /* lineNumbers */);
                cursorStyle = options.get(16 /* cursorStyle */);
