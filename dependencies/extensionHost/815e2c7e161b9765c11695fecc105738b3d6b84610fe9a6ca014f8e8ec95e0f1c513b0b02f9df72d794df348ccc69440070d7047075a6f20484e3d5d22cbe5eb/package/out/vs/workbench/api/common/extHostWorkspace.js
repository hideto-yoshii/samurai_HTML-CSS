...
define(["require", "exports", "vs/base/common/path", "vs/base/common/arrays", "vs/base/common/cancellation", "vs/base/common/event", "vs/base/common/map", "vs/base/common/numbers", "vs/base/common/resources", "vs/base/common/strings", "vs/base/common/uri", "vs/nls", "vs/platform/log/common/log", "vs/platform/notification/common/notification", "vs/workbench/services/search/common/search", "vs/platform/workspace/common/workspace", "vs/workbench/api/common/extHostTypes", "./extHost.protocol", "vs/base/common/async", "vs/base/common/network", "vs/base/common/types", "vs/workbench/api/common/extHostInitDataService", "vs/platform/instantiation/common/instantiation", "vs/workbench/api/common/extHostRpcService"], function (require, exports, path_1, arrays_1, cancellation_1, event_1, map_1, numbers_1, resources_1, strings_1, uri_1, nls_1, log_1, notification_1, search_1, workspace_1, extHostTypes_1, extHost_protocol_1, async_1, network_1, types_1, extHostInitDataService_1, instantiation_1, extHostRpcService_1) {
    "use strict";
    ...
    let ExtHostWorkspace = class ExtHostWorkspace {
        ...
        findFiles(include, exclude, maxResults, extensionId, token = cancellation_1.CancellationToken.None) {
            ...
            return this._proxy.$startFileSearch(types_1.withUndefinedAsNull(includePattern), types_1.withUndefinedAsNull(includeFolder), types_1.withUndefinedAsNull(excludePatternOrDisregardExcludes), types_1.withUndefinedAsNull(maxResults), token)
