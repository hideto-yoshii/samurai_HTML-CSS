...
define(["require", "exports", "vs/nls", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/common/objects", "vs/base/common/uri", "vs/editor/browser/services/bulkEditService", "vs/editor/browser/services/codeEditorService", "vs/platform/commands/common/commands", "vs/platform/editor/common/editor", "vs/platform/opener/common/opener", "vs/workbench/api/common/extHost.protocol", "vs/workbench/api/common/shared/editor", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService"], function (require, exports, nls_1, errors_1, lifecycle_1, objects_1, uri_1, bulkEditService_1, codeEditorService_1, commands_1, editor_1, opener_1, extHost_protocol_1, editor_2, editorService_1, editorGroupsService_1) {
    "use strict";
    ...
    let MainThreadTextEditors = class MainThreadTextEditors {
        ...
        _getTextEditorPositionData() {
            ...
            for (let workbenchEditor of this._editorService.visibleControls) {
                ...
                if (id) {
                    result[id] = editor_2.editorGroupToViewColumn(this._editorGroupService, workbenchEditor.group);
                }
            }
            return result;
        }
        ...
        $tryShowTextDocument(resource, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const editor = yield this._editorService.openEditor(input, editor_2.viewColumnToEditorGroup(this._editorGroupService, options.position));
                if (!editor) {
                    return undefined;
                }
