        ...
        reveal(treeView, dataProvider, itemIn, parentChain, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (const parent of parentChain) {
                    ...
                    if (parentItem) {
                        yield treeView.expand(parentItem);
                    }
                }
