...
define(["require", "exports", "assert", "vs/base/common/errors", "vs/base/common/objects", "vs/workbench/contrib/search/browser/openFileHandler", "vs/base/test/common/utils"], function (require, exports, assert, errors, objects, openFileHandler_1, utils_1) {
    "use strict";
    ...
    suite('CacheState', () => {
        test('reuse old cacheKey until new cache is loaded', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield cache.loading[firstKey].complete(null);
        ...
        test('keep using old cacheKey when loading fails', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    yield cache.loading[secondKey].error('loading failed');
                }
                finally {
                ...
                yield cache.loading[thirdKey].complete(null);
                assert.strictEqual(third.isLoaded, true);
                assert.strictEqual(third.isUpdating, false);
                assert.strictEqual(Object.keys(cache.loading).length, 3);
                yield cache.awaitDisposal(2);
                assert.strictEqual(third.cacheKey, thirdKey); // recover with next successful load
            });
        });
        function createCacheState(cache, previous) {
            return new openFileHandler_1.CacheState(cacheKey => cache.query(cacheKey), query => cache.load(query), cacheKey => cache.dispose(cacheKey), previous);
        }
        class MockCache {
            constructor() {
                this.cacheKeys = [];
            ...
            load(query) {
                const promise = new utils_1.DeferredPromise();
...
//# sourceMappingURL=openFileHandler.test.js.map