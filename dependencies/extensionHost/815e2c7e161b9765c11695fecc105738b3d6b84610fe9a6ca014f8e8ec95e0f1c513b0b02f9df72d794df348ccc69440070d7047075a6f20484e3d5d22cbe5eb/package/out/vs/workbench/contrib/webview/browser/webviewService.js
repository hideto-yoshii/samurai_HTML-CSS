...
define(["require", "exports", "vs/platform/instantiation/common/extensions", "vs/platform/instantiation/common/instantiation", "vs/workbench/contrib/webview/browser/webview", "vs/workbench/contrib/webview/browser/webviewElement", "vs/workbench/contrib/webview/common/themeing", "./dynamicWebviewEditorOverlay"], function (require, exports, extensions_1, instantiation_1, webview_1, webviewElement_1, themeing_1, dynamicWebviewEditorOverlay_1) {
    "use strict";
    ...
    let WebviewService = class WebviewService {
        ...
        createWebview(id, options, contentOptions) {
            return this._instantiationService.createInstance(webviewElement_1.IFrameWebview, id, options, contentOptions, this._webviewThemeDataProvider);
        }
