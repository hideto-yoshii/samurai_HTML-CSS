...
define(["require", "exports", "vs/nls", "vs/base/common/types", "vs/base/common/platform", "vs/base/common/extpath", "vs/base/common/path", "vs/base/common/resources", "vs/base/common/errorMessage", "vs/base/common/strings", "vs/base/common/actions", "vs/base/common/lifecycle", "vs/workbench/contrib/files/common/files", "vs/workbench/services/textfile/common/textfiles", "vs/platform/files/common/files", "vs/workbench/common/editor", "vs/workbench/services/untitled/common/untitledEditorService", "vs/platform/quickOpen/common/quickOpen", "vs/workbench/services/viewlet/browser/viewlet", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/host/browser/host", "vs/workbench/contrib/files/browser/fileCommands", "vs/editor/common/services/resolverService", "vs/platform/configuration/common/configuration", "vs/platform/clipboard/common/clipboardService", "vs/editor/common/services/modeService", "vs/editor/common/services/modelService", "vs/platform/commands/common/commands", "vs/platform/list/browser/listService", "vs/platform/contextkey/common/contextkey", "vs/base/common/network", "vs/platform/dialogs/common/dialogs", "vs/platform/notification/common/notification", "vs/workbench/services/editor/common/editorService", "vs/workbench/browser/parts/editor/editorCommands", "vs/base/common/arrays", "vs/workbench/contrib/files/common/explorerModel", "vs/base/common/errors", "vs/base/browser/dom", "vs/base/common/labels", "vs/css!./media/fileactions"], function (require, exports, nls, types, platform_1, extpath, path_1, resources, errorMessage_1, strings, actions_1, lifecycle_1, files_1, textfiles_1, files_2, editor_1, untitledEditorService_1, quickOpen_1, viewlet_1, instantiation_1, host_1, fileCommands_1, resolverService_1, configuration_1, clipboardService_1, modeService_1, modelService_1, commands_1, listService_1, contextkey_1, network_1, dialogs_1, notification_1, editorService_1, editorCommands_1, arrays_1, explorerModel_1, errors_1, dom_1, labels_1) {
    ...
    function deleteFiles(textFileService, dialogService, configurationService, fileService, elements, useTrash, skipConfirm = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (dirty.length) {
                ...
                const response = yield dialogService.confirm({
                    message,
                    type: 'warning',
                ...
                if (!response.confirmed) {
                    ...
                    skipConfirm = true;
                    yield textFileService.revertAll(dirty);
                }
            }
        ...
        run() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (activeResource) {
                    ...
                    // Bring up quick open
                    yield this.quickOpenService.show('', { autoFocus: { autoFocusSecondEntry: true } });
    ...
    let CollapseExplorerView = class CollapseExplorerView extends actions_1.Action {
        ...
        run() {
            return __awaiter(this, void 0, void 0, function* () {
                const explorerViewlet = yield this.viewletService.openViewlet(files_1.VIEWLET_ID);
    ...
    function validateFileName(item, name) {
        ...
        if (name !== item.name) {
            ...
            const child = (_a = parent) === null || _a === void 0 ? void 0 : _a.getChild(name);
            if (child && child !== item) {
    ...
    function trimLongName(name) {
        var _a;
        if (((_a = name) === null || _a === void 0 ? void 0 : _a.length) > 255) {
    ...
    commands_1.CommandsRegistry.registerCommand({
        ...
        handler: (accessor) => __awaiter(void 0, void 0, void 0, function* () {
            yield openExplorerAndCreate(accessor, false);
        })
    });
    commands_1.CommandsRegistry.registerCommand({
        id: exports.NEW_FOLDER_COMMAND_ID,
        handler: (accessor) => __awaiter(void 0, void 0, void 0, function* () {
            yield openExplorerAndCreate(accessor, true);
        })
    });
    ...
    const downloadFileHandler = (accessor) => {
        ...
        if (explorerContext.stat) {
            const stats = explorerContext.selection.length > 1 ? explorerContext.selection : [explorerContext.stat];
            stats.forEach((s) => __awaiter(void 0, void 0, void 0, function* () {
                if (platform_1.isWeb) {
                    if (!s.isDirectory) {
                        dom_1.triggerDownload(dom_1.asDomUri(s.resource), s.name);
                    }
                }
                else {
                    ...
                    const destination = yield fileDialogService.showSaveDialog({
                    ...
                    if (destination) {
                        yield fileService.copy(s.resource, destination);
                    }
                }
            }));
        }
    ...
    exports.pasteFileHandler = (accessor) => __awaiter(void 0, void 0, void 0, function* () {
        const listService = accessor.get(listService_1.IListService);
        ...
        if (listService.lastFocusedList) {
            ...
            const stats = yield Promise.all(toPaste.map((fileToPaste) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    exports.openFilePreserveFocusHandler = (accessor) => __awaiter(void 0, void 0, void 0, function* () {
        const listService = accessor.get(listService_1.IListService);
        const editorService = accessor.get(editorService_1.IEditorService);
        if (listService.lastFocusedList) {
            const explorerContext = getContext(listService.lastFocusedList);
