        ...
        run(accessor, editor) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (editor.hasModel() && position) {
                    ...
                    if (!bpExists) {
                        const breakpoints = yield debugService.addBreakpoints(uri, [{ lineNumber: position.lineNumber, column: position.column }], 'debugEditorActions.runToCursorAction');
                        if (breakpoints && breakpoints.length) {
                            breakpointToRemove = breakpoints[0];
                        }
                    }
                    yield debugService.getViewModel().focusedThread.continue();
                }
            });
        }
    }
    ...
    class SelectionToWatchExpressionsAction extends editorExtensions_1.EditorAction {
        ...
        run(accessor, editor) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const text = editor.getModel().getValueInRange(editor.getSelection());
                yield viewletService.openViewlet(debug_1.VIEWLET_ID);
