 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/strings", "vs/base/common/platform", "vs/nls"], function (require, exports, strings_1, platform_1, nls_1) {
    "use strict";
...
<div class="welcomePageContainer">
	<div class="welcomePage">
		<div class="title">
			<h1 class="caption">${strings_1.escape(platform_1.isWeb ? nls_1.localize('welcomePage.vsonline', "Visual Studio Online") : nls_1.localize('welcomePage.vscode', "Visual Studio Code"))}</h1>
