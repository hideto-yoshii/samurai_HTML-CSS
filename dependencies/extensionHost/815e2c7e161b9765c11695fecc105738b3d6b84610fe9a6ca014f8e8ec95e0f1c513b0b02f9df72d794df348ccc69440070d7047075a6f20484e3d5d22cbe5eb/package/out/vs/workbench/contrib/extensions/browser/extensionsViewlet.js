...
define(["require", "exports", "vs/nls", "vs/base/common/async", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/services/viewlet/browser/viewlet", "vs/base/browser/dom", "vs/platform/telemetry/common/telemetry", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/extensions/common/extensions", "../common/extensions", "vs/workbench/contrib/extensions/browser/extensionsActions", "vs/platform/extensionManagement/common/extensionManagement", "vs/workbench/services/extensionManagement/common/extensionManagement", "vs/workbench/contrib/extensions/common/extensionsInput", "vs/workbench/contrib/extensions/browser/extensionsViews", "vs/workbench/contrib/preferences/browser/preferencesActions", "vs/platform/progress/common/progress", "vs/workbench/services/editor/common/editorGroupsService", "vs/base/common/severity", "vs/workbench/services/activity/common/activity", "vs/platform/theme/common/themeService", "vs/platform/configuration/common/configuration", "vs/workbench/common/views", "vs/platform/storage/common/storage", "vs/platform/workspace/common/workspace", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/platform/extensionManagement/common/extensionManagementUtil", "vs/platform/log/common/log", "vs/platform/notification/common/notification", "vs/workbench/services/host/browser/host", "vs/workbench/services/layout/browser/layoutService", "vs/workbench/contrib/extensions/common/extensionQuery", "vs/workbench/contrib/codeEditor/browser/suggestEnabledInput/suggestEnabledInput", "vs/base/browser/ui/aria/aria", "vs/base/common/errorsWithActions", "vs/platform/environment/common/environment", "vs/platform/registry/common/platform", "vs/workbench/browser/parts/views/viewsViewlet", "vs/workbench/browser/contextkeys", "vs/platform/label/common/label", "vs/css!./media/extensionsViewlet"], function (require, exports, nls_1, async_1, errors_1, lifecycle_1, event_1, actionbar_1, viewlet_1, dom_1, telemetry_1, instantiation_1, extensions_1, extensions_2, extensionsActions_1, extensionManagement_1, extensionManagement_2, extensionsInput_1, extensionsViews_1, preferencesActions_1, progress_1, editorGroupsService_1, severity_1, activity_1, themeService_1, configuration_1, views_1, storage_1, workspace_1, contextkey_1, contextView_1, extensionManagementUtil_1, log_1, notification_1, host_1, layoutService_1, extensionQuery_1, suggestEnabledInput_1, aria_1, errorsWithActions_1, environment_1, platform_1, viewsViewlet_1, contextkeys_1, label_1) {
    ...
    let ExtensionsViewletViewsContribution = class ExtensionsViewletViewsContribution {
        constructor(extensionManagementServerService, labelService) {
        ...
        createExtensionsViewDescriptorsForServer(server) {
            ...
            return [{
                    ...
                    ctorDescriptor: { ctor: extensionsViews_1.ServerExtensionsView, arguments: [server, event_1.Event.map(onDidChangeServerLabel, () => getInstalledViewName())] },
                    ...
                    ctorDescriptor: { ctor: extensionsViews_1.ServerExtensionsView, arguments: [server, event_1.Event.map(onDidChangeServerLabel, () => getOutdatedViewName())] },
    ...
    let StatusUpdater = class StatusUpdater extends lifecycle_1.Disposable {
        ...
        onServiceChange() {
            ...
            if (outdated > 0) {
                ...
                this.badgeHandle.value = this.activityService.showActivity(extensions_2.VIEWLET_ID, badge, 'extensions-badge count-badge');
            }
        }
    };
