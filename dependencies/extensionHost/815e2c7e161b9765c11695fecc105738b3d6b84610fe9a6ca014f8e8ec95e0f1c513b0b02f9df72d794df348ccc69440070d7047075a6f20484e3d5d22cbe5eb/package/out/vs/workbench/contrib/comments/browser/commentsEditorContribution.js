...
define(["require", "exports", "vs/base/browser/dom", "vs/base/common/actions", "vs/base/common/arrays", "vs/base/common/async", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/editor/browser/editorBrowser", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/editor/contrib/referenceSearch/referencesWidget", "vs/nls", "vs/platform/commands/common/commands", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybindingsRegistry", "vs/platform/quickinput/common/quickInput", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/workbench/common/theme", "vs/workbench/contrib/comments/browser/commentGlyphWidget", "vs/workbench/contrib/comments/browser/commentService", "vs/workbench/contrib/comments/browser/commentThreadWidget", "vs/workbench/contrib/comments/browser/simpleCommentEditor", "vs/workbench/services/editor/common/editorService", "vs/editor/browser/widget/embeddedCodeEditorWidget", "vs/css!./media/review"], function (require, exports, dom_1, actions_1, arrays_1, async_1, errors_1, lifecycle_1, editorBrowser_1, editorExtensions_1, codeEditorService_1, range_1, textModel_1, modes, referencesWidget_1, nls, commands_1, contextView_1, instantiation_1, keybindingsRegistry_1, quickInput_1, colorRegistry_1, themeService_1, theme_1, commentGlyphWidget_1, commentService_1, commentThreadWidget_1, simpleCommentEditor_1, editorService_1, embeddedCodeEditorWidget_1) {
    ...
    let CommentController = class CommentController {
        ...
        onModelChanged(e) {
            ...
            this.localToDispose.add(this.editor.onDidChangeModelContent(() => __awaiter(this, void 0, void 0, function* () {
                this.beginComputeCommentingRanges();
            })));
            this.localToDispose.add(this.commentService.onDidUpdateCommentThreads((e) => __awaiter(this, void 0, void 0, function* () {
                const editorURI = this.editor && this.editor.hasModel() && this.editor.getModel().uri;
                if (!editorURI) {
                    return;
                }
                if (this._computePromise) {
                    yield this._computePromise;
                }
        ...
        addOrToggleCommentAtLine(lineNumber, e) {
