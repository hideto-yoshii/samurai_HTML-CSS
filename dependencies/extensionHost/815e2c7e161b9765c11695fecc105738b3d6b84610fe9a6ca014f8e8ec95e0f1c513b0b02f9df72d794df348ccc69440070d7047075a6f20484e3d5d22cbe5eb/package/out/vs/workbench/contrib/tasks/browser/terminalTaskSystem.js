    ...
    class TerminalTaskSystem {
        ...
        resolveVariablesFromSet(taskSystemInfo, workspaceFolder, task, variables) {
            ...
            if (taskSystemInfo && workspaceFolder) {
                ...
                resolvedVariables = taskSystemInfo.resolveVariables(workspaceFolder, resolveSet).then((resolved) => __awaiter(this, void 0, void 0, function* () {
                    if (isProcess) {
                        let process = tasks_1.CommandString.value(task.command.name);
                        if (taskSystemInfo.platform === 3 /* Windows */) {
                            process = yield this.resolveAndFindExecutable(workspaceFolder, task, cwd, envPath);
                        }
                        ...
                        if (resolvedVariablesMap) {
                            if (isProcess) {
                                ...
                                if (Platform.isWindows) {
                                    processVarValue = yield this.resolveAndFindExecutable(workspaceFolder, task, cwd, envPath);
                                }
                                else {
        ...
        createShellLaunchConfig(task, workspaceFolder, variableResolver, platform, options, command, args, waitOnExit) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (isShellCommand) {
                    const defaultConfig = variableResolver.taskSystemInfo ? yield variableResolver.taskSystemInfo.getDefaultShellAndArgs() : yield this.terminalInstanceService.getDefaultShellAndArgs(true, platform);
        ...
        fileExists(path) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (yield this.fileService.exists(uri)) {
                    return !((yield this.fileService.resolve(uri)).isDirectory);
                }
                return false;
            });
        }
        findExecutable(command, cwd, paths) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (let pathEntry of paths) {
                    ...
                    if (yield this.fileExists(withExtension)) {
