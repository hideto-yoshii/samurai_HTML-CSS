...
define(["require", "exports", "vs/platform/configuration/common/configuration", "vs/platform/instantiation/common/instantiation", "vs/workbench/contrib/webview/browser/dynamicWebviewEditorOverlay", "vs/workbench/contrib/webview/browser/webviewElement", "vs/workbench/contrib/webview/common/themeing", "vs/workbench/contrib/webview/electron-browser/webviewElement"], function (require, exports, configuration_1, instantiation_1, dynamicWebviewEditorOverlay_1, webviewElement_1, themeing_1, webviewElement_2) {
    "use strict";
    ...
    let ElectronWebviewService = class ElectronWebviewService {
        constructor(_instantiationService, _configService) {
            ...
            this.webviewThemeDataProvider = this._instantiationService.createInstance(themeing_1.WebviewThemeDataProvider);
        }
        createWebview(id, options, contentOptions) {
            ...
            if (useExternalEndpoint) {
                return this._instantiationService.createInstance(webviewElement_1.IFrameWebview, id, options, contentOptions, this.webviewThemeDataProvider);
            }
            else {
                return this._instantiationService.createInstance(webviewElement_2.ElectronWebviewBasedWebview, id, options, contentOptions, this.webviewThemeDataProvider);
            }
        }
