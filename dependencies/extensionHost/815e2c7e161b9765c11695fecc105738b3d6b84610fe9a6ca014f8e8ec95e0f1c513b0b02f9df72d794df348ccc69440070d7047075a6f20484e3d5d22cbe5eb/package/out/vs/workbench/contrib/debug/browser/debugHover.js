    ...
    let DebugHoverWidget = class DebugHoverWidget {
        ...
        showAt(range, focus) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (session.capabilities.supportsEvaluateForHovers) {
                    ...
                    yield expression.evaluate(session, this.debugService.getViewModel().focusedStackFrame, 'hover');
                }
                else {
                    expression = yield this.findExpressionInStackFrame(arrays_1.coalesce(matchingExpression.split('.').map(word => word.trim())));
                }
        ...
        doFindExpression(container, namesToFind) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const children = yield container.getChildren();
        ...
        findExpressionInStackFrame(namesToFind) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const expressions = arrays_1.coalesce(yield Promise.all(nonExpensive.map(scope => this.doFindExpression(scope, namesToFind))));
        ...
        doShow(position, expression, focus, forceValueHover = false) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.tree.setInput(expression);
