...
define(["require", "exports", "vs/nls", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/config/editorOptions", "vs/editor/common/services/resourceConfiguration", "vs/platform/actions/common/actions", "vs/platform/contextkey/common/contextkey", "vs/platform/notification/common/notification", "vs/workbench/contrib/preferences/browser/preferencesEditor", "vs/base/common/amd"], function (require, exports, nls, lifecycle_1, uri_1, editorExtensions_1, codeEditorService_1, editorOptions_1, resourceConfiguration_1, actions_1, contextkey_1, notification_1, preferencesEditor_1, amd_1) {
    ...
    function toggleWordWrap(editor, state) {
        ...
        let transientState;
        const actualWrappingInfo = editor.getOption(103 /* wrappingInfo */);
    ...
    class ToggleWordWrapAction extends editorExtensions_1.EditorAction {
        ...
        run(accessor, editor) {
            ...
            if (editor.getOption(42 /* inDiffEditor */)) {
    ...
    let ToggleWordWrapController = class ToggleWordWrapController extends lifecycle_1.Disposable {
        constructor(editor, contextKeyService, configurationService, codeEditorService) {
            ...
            const inDiffEditor = this.contextKeyService.createKey(inDiffEditorKey, options.get(42 /* inDiffEditor */));
            let currentlyApplyingEditorConfig = false;
            this._register(editor.onDidChangeConfiguration((e) => {
                if (!e.hasChanged(103 /* wrappingInfo */) && !e.hasChanged(42 /* inDiffEditor */)) {
                    return;
                }
                const options = this.editor.getOptions();
                const wrappingInfo = options.get(103 /* wrappingInfo */);
                ...
                inDiffEditor.set(options.get(42 /* inDiffEditor */));
            ...
            const ensureWordWrapSettings = () => {
                ...
                if (this.editor.getOption(42 /* inDiffEditor */)) {
                    return;
                }
    ...
    const WORD_WRAP_DARK_ICON = uri_1.URI.parse(amd_1.registerAndGetAmdImageURL('vs/workbench/contrib/codeEditor/browser/word-wrap-dark.svg'));
    const WORD_WRAP_LIGHT_ICON = uri_1.URI.parse(amd_1.registerAndGetAmdImageURL('vs/workbench/contrib/codeEditor/browser/word-wrap-light.svg'));
