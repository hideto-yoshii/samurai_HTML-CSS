...
define(["require", "exports", "vs/base/browser/ui/aria/aria", "vs/nls", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/browser/ui/splitview/splitview", "vs/workbench/services/layout/browser/layoutService", "vs/platform/instantiation/common/instantiation", "vs/workbench/contrib/terminal/browser/terminal"], function (require, exports, aria, nls, event_1, lifecycle_1, splitview_1, layoutService_1, instantiation_1, terminal_1) {
    "use strict";
    ...
    let TerminalTab = class TerminalTab extends lifecycle_1.Disposable {
        constructor(terminalFocusContextKey, configHelper, _container, shellLaunchConfigOrInstance, _terminalService, _layoutService, _instantiationService) {
            super();
            this._container = _container;
