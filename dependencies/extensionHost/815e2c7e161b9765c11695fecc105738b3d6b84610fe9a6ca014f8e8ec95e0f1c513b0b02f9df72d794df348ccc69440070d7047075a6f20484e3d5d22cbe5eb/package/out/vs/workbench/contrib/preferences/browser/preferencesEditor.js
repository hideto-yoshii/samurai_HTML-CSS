...
define(["require", "exports", "vs/base/browser/dom", "vs/base/browser/ui/splitview/splitview", "vs/base/browser/ui/widget", "vs/base/common/arrays", "vs/base/common/async", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/iterator", "vs/base/common/lifecycle", "vs/base/common/strings", "vs/base/common/uri", "vs/editor/browser/editorExtensions", "vs/editor/browser/widget/codeEditorWidget", "vs/editor/common/services/resourceConfiguration", "vs/editor/contrib/find/findController", "vs/editor/contrib/folding/folding", "vs/editor/contrib/message/messageController", "vs/editor/contrib/multicursor/multicursor", "vs/nls", "vs/platform/contextkey/common/contextkey", "vs/platform/instantiation/common/instantiation", "vs/platform/log/common/log", "vs/platform/progress/common/progress", "vs/platform/registry/common/platform", "vs/platform/storage/common/storage", "vs/platform/telemetry/common/telemetry", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/styler", "vs/platform/theme/common/themeService", "vs/platform/workspace/common/workspace", "vs/workbench/browser/editor", "vs/workbench/browser/parts/editor/baseEditor", "vs/workbench/browser/parts/editor/textEditor", "vs/workbench/contrib/preferences/browser/preferencesRenderers", "vs/workbench/contrib/preferences/browser/preferencesWidgets", "vs/workbench/contrib/preferences/common/preferences", "vs/workbench/services/editor/common/editorService", "vs/workbench/services/editor/common/editorGroupsService", "vs/workbench/services/preferences/common/preferences", "vs/workbench/services/preferences/common/preferencesModels", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/host/browser/host", "vs/base/common/types"], function (require, exports, DOM, splitview_1, widget_1, arrays, async_1, cancellation_1, errors_1, event_1, iterator_1, lifecycle_1, strings, uri_1, editorExtensions_1, codeEditorWidget_1, resourceConfiguration_1, findController_1, folding_1, messageController_1, multicursor_1, nls, contextkey_1, instantiation_1, log_1, progress_1, platform_1, storage_1, telemetry_1, colorRegistry_1, styler_1, themeService_1, workspace_1, editor_1, baseEditor_1, textEditor_1, preferencesRenderers_1, preferencesWidgets_1, preferences_1, editorService_1, editorGroupsService_1, preferences_2, preferencesModels_1, textfiles_1, host_1, types_1) {
        ...
        getPreferencesEditorModel(target) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!this._prefsModelsForSearch.has(targetKey)) {
                    try {
                        const model = yield this.preferencesService.createPreferencesEditorModel(resource);
                        if (model) {
    ...
    let DefaultPreferencesEditor = class DefaultPreferencesEditor extends textEditor_1.BaseTextEditor {
        constructor(telemetryService, instantiationService, storageService, configurationService, themeService, textFileService, editorGroupService, editorService, hostService) {
