...
define(["require", "exports", "crypto", "vs/platform/files/common/files", "vs/platform/workspace/common/workspace", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/host/browser/host", "vs/platform/notification/common/notification", "vs/platform/quickinput/common/quickInput", "vs/workbench/services/textfile/common/textfiles", "vs/base/common/network", "vs/platform/workspaces/common/workspaces", "vs/nls", "vs/base/common/severity", "vs/base/common/resources", "vs/platform/instantiation/common/extensions", "vs/workbench/contrib/stats/common/workspaceStats", "vs/workbench/contrib/stats/electron-browser/workspaceStats", "vs/platform/product/common/productService"], function (require, exports, crypto, files_1, workspace_1, environmentService_1, host_1, notification_1, quickInput_1, textfiles_1, network_1, workspaces_1, nls_1, severity_1, resources_1, extensions_1, workspaceStats_1, workspaceStats_2, productService_1) {
    "use strict";
    ...
    let WorkspaceStatsService = class WorkspaceStatsService {
        constructor(fileService, contextService, environmentService, productService, hostService, notificationService, quickInputService, textFileService) {
        ...
        getTags() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!this._tags) {
                    this._tags = yield this.resolveWorkspaceTags(this.environmentService.configuration, rootFiles => this.handleWorkspaceFiles(rootFiles));
                }
                return this._tags;
            });
        }
        ...
        getHashedRemotesFromUri(workspaceUri, stripEndingDotGit = false) {
            ...
            return this.fileService.exists(uri).then(exists => {
                ...
                return this.textFileService.read(uri, { acceptTextOnly: true }).then(content => workspaceStats_2.getHashedRemotesFromConfig(content.value, stripEndingDotGit), err => [] // ignore missing or binary file
                );
            });
        }
        /* __GDPR__FRAGMENT__
        ...
        */
        ...
        doHandleWorkspaceFiles(folder, workspaces) {
            ...
            if (workspaces.length === 1) {
                ...
                this.notificationService.prompt(severity_1.default.Info, nls_1.localize('workspaceFound', "This folder contains a workspace file '{0}'. Do you want to open it? [Learn more]({1}) about workspace files.", workspaceFile, 'https://go.microsoft.com/fwlink/?linkid=2025315'), [{
                        label: nls_1.localize('openWorkspace', "Open Workspace"),
                        run: () => this.hostService.openWindow([{ workspaceUri: resources_1.joinPath(folder, workspaceFile) }])
                    }], { neverShowAgain });
            }
            // Prompt to select a workspace from many
            else if (workspaces.length > 1) {
                this.notificationService.prompt(severity_1.default.Info, nls_1.localize('workspacesFound', "This folder contains multiple workspace files. Do you want to open one? [Learn more]({0}) about workspace files.", 'https://go.microsoft.com/fwlink/?linkid=2025315'), [{
                        ...
                        run: () => {
                            this.quickInputService.pick(workspaces.map(workspace => ({ label: workspace })), { placeHolder: nls_1.localize('selectToOpen', "Select a workspace to open") }).then(pick => {
                                if (pick) {
                                    this.hostService.openWindow([{ workspaceUri: resources_1.joinPath(folder, pick.label) }]);
                                }
                            });
                        }
                    }], { neverShowAgain });
        ...
        findFolder({ filesToOpenOrCreate, filesToDiff }) {
    ...
    WorkspaceStatsService = __decorate([
    ...
    extensions_1.registerSingleton(workspaceStats_1.IWorkspaceStatsService, WorkspaceStatsService, true);
});
