...
define(["require", "exports", "vs/base/browser/dom", "vs/base/common/glob", "vs/platform/progress/common/progress", "vs/platform/notification/common/notification", "vs/platform/files/common/files", "vs/workbench/services/layout/browser/layoutService", "vs/platform/workspace/common/workspace", "vs/base/common/lifecycle", "vs/platform/contextview/browser/contextView", "vs/platform/theme/common/themeService", "vs/platform/configuration/common/configuration", "vs/workbench/contrib/files/common/files", "vs/base/common/resources", "vs/base/browser/ui/inputbox/inputBox", "vs/nls", "vs/platform/theme/common/styler", "vs/base/common/functional", "vs/base/common/objects", "vs/base/common/path", "vs/workbench/contrib/files/common/explorerModel", "vs/base/common/comparers", "vs/workbench/browser/dnd", "vs/platform/instantiation/common/instantiation", "vs/base/browser/dnd", "vs/base/common/network", "vs/base/browser/ui/list/listView", "vs/base/common/platform", "vs/platform/dialogs/common/dialogs", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/host/browser/host", "vs/workbench/services/workspaces/common/workspaceEditing", "vs/base/common/async", "vs/workbench/services/editor/common/editorService", "vs/workbench/contrib/files/browser/fileActions", "vs/base/common/filters", "vs/base/common/event", "vs/base/common/buffer"], function (require, exports, DOM, glob, progress_1, notification_1, files_1, layoutService_1, workspace_1, lifecycle_1, contextView_1, themeService_1, configuration_1, files_2, resources_1, inputBox_1, nls_1, styler_1, functional_1, objects_1, path, explorerModel_1, comparers_1, dnd_1, instantiation_1, dnd_2, network_1, listView_1, platform_1, dialogs_1, textfiles_1, host_1, workspaceEditing_1, async_1, editorService_1, fileActions_1, filters_1, event_1, buffer_1) {
    ...
    let FilesFilter = class FilesFilter {
        ...
        updateConfiguration() {
            ...
            this.contextService.getWorkspace().folders.forEach(folder => {
                ...
                const excludesConfig = ((_b = (_a = configuration) === null || _a === void 0 ? void 0 : _a.files) === null || _b === void 0 ? void 0 : _b.exclude) || Object.create(null);
                if (!needsRefresh) {
    ...
    let FileDragAndDrop = class FileDragAndDrop {
        constructor(notificationService, explorerService, editorService, dialogService, contextService, fileService, configurationService, instantiationService, textFileService, hostService, workspaceEditingService) {
            this.notificationService = notificationService;
            this.explorerService = explorerService;
                        ...
                        reader.onload = (event) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            if (typeof name === 'string' && ((_a = event.target) === null || _a === void 0 ? void 0 : _a.result) instanceof ArrayBuffer) {
                                if (target.getChild(name)) {
                                    const { confirmed } = yield this.dialogService.confirm(fileOverwriteConfirm);
                                    if (!confirmed) {
                                        return;
                                    }
                                }
                                const resource = resources_1.joinPath(target.resource, name);
                                yield this.fileService.writeFile(resource, buffer_1.VSBuffer.wrap(new Uint8Array((_b = event.target) === null || _b === void 0 ? void 0 : _b.result)));
                                if (data.files.length === 1) {
                                    yield this.editorService.openEditor({ resource, options: { pinned: true } });
                                }
                            }
                        });
                    });
        ...
        addResources(target, resources) {
            return __awaiter(this, void 0, void 0, function* () {
                if (resources && resources.length > 0) {
                    ...
                    const targetStat = yield this.fileService.resolve(target.resource);
                    ...
                    const resourceExists = resources.some(resource => targetNames.has(!resources_1.hasToIgnoreCase(resource) ? resources_1.basename(resource) : resources_1.basename(resource).toLowerCase()));
                    if (resourceExists) {
                        const confirmationResult = yield this.dialogService.confirm(fileOverwriteConfirm);
                    ...
                    resources.forEach(resource => {
                        addPromisesFactory.push(() => __awaiter(this, void 0, void 0, function* () {
                            ...
                            if (this.textFileService.isDirty(targetFile)) {
                                yield this.textFileService.revertAll([targetFile], { soft: true });
                            }
                            const copyTarget = resources_1.joinPath(target.resource, resources_1.basename(sourceFile));
                            const stat = yield this.fileService.copy(sourceFile, copyTarget, true);
                    ...
                    yield async_1.sequence(addPromisesFactory);
                }
            });
        }
        handleExplorerDrop(data, target, originalEvent) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (confirmDragAndDrop) {
                    const confirmation = yield this.dialogService.confirm({
                    ...
                    if (confirmation.checkboxChecked === true) {
                        yield this.configurationService.updateValue(FileDragAndDrop.CONFIRM_DND_SETTING_KEY, false, 1 /* USER */);
                    }
                }
                const rootDropPromise = this.doHandleRootDrop(items.filter(s => s.isRoot), target);
                yield Promise.all(items.filter(s => !s.isRoot).map(source => this.doHandleExplorerDrop(source, target, isCopy)).concat(rootDropPromise));
            });
        }
        ...
        doHandleExplorerDrop(source, target, isCopy) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (isCopy) {
                    ...
                    const stat = yield this.fileService.copy(source.resource, fileActions_1.findValidPasteFileTarget(target, { resource: source.resource, isDirectory: source.isDirectory, allowOverwrite: false }, incrementalNaming));
                    if (!stat.isDirectory) {
                        yield this.editorService.openEditor({ resource: stat.resource, options: { pinned: true } });
                    }
                    return;
                }
                // Otherwise move
                ...
                try {
                    yield this.textFileService.move(source.resource, targetResource);
                }
                catch (error) {
                    // Conflict
                    if (error.fileOperationResult === 4 /* FILE_MOVE_CONFLICT */) {
                        ...
                        const { confirmed } = yield this.dialogService.confirm(confirm);
                        if (confirmed) {
                            try {
                                yield this.textFileService.move(source.resource, targetResource, true /* overwrite */);
                            }
                            catch (error) {
