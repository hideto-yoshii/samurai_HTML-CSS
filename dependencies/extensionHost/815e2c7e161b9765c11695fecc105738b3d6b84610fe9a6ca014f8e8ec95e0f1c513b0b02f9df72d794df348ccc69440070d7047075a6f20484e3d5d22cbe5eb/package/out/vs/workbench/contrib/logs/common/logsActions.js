    ...
    let OpenWindowSessionLogFileAction = class OpenWindowSessionLogFileAction extends actions_1.Action {
        ...
        run() {
            return __awaiter(this, void 0, void 0, function* () {
                const sessionResult = yield this.quickInputService.pick(this.getSessions().then(sessions => sessions.map((s, index) => ({
                    id: s.toString(),
                ...
                if (sessionResult) {
                    const logFileResult = yield this.quickInputService.pick(this.getLogFiles(uri_1.URI.parse(sessionResult.id)).then(logFiles => logFiles.map(s => ({
                        id: s.toString(),
                        label: resources_1.basename(s)
                    }))), {
                        canPickMany: false,
        ...
        getSessions() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const stat = yield this.fileService.resolve(resources_1.dirname(logsPath));
                if (stat.children) {
        ...
        getLogFiles(session) {
            return __awaiter(this, void 0, void 0, function* () {
                const stat = yield this.fileService.resolve(session);
                if (stat.children) {
