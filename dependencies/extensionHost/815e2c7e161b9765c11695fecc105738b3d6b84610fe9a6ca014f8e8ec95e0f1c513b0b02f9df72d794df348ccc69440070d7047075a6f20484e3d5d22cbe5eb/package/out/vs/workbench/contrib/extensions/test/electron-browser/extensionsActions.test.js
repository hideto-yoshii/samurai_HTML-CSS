    ...
    suite('ExtensionsActions Test', () => {
        ...
        setup(() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            instantiationService.stub(extensionManagement_2.IExtensionManagementServerService, new class extends extensionManagementServerService_1.ExtensionManagementServerService {
                constructor() {
                    super(instantiationService.get(sharedProcessService_1.ISharedProcessService), instantiationService.get(remoteAgentService_1.IRemoteAgentService), instantiationService.get(extensionManagement_1.IExtensionGalleryService), instantiationService.get(configuration_1.IConfigurationService), instantiationService.get(productService_1.IProductService), instantiationService.get(log_1.ILogService), instantiationService.get(label_1.ILabelService));
        ...
        test('Test UpdateAction when extension is installed outdated and user extension', () => {
            ...
            const workbenchService = instantiationService.get(extensions_1.IExtensionsWorkbenchService);
            return workbenchService.queryLocal()
                .then((extensions) => __awaiter(void 0, void 0, void 0, function* () {
                testObject.extension = extensions[0];
                instantiationService.stubPromise(extensionManagement_1.IExtensionGalleryService, 'query', aPage(aGalleryExtension('a', { identifier: local.identifier, version: '1.0.1' })));
                assert.ok(!testObject.enabled);
        ...
        test('Test ReloadAction when extension state is installing', () => __awaiter(void 0, void 0, void 0, function* () {
            const testObject = instantiationService.createInstance(ExtensionsActions.ReloadAction);
            instantiationService.createInstance(extensions_1.ExtensionContainers, [testObject]);
            const workbenchService = instantiationService.get(extensions_1.IExtensionsWorkbenchService);
            const gallery = aGalleryExtension('a');
        ...
        test('Test ReloadAction when extension state is uninstalling', () => __awaiter(void 0, void 0, void 0, function* () {
            const testObject = instantiationService.createInstance(ExtensionsActions.ReloadAction);
            instantiationService.createInstance(extensions_1.ExtensionContainers, [testObject]);
            const local = aLocalExtension('a');
            instantiationService.stubPromise(extensionManagement_1.IExtensionManagementService, 'getInstalled', [local]);
        ...
        test('Test ReloadAction when extension is newly installed', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('Test ReloadAction when extension is newly installed and reload is not required', () => __awaiter(void 0, void 0, void 0, function* () {
            const onDidChangeExtensionsEmitter = new event_1.Emitter();
            const runningExtensions = [{ identifier: new extensions_3.ExtensionIdentifier('pub.b'), extensionLocation: uri_1.URI.file('pub.b') }];
            instantiationService.stub(extensions_2.IExtensionService, {
                getExtensions: () => Promise.resolve(runningExtensions),
        ...
        test('Test ReloadAction when extension is installed and uninstalled', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('Test ReloadAction when extension is uninstalled', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('Test ReloadAction when extension is uninstalled and can be removed', () => __awaiter(void 0, void 0, void 0, function* () {
            const local = aLocalExtension('a');
            instantiationService.stub(extensions_2.IExtensionService, {
        ...
        test('Test ReloadAction when extension is uninstalled and installed', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('Test ReloadAction when extension is updated while running', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('Test ReloadAction when extension is updated when not running', () => __awaiter(void 0, void 0, void 0, function* () {
            instantiationService.stubPromise(extensions_2.IExtensionService, 'getExtensions', [{ identifier: new extensions_3.ExtensionIdentifier('pub.b'), extensionLocation: uri_1.URI.file('pub.b') }]);
            const local = aLocalExtension('a', { version: '1.0.1' });
        ...
        test('Test ReloadAction when extension is disabled when running', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('Test ReloadAction when extension enablement is toggled when running', () => __awaiter(void 0, void 0, void 0, function* () {
            instantiationService.stubPromise(extensions_2.IExtensionService, 'getExtensions', [{ identifier: new extensions_3.ExtensionIdentifier('pub.a'), version: '1.0.0', extensionLocation: uri_1.URI.file('pub.a') }]);
            const testObject = instantiationService.createInstance(ExtensionsActions.ReloadAction);
            instantiationService.createInstance(extensions_1.ExtensionContainers, [testObject]);
            const local = aLocalExtension('a');
        ...
        test('Test ReloadAction when extension is enabled when not running', () => __awaiter(void 0, void 0, void 0, function* () {
            instantiationService.stubPromise(extensions_2.IExtensionService, 'getExtensions', [{ identifier: new extensions_3.ExtensionIdentifier('pub.b'), extensionLocation: uri_1.URI.file('pub.b') }]);
            const local = aLocalExtension('a');
            yield instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([local], 2 /* DisabledGlobally */);
            const testObject = instantiationService.createInstance(ExtensionsActions.ReloadAction);
        ...
        test('Test ReloadAction when extension enablement is toggled when not running', () => __awaiter(void 0, void 0, void 0, function* () {
            instantiationService.stubPromise(extensions_2.IExtensionService, 'getExtensions', [{ identifier: new extensions_3.ExtensionIdentifier('pub.b'), extensionLocation: uri_1.URI.file('pub.b') }]);
            const local = aLocalExtension('a');
            yield instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([local], 2 /* DisabledGlobally */);
            const testObject = instantiationService.createInstance(ExtensionsActions.ReloadAction);
        ...
        test('Test ReloadAction when extension is updated when not running and enabled', () => __awaiter(void 0, void 0, void 0, function* () {
            instantiationService.stubPromise(extensions_2.IExtensionService, 'getExtensions', [{ identifier: new extensions_3.ExtensionIdentifier('pub.b'), extensionLocation: uri_1.URI.file('pub.b') }]);
            const local = aLocalExtension('a', { version: '1.0.1' });
            yield instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([local], 2 /* DisabledGlobally */);
            const testObject = instantiationService.createInstance(ExtensionsActions.ReloadAction);
        ...
        test('Test ReloadAction when a localization extension is newly installed', () => __awaiter(void 0, void 0, void 0, function* () {
            instantiationService.stubPromise(extensions_2.IExtensionService, 'getExtensions', [{ identifier: new extensions_3.ExtensionIdentifier('pub.b'), extensionLocation: uri_1.URI.file('pub.b') }]);
            const testObject = instantiationService.createInstance(ExtensionsActions.ReloadAction);
            instantiationService.createInstance(extensions_1.ExtensionContainers, [testObject]);
            const gallery = aGalleryExtension('a');
        ...
        test('Test ReloadAction when a localization extension is updated while running', () => __awaiter(void 0, void 0, void 0, function* () {
            instantiationService.stubPromise(extensions_2.IExtensionService, 'getExtensions', [{ identifier: new extensions_3.ExtensionIdentifier('pub.a'), version: '1.0.1', extensionLocation: uri_1.URI.file('pub.a') }]);
            const testObject = instantiationService.createInstance(ExtensionsActions.ReloadAction);
            instantiationService.createInstance(extensions_1.ExtensionContainers, [testObject]);
        ...
        test('Test ReloadAction when extension is not installed but extension from different server is installed and running', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const gallery = aGalleryExtension('a');
        ...
        test('Test ReloadAction when extension is uninstalled but extension from different server is installed and running', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const gallery = aGalleryExtension('a');
            const localExtension = aLocalExtension('a', { extensionKind: 'workspace' }, { location: uri_1.URI.file('pub.a') });
            const remoteExtension = aLocalExtension('a', { extensionKind: 'workspace' }, { location: uri_1.URI.file('pub.a').with({ scheme: network_1.Schemas.vscodeRemote }) });
        ...
        test('Test ReloadAction when workspace extension is disabled on local server and installed in remote server', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const gallery = aGalleryExtension('a');
        ...
        test('Test ReloadAction is disabled when remote ui extension is installed in local server', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const gallery = aGalleryExtension('a');
        ...
        test('Test ReloadAction for remote ui extension is disabled when it is installed and enabled in local server', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const gallery = aGalleryExtension('a');
            const localExtension = aLocalExtension('a', { extensionKind: 'ui' }, { location: uri_1.URI.file('pub.a') });
            const localExtensionManagementService = createExtensionManagementService([localExtension]);
        ...
        test('Test ReloadAction for local ui extension is disabled when it is installed and enabled in remote server', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const gallery = aGalleryExtension('a');
            const localExtension = aLocalExtension('a', { extensionKind: 'ui' }, { location: uri_1.URI.file('pub.a') });
            const localExtensionManagementService = createExtensionManagementService([localExtension]);
        ...
        test('Test remote install action is enabled for local workspace extension', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
        ...
        test('Test remote install action when installing local workspace extension', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const remoteExtensionManagementService = createExtensionManagementService();
        ...
        test('Test remote install action when installing local workspace extension is finished', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const remoteExtensionManagementService = createExtensionManagementService();
            const onInstallExtension = new event_1.Emitter();
            remoteExtensionManagementService.onInstallExtension = onInstallExtension.event;
        ...
        test('Test remote install action is enabled for disabled local workspace extension', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const localWorkspaceExtension = aLocalExtension('a', { extensionKind: 'workspace' }, { location: uri_1.URI.file(`pub.a`) });
            const extensionManagementServerService = aMultiExtensionManagementServerService(instantiationService, createExtensionManagementService([localWorkspaceExtension]));
            instantiationService.stub(extensionManagement_2.IExtensionManagementServerService, extensionManagementServerService);
        ...
        test('Test remote install action is disabled when extension is not set', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const localWorkspaceExtension = aLocalExtension('a', { extensionKind: 'workspace' }, { location: uri_1.URI.file(`pub.a`) });
            const extensionManagementServerService = aMultiExtensionManagementServerService(instantiationService, createExtensionManagementService([localWorkspaceExtension]));
            instantiationService.stub(extensionManagement_2.IExtensionEnablementService, new extensionEnablementService_test_1.TestExtensionEnablementService(instantiationService));
        ...
        test('Test remote install action is disabled for extension which is not installed', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
        ...
        test('Test remote install action is disabled for local workspace extension which is disabled in env', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const localWorkspaceExtension = aLocalExtension('a', { extensionKind: 'workspace' }, { location: uri_1.URI.file(`pub.a`) });
            const extensionManagementServerService = aMultiExtensionManagementServerService(instantiationService, createExtensionManagementService([localWorkspaceExtension]));
        ...
        test('Test remote install action is disabled when remote server is not available', () => __awaiter(void 0, void 0, void 0, function* () {
            // single server setup
            const workbenchService = instantiationService.get(extensions_1.IExtensionsWorkbenchService);
        ...
        test('Test remote install action is disabled for local workspace extension if it is uninstalled locally', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
        ...
        test('Test remote install action is disabled for local workspace extension if it is installed in remote', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const localWorkspaceExtension = aLocalExtension('a', { extensionKind: 'workspace' }, { location: uri_1.URI.file(`pub.a`) });
        ...
        test('Test remote install action is enabled for local workspace extension if it has not gallery', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const localWorkspaceExtension = aLocalExtension('a', { extensionKind: 'workspace' }, { location: uri_1.URI.file(`pub.a`) });
            const extensionManagementServerService = aMultiExtensionManagementServerService(instantiationService, createExtensionManagementService([localWorkspaceExtension]));
            instantiationService.stub(extensionManagement_2.IExtensionManagementServerService, extensionManagementServerService);
        ...
        test('Test remote install action is disabled for local workspace system extension', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
        ...
        test('Test remote install action is disabled for local ui extension if it is not installed in remote', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
        ...
        test('Test remote install action is disabled for local ui extension if it is also installed in remote', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const localUIExtension = aLocalExtension('a', { extensionKind: 'ui' }, { location: uri_1.URI.file(`pub.a`) });
        ...
        test('Test remote install action is enabled for locally installed language pack extension', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
        ...
        test('Test remote install action is disabled if local language pack extension is uninstalled', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const extensionManagementService = instantiationService.get(extensionManagement_1.IExtensionManagementService);
            const extensionManagementServerService = aMultiExtensionManagementServerService(instantiationService, extensionManagementService);
            instantiationService.stub(extensionManagement_2.IExtensionManagementServerService, extensionManagementServerService);
        ...
        test('Test local install action is disabled for remote ui extension', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const remoteUIExtension = aLocalExtension('a', { extensionKind: 'ui' }, { location: uri_1.URI.file(`pub.a`).with({ scheme: network_1.Schemas.vscodeRemote }) });
        ...
        test('Test local install action when installing remote ui extension', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const localExtensionManagementService = createExtensionManagementService();
            const onInstallExtension = new event_1.Emitter();
        ...
        test('Test local install action is disabled for disabled remote ui extension', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const remoteUIExtension = aLocalExtension('a', { extensionKind: 'ui' }, { location: uri_1.URI.file(`pub.a`).with({ scheme: network_1.Schemas.vscodeRemote }) });
            const extensionManagementServerService = aMultiExtensionManagementServerService(instantiationService, createExtensionManagementService(), createExtensionManagementService([remoteUIExtension]));
            instantiationService.stub(extensionManagement_2.IExtensionManagementServerService, extensionManagementServerService);
        ...
        test('Test local install action is disabled when extension is not set', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const remoteUIExtension = aLocalExtension('a', { extensionKind: 'ui' }, { location: uri_1.URI.file(`pub.a`).with({ scheme: network_1.Schemas.vscodeRemote }) });
            const extensionManagementServerService = aMultiExtensionManagementServerService(instantiationService, createExtensionManagementService(), createExtensionManagementService([remoteUIExtension]));
            instantiationService.stub(extensionManagement_2.IExtensionEnablementService, new extensionEnablementService_test_1.TestExtensionEnablementService(instantiationService));
        ...
        test('Test local install action is disabled for extension which is not installed', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const extensionManagementServerService = aMultiExtensionManagementServerService(instantiationService);
            instantiationService.stub(extensionManagement_2.IExtensionManagementServerService, extensionManagementServerService);
            instantiationService.stub(extensionManagement_2.IExtensionEnablementService, new extensionEnablementService_test_1.TestExtensionEnablementService(instantiationService));
        ...
        test('Test local install action is disabled for remote ui extension which is disabled in env', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const remoteUIExtension = aLocalExtension('a', { extensionKind: 'ui' }, { location: uri_1.URI.file(`pub.a`).with({ scheme: network_1.Schemas.vscodeRemote }) });
            instantiationService.stub(environmentService_1.IWorkbenchEnvironmentService, { disableExtensions: true });
            const extensionManagementServerService = aMultiExtensionManagementServerService(instantiationService, createExtensionManagementService(), createExtensionManagementService([remoteUIExtension]));
        ...
        test('Test local install action is disabled when local server is not available', () => __awaiter(void 0, void 0, void 0, function* () {
            // single server setup
            const remoteUIExtension = aLocalExtension('a', { extensionKind: 'ui' }, { location: uri_1.URI.file(`pub.a`).with({ scheme: network_1.Schemas.vscodeRemote }) });
        ...
        test('Test local install action is disabled for remote ui extension if it is installed in local', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const localUIExtension = aLocalExtension('a', { extensionKind: 'ui' }, { location: uri_1.URI.file(`pub.a`) });
            const remoteUIExtension = aLocalExtension('a', { extensionKind: 'ui' }, { location: uri_1.URI.file(`pub.a`).with({ scheme: network_1.Schemas.vscodeRemote }) });
            const extensionManagementServerService = aMultiExtensionManagementServerService(instantiationService, createExtensionManagementService([localUIExtension]), createExtensionManagementService([remoteUIExtension]));
        ...
        test('Test local install action is disabled for remote UI extension if it uninstalled locally', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const extensionManagementService = instantiationService.get(extensionManagement_1.IExtensionManagementService);
        ...
        test('Test local install action is disabled for remote UI extension if it has gallery', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const remoteUIExtension = aLocalExtension('a', { extensionKind: 'ui' }, { location: uri_1.URI.file(`pub.a`).with({ scheme: network_1.Schemas.vscodeRemote }) });
            const extensionManagementServerService = aMultiExtensionManagementServerService(instantiationService, createExtensionManagementService(), createExtensionManagementService([remoteUIExtension]));
            instantiationService.stub(extensionManagement_2.IExtensionManagementServerService, extensionManagementServerService);
        ...
        test('Test local install action is disabled for remote UI system extension', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
        ...
        test('Test local install action is disabled for remote workspace extension if it is not installed in local', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const remoteWorkspaceExtension = aLocalExtension('a', { extensionKind: 'workspace' }, { location: uri_1.URI.file(`pub.a`).with({ scheme: network_1.Schemas.vscodeRemote }) });
        ...
        test('Test local install action is disabled for remote workspace extension if it is also installed in local', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
        ...
        test('Test local install action is enabled for remotely installed language pack extension', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
        ...
        test('Test local install action is disabled if remote language pack extension is uninstalled', () => __awaiter(void 0, void 0, void 0, function* () {
            // multi server setup
            const extensionManagementService = instantiationService.get(extensionManagement_1.IExtensionManagementService);
            const extensionManagementServerService = aMultiExtensionManagementServerService(instantiationService, createExtensionManagementService(), extensionManagementService);
            instantiationService.stub(extensionManagement_2.IExtensionManagementServerService, extensionManagementServerService);
