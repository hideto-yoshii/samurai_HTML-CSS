...
define(["require", "exports", "vs/nls", "vs/workbench/contrib/callHierarchy/browser/callHierarchy", "vs/base/common/cancellation", "vs/platform/instantiation/common/instantiation", "vs/workbench/contrib/callHierarchy/browser/callHierarchyPeek", "vs/base/common/event", "vs/editor/browser/editorExtensions", "vs/platform/contextkey/common/contextkey", "vs/base/common/lifecycle", "vs/editor/common/editorContextKeys", "vs/editor/contrib/referenceSearch/peekViewWidget", "vs/platform/storage/common/storage", "vs/editor/browser/services/codeEditorService", "vs/editor/common/core/range"], function (require, exports, nls_1, callHierarchy_1, cancellation_1, instantiation_1, callHierarchyPeek_1, event_1, editorExtensions_1, contextkey_1, lifecycle_1, editorContextKeys_1, peekViewWidget_1, storage_1, codeEditorService_1, range_1) {
    "use strict";
    ...
    let CallHierarchyController = class CallHierarchyController {
        ...
        startCallHierarchyFromCallHierarchy() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const newEditor = yield this._editorService.openCodeEditor({ resource: call.item.uri }, this._editor);
                if (!newEditor) {
                    return;
                }
    ...
    editorExtensions_1.registerEditorAction(class extends editorExtensions_1.EditorAction {
        constructor() {
            super({
                ...
                precondition: contextkey_1.ContextKeyExpr.and(_ctxCallHierarchyVisible.negate(), _ctxHasCompletionItemProvider, peekViewWidget_1.PeekContext.notInPeekEditor)
            });
        }
