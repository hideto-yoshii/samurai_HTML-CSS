    ...
    let TabCompletionController = class TabCompletionController {
        constructor(_editor, _snippetService, contextKeyService) {
            ...
            this._configListener = this._editor.onDidChangeConfiguration(e => {
                if (e.hasChanged(89 /* tabCompletion */)) {
                    this._update();
                }
            });
            this._update();
        ...
        _update() {
            const enabled = this._editor.getOption(89 /* tabCompletion */) === 'onlySnippets';
        ...
        performSnippetCompletions() {
            ...
            if (this._activeSnippets.length === 1) {
                ...
                snippetController2_1.SnippetController2.get(this._editor).insert(snippet.codeSnippet, { overwriteBefore: snippet.prefix.length, overwriteAfter: 0 });
            }
