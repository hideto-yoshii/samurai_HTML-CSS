...
define(["require", "exports", "sinon", "assert", "fs", "vs/base/common/objects", "vs/base/common/uuid", "vs/workbench/contrib/extensions/common/extensions", "vs/workbench/contrib/extensions/browser/extensionsWorkbenchService", "vs/platform/extensionManagement/common/extensionManagement", "vs/workbench/services/extensionManagement/common/extensionManagement", "vs/platform/extensionManagement/common/extensionManagementUtil", "vs/platform/extensionManagement/node/extensionManagementService", "vs/workbench/contrib/extensions/browser/extensionTipsService", "vs/workbench/services/extensionManagement/test/electron-browser/extensionEnablementService.test", "vs/platform/extensionManagement/common/extensionGalleryService", "vs/platform/url/common/url", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/base/common/event", "vs/platform/telemetry/common/telemetry", "vs/platform/telemetry/common/telemetryUtils", "vs/platform/workspace/common/workspace", "vs/workbench/test/workbenchTestServices", "vs/platform/configuration/common/configuration", "vs/platform/log/common/log", "vs/platform/progress/common/progress", "vs/workbench/services/progress/browser/progressService", "vs/platform/notification/common/notification", "vs/platform/url/node/urlService", "vs/base/common/uri", "vs/base/common/cancellation", "vs/workbench/services/remote/common/remoteAgentService", "vs/workbench/services/remote/electron-browser/remoteAgentServiceImpl", "vs/platform/ipc/electron-browser/sharedProcessService"], function (require, exports, sinon, assert, fs, objects_1, uuid_1, extensions_1, extensionsWorkbenchService_1, extensionManagement_1, extensionManagement_2, extensionManagementUtil_1, extensionManagementService_1, extensionTipsService_1, extensionEnablementService_test_1, extensionGalleryService_1, url_1, instantiationServiceMock_1, event_1, telemetry_1, telemetryUtils_1, workspace_1, workbenchTestServices_1, configuration_1, log_1, progress_1, progressService_1, notification_1, urlService_1, uri_1, cancellation_1, remoteAgentService_1, remoteAgentServiceImpl_1, sharedProcessService_1) {
    ...
    suite('ExtensionsWorkbenchServiceTest', () => {
        ...
        test('test gallery extension', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test for empty installed extensions', () => __awaiter(void 0, void 0, void 0, function* () {
            testObject = yield aWorkbenchService();
            assert.deepEqual([], testObject.local);
        }));
        test('test for installed extensions', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test installed extensions get syncs with gallery', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test extension state computation', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test extension doesnot show outdated for system extensions', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test canInstall returns false for extensions with out gallery', () => __awaiter(void 0, void 0, void 0, function* () {
            const local = aLocalExtension('a', { version: '1.0.1' }, { type: 0 /* System */ });
            instantiationService.stubPromise(extensionManagement_1.IExtensionManagementService, 'getInstalled', [local]);
            testObject = yield aWorkbenchService();
        ...
        test('test canInstall returns false for a system extension', () => __awaiter(void 0, void 0, void 0, function* () {
            const local = aLocalExtension('a', { version: '1.0.1' }, { type: 0 /* System */ });
            instantiationService.stubPromise(extensionManagement_1.IExtensionManagementService, 'getInstalled', [local]);
        ...
        test('test canInstall returns true for extensions with gallery', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test onchange event is triggered while installing', () => __awaiter(void 0, void 0, void 0, function* () {
            const gallery = aGalleryExtension('gallery1');
            testObject = yield aWorkbenchService();
            instantiationService.stubPromise(extensionManagement_1.IExtensionGalleryService, 'query', aPage(gallery));
        ...
        test('test onchange event is triggered when installation is finished', () => __awaiter(void 0, void 0, void 0, function* () {
            const gallery = aGalleryExtension('gallery1');
            testObject = yield aWorkbenchService();
            instantiationService.stubPromise(extensionManagement_1.IExtensionGalleryService, 'query', aPage(gallery));
            const target = sinon.spy();
        ...
        test('test onchange event is triggered while uninstalling', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test onchange event is triggered when uninstalling is finished', () => __awaiter(void 0, void 0, void 0, function* () {
            const local = aLocalExtension('a', {}, { type: 0 /* System */ });
            instantiationService.stubPromise(extensionManagement_1.IExtensionManagementService, 'getInstalled', [local]);
            testObject = yield aWorkbenchService();
            const target = sinon.spy();
        ...
        test('test uninstalled extensions are always enabled', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test enablement state installed enabled extension', () => __awaiter(void 0, void 0, void 0, function* () {
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([aLocalExtension('b')], 2 /* DisabledGlobally */)
                .then(() => instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([aLocalExtension('c')], 3 /* DisabledWorkspace */))
                .then(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test workspace disabled extension', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test globally disabled extension', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test enablement state is updated for user extensions', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test enable extension globally when extension is disabled for workspace', () => __awaiter(void 0, void 0, void 0, function* () {
            const localExtension = aLocalExtension('a');
        ...
        test('test disable extension globally', () => __awaiter(void 0, void 0, void 0, function* () {
            instantiationService.stubPromise(extensionManagement_1.IExtensionManagementService, 'getInstalled', [aLocalExtension('a')]);
            testObject = yield aWorkbenchService();
        ...
        test('test system extensions can be disabled', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test enablement state is updated on change from outside', () => __awaiter(void 0, void 0, void 0, function* () {
            const localExtension = aLocalExtension('a');
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([aLocalExtension('c')], 2 /* DisabledGlobally */)
                .then(() => instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([aLocalExtension('b')], 3 /* DisabledWorkspace */))
                .then(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test disable extension with dependencies disable only itself', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test disable extension pack disables the pack', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test disable extension pack disable all', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionPack: ['pub.b'] });
            const extensionB = aLocalExtension('b');
            const extensionC = aLocalExtension('c');
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([extensionA], 4 /* EnabledGlobally */)
        ...
        test('test disable extension fails if extension is a dependent of other', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionDependencies: ['pub.b'] });
            const extensionB = aLocalExtension('b');
            const extensionC = aLocalExtension('c');
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([extensionA], 4 /* EnabledGlobally */)
        ...
        test('test disable extension when extension is part of a pack', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionPack: ['pub.b'] });
            const extensionB = aLocalExtension('b');
            const extensionC = aLocalExtension('c');
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([extensionA], 4 /* EnabledGlobally */)
        ...
        test('test disable both dependency and dependent do not promot and do not fail', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionDependencies: ['pub.b'] });
            const extensionB = aLocalExtension('b');
            const extensionC = aLocalExtension('c');
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([extensionA], 4 /* EnabledGlobally */)
        ...
        test('test enable both dependency and dependent do not promot and do not fail', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionDependencies: ['pub.b'] });
            const extensionB = aLocalExtension('b');
            const extensionC = aLocalExtension('c');
        ...
        test('test disable extension does not fail if its dependency is a dependent of other but chosen to disable only itself', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionDependencies: ['pub.b'] });
            const extensionB = aLocalExtension('b');
        ...
        test('test disable extension if its dependency is a dependent of other disabled extension', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionDependencies: ['pub.b'] });
            const extensionB = aLocalExtension('b');
            const extensionC = aLocalExtension('c', { extensionDependencies: ['pub.b'] });
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([extensionA], 4 /* EnabledGlobally */)
        ...
        test('test disable extension if its dependencys dependency is itself', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionDependencies: ['pub.b'] });
        ...
        test('test disable extension if its dependency is dependent and is disabled', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionDependencies: ['pub.b'] });
            const extensionB = aLocalExtension('b');
            const extensionC = aLocalExtension('c', { extensionDependencies: ['pub.b'] });
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([extensionA], 4 /* EnabledGlobally */)
        ...
        test('test disable extension with cyclic dependencies', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionDependencies: ['pub.b'] });
        ...
        test('test enable extension with dependencies enable all', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionDependencies: ['pub.b'] });
            const extensionB = aLocalExtension('b');
            const extensionC = aLocalExtension('c');
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([extensionA], 2 /* DisabledGlobally */)
        ...
        test('test enable extension with dependencies does not prompt if dependency is enabled already', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionDependencies: ['pub.b'] });
            const extensionB = aLocalExtension('b');
            const extensionC = aLocalExtension('c');
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([extensionA], 2 /* DisabledGlobally */)
        ...
        test('test enable extension with dependency does not prompt if both are enabled', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionDependencies: ['pub.b'] });
            const extensionB = aLocalExtension('b');
            const extensionC = aLocalExtension('c');
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([extensionA], 2 /* DisabledGlobally */)
        ...
        test('test enable extension with cyclic dependencies', () => __awaiter(void 0, void 0, void 0, function* () {
            const extensionA = aLocalExtension('a', { extensionDependencies: ['pub.b'] });
            const extensionB = aLocalExtension('b', { extensionDependencies: ['pub.c'] });
            const extensionC = aLocalExtension('c', { extensionDependencies: ['pub.a'] });
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([extensionA], 2 /* DisabledGlobally */)
        ...
        test('test change event is fired when disablement flags are changed', () => __awaiter(void 0, void 0, void 0, function* () {
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([aLocalExtension('c')], 2 /* DisabledGlobally */)
                .then(() => instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([aLocalExtension('b')], 3 /* DisabledWorkspace */))
                .then(() => __awaiter(void 0, void 0, void 0, function* () {
                instantiationService.stubPromise(extensionManagement_1.IExtensionManagementService, 'getInstalled', [aLocalExtension('a')]);
        ...
        test('test change event is fired when disablement flags are changed from outside', () => __awaiter(void 0, void 0, void 0, function* () {
            const localExtension = aLocalExtension('a');
            return instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([aLocalExtension('c')], 2 /* DisabledGlobally */)
                .then(() => instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([aLocalExtension('b')], 3 /* DisabledWorkspace */))
                .then(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('test installing an extension re-eanbles it when disabled globally', () => __awaiter(void 0, void 0, void 0, function* () {
            testObject = yield aWorkbenchService();
            ...
            instantiationService.stubPromise(extensionManagement_1.IExtensionManagementService, 'getInstalled', [local]);
            const actual = yield testObject.queryLocal();
            assert.equal(actual[0].enablementState, 4 /* EnabledGlobally */);
        }));
        test('test updating an extension does not re-eanbles it when disabled globally', () => __awaiter(void 0, void 0, void 0, function* () {
            testObject = yield aWorkbenchService();
            const local = aLocalExtension('pub.a');
            yield instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([local], 2 /* DisabledGlobally */);
            ...
            instantiationService.stubPromise(extensionManagement_1.IExtensionManagementService, 'getInstalled', [local]);
            const actual = yield testObject.queryLocal();
            assert.equal(actual[0].enablementState, 2 /* DisabledGlobally */);
        }));
        test('test installing an extension re-eanbles it when workspace disabled', () => __awaiter(void 0, void 0, void 0, function* () {
            testObject = yield aWorkbenchService();
            const local = aLocalExtension('pub.a');
            yield instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([local], 3 /* DisabledWorkspace */);
            didInstallEvent.fire({ local, identifier: local.identifier, operation: 1 /* Install */ });
            instantiationService.stubPromise(extensionManagement_1.IExtensionManagementService, 'getInstalled', [local]);
            const actual = yield testObject.queryLocal();
            assert.equal(actual[0].enablementState, 4 /* EnabledGlobally */);
        }));
        test('test updating an extension does not re-eanbles it when workspace disabled', () => __awaiter(void 0, void 0, void 0, function* () {
            testObject = yield aWorkbenchService();
            const local = aLocalExtension('pub.a');
            yield instantiationService.get(extensionManagement_2.IExtensionEnablementService).setEnablement([local], 3 /* DisabledWorkspace */);
            didInstallEvent.fire({ local, identifier: local.identifier, operation: 2 /* Update */ });
            instantiationService.stubPromise(extensionManagement_1.IExtensionManagementService, 'getInstalled', [local]);
            const actual = yield testObject.queryLocal();
            assert.equal(actual[0].enablementState, 3 /* DisabledWorkspace */);
        }));
