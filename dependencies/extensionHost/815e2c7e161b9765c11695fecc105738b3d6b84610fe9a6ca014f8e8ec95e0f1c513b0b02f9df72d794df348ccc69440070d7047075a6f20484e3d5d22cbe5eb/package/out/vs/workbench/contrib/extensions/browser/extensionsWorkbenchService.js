...
`);
    ...
    let Extensions = class Extensions extends lifecycle_1.Disposable {
        ...
        queryInstalled() {
            return __awaiter(this, void 0, void 0, function* () {
                const installed = yield this.server.extensionManagementService.getInstalled();
        ...
        syncLocalWithGalleryExtension(gallery, maliciousExtensionSet) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const compatible = gallery.properties.engine ? yield this.galleryService.getCompatibleExtension(gallery) : gallery;
                if (!compatible) {
                    return false;
                }
                // Sync the local extension with gallery extension if local extension doesnot has metadata
                if (extension.local) {
                    const local = extension.local.metadata ? extension.local : yield this.server.extensionManagementService.updateMetadata(extension.local, { id: compatible.identifier.uuid, publisherDisplayName: compatible.publisherDisplayName, publisherId: compatible.publisherId });
                    extension.local = local;
    ...
    let ExtensionsWorkbenchService = class ExtensionsWorkbenchService extends lifecycle_1.Disposable {
        constructor(instantiationService, editorService, extensionService, galleryService, configurationService, telemetryService, notificationService, urlService, extensionEnablementService, hostService, progressService, extensionManagementServerService, storageService, modeService, productService) {
            ...
            if (extensionManagementServerService.localExtensionManagementServer) {
                ...
                this._register(event_1.Event.filter(this.localExtensions.onChange, e => !!e && e.operation === 1 /* Install */)(e => this.onDidInstallExtension(e.extension)));
            }
            if (extensionManagementServerService.remoteExtensionManagementServer) {
                ...
                this._register(event_1.Event.filter(this.remoteExtensions.onChange, e => !!e && e.operation === 1 /* Install */)(e => this.onDidInstallExtension(e.extension)));
            }
        ...
        get local() {
            ...
            const byId = extensionManagementUtil_1.groupByExtension(result, r => r.identifier);
        ...
        queryLocal(server) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.localExtensions) {
                    yield this.localExtensions.queryInstalled();
                }
                if (this.remoteExtensions) {
                    yield this.remoteExtensions.queryInstalled();
                }
                return this.local;
            });
        }
        ...
        getPrimaryExtension(extensions) {
            ...
            const pickRemoteOrFirstExtension = (from) => {
        ...
        install(extension) {
            if (extension instanceof uri_1.URI) {
                return this.installWithProgress(() => __awaiter(this, void 0, void 0, function* () {
                    const { identifier } = yield this.extensionService.install(extension);
            ...
            return this.installWithProgress(() => __awaiter(this, void 0, void 0, function* () {
                yield this.installFromGallery(extension, gallery);
        ...
        installFromGallery(extension, gallery) {
            return __awaiter(this, void 0, void 0, function* () {
                this.installing.push(extension);
                this._onChange.fire(extension);
                try {
                    ...
                    yield extensionService.installFromGallery(gallery);
        ...
        onDidInstallExtension(extension) {
            this.setEnablement(extension, 4 /* EnabledGlobally */);
        }
    ...
    ExtensionsWorkbenchService = __decorate([
        ...
        __param(8, extensionManagement_2.IExtensionEnablementService),
