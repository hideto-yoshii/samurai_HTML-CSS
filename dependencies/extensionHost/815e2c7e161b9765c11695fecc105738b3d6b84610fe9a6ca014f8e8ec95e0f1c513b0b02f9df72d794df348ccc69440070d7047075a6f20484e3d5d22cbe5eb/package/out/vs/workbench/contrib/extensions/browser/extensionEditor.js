...
define(["require", "exports", "vs/nls", "vs/base/common/async", "vs/base/common/arrays", "vs/base/common/platform", "vs/base/common/event", "vs/base/common/cache", "vs/base/common/actions", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/browser/event", "vs/base/browser/dom", "vs/workbench/browser/parts/editor/baseEditor", "vs/workbench/services/viewlet/browser/viewlet", "vs/platform/telemetry/common/telemetry", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/extensionManagement/common/extensionManagement", "vs/workbench/contrib/extensions/common/extensions", "vs/workbench/contrib/extensions/browser/extensionsWidgets", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/contrib/extensions/browser/extensionsActions", "vs/platform/keybinding/common/keybinding", "vs/base/browser/ui/scrollbar/scrollableElement", "vs/platform/opener/common/opener", "vs/platform/theme/common/themeService", "vs/base/browser/ui/keybindingLabel/keybindingLabel", "vs/platform/contextkey/common/contextkey", "vs/editor/browser/editorExtensions", "vs/workbench/services/editor/common/editorService", "vs/base/common/color", "vs/base/common/objects", "vs/platform/notification/common/notification", "vs/workbench/contrib/extensions/browser/extensionsViewer", "vs/workbench/contrib/update/common/update", "vs/base/common/keybindingParser", "vs/platform/storage/common/storage", "vs/workbench/services/extensions/common/extensions", "vs/platform/configuration/common/configurationRegistry", "vs/base/common/types", "vs/workbench/services/themes/common/workbenchThemeService", "vs/workbench/contrib/webview/browser/webview", "vs/base/browser/keyboardEvent", "vs/base/common/uuid", "vs/base/common/process", "vs/base/common/uri", "vs/base/common/network", "vs/workbench/contrib/markdown/common/markdownDocumentRenderer", "vs/editor/common/services/modeService", "vs/editor/common/modes", "vs/editor/common/modes/supports/tokenization", "vs/css!./media/extensionEditor"], function (require, exports, nls_1, async_1, arrays, platform_1, event_1, cache_1, actions_1, errors_1, lifecycle_1, event_2, dom_1, baseEditor_1, viewlet_1, telemetry_1, instantiation_1, extensionManagement_1, extensions_1, extensionsWidgets_1, actionbar_1, extensionsActions_1, keybinding_1, scrollableElement_1, opener_1, themeService_1, keybindingLabel_1, contextkey_1, editorExtensions_1, editorService_1, color_1, objects_1, notification_1, extensionsViewer_1, update_1, keybindingParser_1, storage_1, extensions_2, configurationRegistry_1, types_1, workbenchThemeService_1, webview_1, keyboardEvent_1, uuid_1, process_1, uri_1, network_1, markdownDocumentRenderer_1, modeService_1, modes_1, tokenization_1) {
    ...
    let ExtensionEditor = class ExtensionEditor extends baseEditor_1.BaseEditor {
        constructor(telemetryService, instantiationService, viewletService, extensionsWorkbenchService, themeService, keybindingService, notificationService, openerService, extensionTipsService, storageService, extensionService, workbenchThemeService, webviewService, modeService) {
        ...
        createEditor(parent) {
            ...
            const name = dom_1.append(title, dom_1.$('span.name.clickable', { title: nls_1.localize('name', "Extension name") }));
        ...
        setInput(input, options, token) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                if (this.template) {
                    yield this.updateTemplate(input, this.template);
                }
                ...
                */
                ...
                this.extensionManifest.get()
                    ...
                    if (extension.extensionPack.length) {
                        template.navbar.push(NavbarSection.ExtensionPack, nls_1.localize('extensionPack', "Extension Pack"), nls_1.localize('extensionsPack', "Set of extensions that can be installed together"));
                    }
                    if (manifest && manifest.contributes) {
                        template.navbar.push(NavbarSection.Contributions, nls_1.localize('contributions', "Contributions"), nls_1.localize('contributionstooltip', "Lists contributions to VS Code by this extension"));
                    }
        ...
        openMarkdown(cacheResult, noContentCopy, template) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const body = yield this.renderMarkdown(cacheResult, template);
                    ...
                    this.contentDisposables.add(this.themeService.onThemeChange(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    this.contentDisposables.add(webviewElement.onDidClickLink(link => {
                        ...
                        if ([network_1.Schemas.http, network_1.Schemas.https, network_1.Schemas.mailto].indexOf(link.scheme) >= 0 || (link.scheme === 'command' && link.path === update_1.ShowCurrentReleaseNotesActionId)) {
        ...
        renderMarkdown(cacheResult, template) {
            return __awaiter(this, void 0, void 0, function* () {
                const contents = yield this.loadContents(() => cacheResult, template);
                const content = yield markdownDocumentRenderer_1.renderMarkdownDocument(contents, this.extensionService, this.modeService);
                const documentContent = yield this.renderBody(content);
        ...
        openExtensionPack(extension, template) {
            const content = dom_1.$('div', { class: 'subcontent' });
            const scrollableContent = new scrollableElement_1.DomScrollableElement(content, {});
            dom_1.append(template.content, scrollableContent.getDomNode());
            this.contentDisposables.add(scrollableContent);
            const extensionsPackTree = this.instantiationService.createInstance(extensionsViewer_1.ExtensionsTree, new extensionsViewer_1.ExtensionData(extension, null, extension => extension.extensionPack || [], this.extensionsWorkbenchService), content);
            const layout = () => {
                scrollableContent.scanDomNode();
                const scrollDimensions = scrollableContent.getScrollDimensions();
        ...
        renderIconThemes(container, manifest, onDetailsToggle) {
            ...
            const details = dom_1.$('details', { open: true, ontoggle: onDetailsToggle }, dom_1.$('summary', { tabindex: '0' }, nls_1.localize('iconThemes', "Icon Themes ({0})", contrib.length)), dom_1.$('ul', undefined, ...contrib.map(theme => dom_1.$('li', undefined, theme.label))));
            dom_1.append(container, details);
            return true;
        }
    ...
    class StartExtensionEditorFindNextCommand extends editorExtensions_1.Command {
        runCommand(accessor, args) {
            const extensionEditor = getExtensionEditor(accessor);
            if (extensionEditor) {
    ...
    class StartExtensionEditorFindPreviousCommand extends editorExtensions_1.Command {
        runCommand(accessor, args) {
            const extensionEditor = getExtensionEditor(accessor);
            if (extensionEditor) {
