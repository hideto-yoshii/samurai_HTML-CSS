 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/platform/registry/common/platform", "vs/workbench/contrib/files/browser/fileActions", "vs/workbench/contrib/files/browser/saveErrorHandler", "vs/platform/actions/common/actions", "vs/workbench/common/actions", "vs/base/common/keyCodes", "vs/workbench/contrib/files/browser/fileCommands", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey", "vs/platform/keybinding/common/keybindingsRegistry", "vs/base/common/platform", "vs/workbench/contrib/files/common/files", "vs/workbench/browser/actions/workspaceCommands", "vs/workbench/browser/parts/editor/editorCommands", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/common/resources", "vs/platform/list/browser/listService", "vs/base/common/uri", "vs/base/common/network", "vs/workbench/browser/contextkeys", "vs/workbench/browser/actions/workspaceActions", "vs/workbench/common/editor", "vs/workbench/common/viewlet", "vs/base/common/amd"], function (require, exports, nls, platform_1, fileActions_1, saveErrorHandler_1, actions_1, actions_2, keyCodes_1, fileCommands_1, commands_1, contextkey_1, keybindingsRegistry_1, platform_2, files_1, workspaceCommands_1, editorCommands_1, textfiles_1, resources_1, listService_1, uri_1, network_1, contextkeys_1, workspaceActions_1, editor_1, viewlet_1, amd_1) {
    "use strict";
    ...
    registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(workspaceActions_1.OpenWorkspaceAction, workspaceActions_1.OpenWorkspaceAction.ID, workspaceActions_1.OpenWorkspaceAction.LABEL), 'Workspaces: Open Workspace...', workspacesCategory);
    ...
    appendSaveConflictEditorTitleAction('workbench.files.action.acceptLocalChanges', nls.localize('acceptLocalChanges', "Use your changes and overwrite file contents"), {
        light: uri_1.URI.parse(amd_1.registerAndGetAmdImageURL(`vs/workbench/contrib/files/browser/media/check-light.svg`)),
        dark: uri_1.URI.parse(amd_1.registerAndGetAmdImageURL(`vs/workbench/contrib/files/browser/media/check-dark.svg`))
    ...
    appendSaveConflictEditorTitleAction('workbench.files.action.revertLocalChanges', nls.localize('revertLocalChanges', "Discard your changes and revert to file contents"), {
        light: uri_1.URI.parse(amd_1.registerAndGetAmdImageURL(`vs/workbench/contrib/files/browser/media/undo-light.svg`)),
        dark: uri_1.URI.parse(amd_1.registerAndGetAmdImageURL(`vs/workbench/contrib/files/browser/media/undo-dark.svg`))
    ...
    actions_1.MenuRegistry.appendMenuItem(11 /* ExplorerContext */, ({
        ...
        when: contextkey_1.ContextKeyExpr.or(contextkey_1.ContextKeyExpr.and(resources_1.ResourceContextKey.Scheme.notEqualsTo(network_1.Schemas.file), contextkeys_1.IsWebContext.toNegated()), contextkey_1.ContextKeyExpr.and(resources_1.ResourceContextKey.Scheme.notEqualsTo(network_1.Schemas.file), files_1.ExplorerFolderContext.toNegated()))
    }));
    actions_1.MenuRegistry.appendMenuItem(11 /* ExplorerContext */, {
        group: '6_copypath',
        order: 30,
    ...
    actions_1.MenuRegistry.appendMenuItem(11 /* ExplorerContext */, {
        ...
        when: contextkey_1.ContextKeyExpr.and(files_1.ExplorerRootContext)
    });
    actions_1.MenuRegistry.appendMenuItem(11 /* ExplorerContext */, {
        group: '2_workspace',
        order: 30,
    ...
    actions_1.MenuRegistry.appendMenuItem(15 /* MenubarFileMenu */, {
        ...
        command: {
            ...
            precondition: contextkey_1.ContextKeyExpr.or(editor_1.ActiveEditorIsSaveableContext, contextkey_1.ContextKeyExpr.and(files_1.ExplorerViewletVisibleContext, viewlet_1.SidebarFocusContext))
        },
        order: 1
    });
    actions_1.MenuRegistry.appendMenuItem(15 /* MenubarFileMenu */, {
