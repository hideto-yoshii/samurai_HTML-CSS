...
define(["require", "exports", "vs/nls", "vs/base/common/severity", "vs/base/common/actions", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/workbench/services/activity/common/activity", "vs/platform/instantiation/common/instantiation", "vs/workbench/common/activity", "vs/platform/opener/common/opener", "vs/platform/storage/common/storage", "vs/platform/update/common/update", "semver-umd", "vs/platform/notification/common/notification", "vs/platform/dialogs/common/dialogs", "vs/workbench/services/environment/common/environmentService", "./releaseNotesEditor", "vs/base/common/platform", "vs/platform/configuration/common/configuration", "vs/platform/contextkey/common/contextkey", "vs/platform/actions/common/actions", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkeys", "vs/workbench/contrib/update/common/update", "vs/workbench/services/host/browser/host", "vs/platform/product/common/productService"], function (require, exports, nls, severity_1, actions_1, lifecycle_1, uri_1, activity_1, instantiation_1, activity_2, opener_1, storage_1, update_1, semver, notification_1, dialogs_1, environmentService_1, releaseNotesEditor_1, platform_1, configuration_1, contextkey_1, actions_2, commands_1, contextkeys_1, update_2, host_1, productService_1) {
    "use strict";
    ...
    let UpdateContribution = class UpdateContribution extends lifecycle_1.Disposable {
        constructor(storageService, instantiationService, notificationService, dialogService, updateService, activityService, contextKeyService, productService, workbenchEnvironmentService) {
            super();
        ...
        onUpdateStateChange(state) {
            ...
            if (state.type === "available for download" /* AvailableForDownload */ || state.type === "downloaded" /* Downloaded */ || state.type === "ready" /* Ready */) {
                ...
                badge = new activity_1.ProgressBadge(() => nls.localize('updateIsReady', "New {0} update available.", this.productService.nameShort));
        ...
        registerGlobalActivityActions() {
            ...
            actions_2.MenuRegistry.appendMenuItem(45 /* GlobalActivity */, {
                group: '6_update',
                command: {
                    id: 'update.check',
