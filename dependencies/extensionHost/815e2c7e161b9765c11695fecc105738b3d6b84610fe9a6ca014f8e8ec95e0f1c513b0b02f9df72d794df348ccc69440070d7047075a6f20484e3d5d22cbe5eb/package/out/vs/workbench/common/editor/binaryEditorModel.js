...
define(["require", "exports", "vs/workbench/common/editor", "vs/platform/files/common/files", "vs/base/common/network", "vs/base/common/resources", "vs/base/common/mime"], function (require, exports, editor_1, files_1, network_1, resources_1, mime_1) {
    "use strict";
    ...
    let BinaryEditorModel = class BinaryEditorModel extends editor_1.EditorModel {
        constructor(resource, name, fileService) {
            ...
            if (resource.scheme === network_1.Schemas.data) {
                ...
                const metadataMime = metadata.get(resources_1.DataUri.META_DATA_MIME);
                if (metadataMime) {
         ...
         */
        getName() {
            return this.name || resources_1.basename(this.resource);
        }
        /**
