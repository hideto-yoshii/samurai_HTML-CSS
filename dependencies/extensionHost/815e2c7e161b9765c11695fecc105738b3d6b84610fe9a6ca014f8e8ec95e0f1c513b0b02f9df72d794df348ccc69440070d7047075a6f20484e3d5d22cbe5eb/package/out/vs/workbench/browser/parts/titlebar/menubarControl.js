...
define(["require", "exports", "vs/nls", "vs/platform/actions/common/actions", "vs/platform/theme/common/themeService", "vs/platform/windows/common/windows", "vs/platform/contextkey/common/contextkey", "vs/base/common/actions", "vs/base/browser/ui/actionbar/actionbar", "vs/base/browser/dom", "vs/platform/keybinding/common/keybinding", "vs/base/common/platform", "vs/platform/configuration/common/configuration", "vs/base/common/event", "vs/base/common/lifecycle", "vs/platform/workspaces/common/workspaces", "vs/base/common/async", "vs/workbench/common/theme", "vs/platform/label/common/label", "vs/platform/update/common/update", "vs/platform/storage/common/storage", "vs/platform/notification/common/notification", "vs/workbench/services/preferences/common/preferences", "vs/workbench/services/environment/common/environmentService", "vs/base/browser/ui/menu/menubar", "vs/base/browser/ui/menu/menu", "vs/platform/theme/common/styler", "vs/base/common/objects", "vs/base/common/labels", "vs/platform/accessibility/common/accessibility", "vs/workbench/services/layout/browser/layoutService", "vs/base/browser/browser", "vs/workbench/services/host/browser/host", "vs/platform/electron/node/electron", "vs/platform/instantiation/common/instantiation", "vs/workbench/services/electron/electron-browser/electronEnvironmentService"], function (require, exports, nls, actions_1, themeService_1, windows_1, contextkey_1, actions_2, actionbar_1, DOM, keybinding_1, platform_1, configuration_1, event_1, lifecycle_1, workspaces_1, async_1, theme_1, label_1, update_1, storage_1, notification_1, preferences_1, environmentService_1, menubar_1, menu_1, styler_1, objects_1, labels_1, accessibility_1, layoutService_1, browser_1, host_1, electron_1, instantiation_1, electronEnvironmentService_1) {
    ...
    let CustomMenubarControl = class CustomMenubarControl extends MenubarControl {
        constructor(menuService, workspacesService, contextKeyService, keybindingService, configurationService, labelService, updateService, storageService, notificationService, preferencesService, environmentService, accessibilityService, themeService, layoutService, hostService, workbenchEnvironmentService, electronService, electronEnvironmentService) {
        ...
        registerListeners() {
            ...
            if (!platform_1.isWeb) {
                this._register(event_1.Event.any(event_1.Event.map(event_1.Event.filter(this.electronService.onWindowMaximize, id => id === this.electronEnvironmentService.windowId), _ => true), event_1.Event.map(event_1.Event.filter(this.electronService.onWindowUnmaximize, id => id === this.electronEnvironmentService.windowId), _ => false))(e => this.updateMenubar()));
            }
    ...
    CustomMenubarControl = __decorate([
        ...
        __param(16, instantiation_1.optional(electron_1.IElectronService)),
        __param(17, instantiation_1.optional(electronEnvironmentService_1.IElectronEnvironmentService))
