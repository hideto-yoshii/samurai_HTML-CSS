 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/actions", "vs/workbench/common/component", "vs/base/common/event", "vs/base/browser/dom", "vs/base/common/lifecycle", "vs/base/common/types", "vs/base/common/arrays"], function (require, exports, actions_1, component_1, event_1, dom_1, lifecycle_1, types_1, arrays_1) {
    "use strict";
    ...
    class CompositeRegistry extends lifecycle_1.Disposable {
        ...
        compositeById(id) {
            return arrays_1.find(this.composites, composite => composite.id === id);
        }
    }
