 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/platform/registry/common/platform", "vs/workbench/browser/parts/editor/baseEditor", "vs/base/common/arrays"], function (require, exports, platform_1, baseEditor_1, arrays_1) {
    "use strict";
    ...
    class EditorRegistry {
        ...
        getEditorById(editorId) {
            return arrays_1.find(this.editors, editor => editor.getId() === editorId);
        }
        getEditors() {
