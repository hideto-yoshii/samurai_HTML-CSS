 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/base/common/idGenerator", "vs/base/common/lifecycle", "vs/base/common/strings", "vs/base/common/event", "vs/base/common/errors", "vs/base/browser/ui/toolbar/toolbar", "vs/base/browser/ui/progressbar/progressbar", "vs/workbench/browser/actions", "vs/workbench/browser/part", "vs/workbench/services/progress/browser/progressIndicator", "vs/platform/instantiation/common/serviceCollection", "vs/platform/progress/common/progress", "vs/platform/theme/common/styler", "vs/base/browser/dom", "vs/base/common/types", "vs/css!./media/compositepart"], function (require, exports, nls, idGenerator_1, lifecycle_1, strings, event_1, errors, toolbar_1, progressbar_1, actions_1, part_1, progressIndicator_1, serviceCollection_1, progress_1, styler_1, dom_1, types_1) {
    "use strict";
    ...
    class CompositePart extends part_1.Part {
        ...
        updateTitle(compositeId, compositeTitle) {
            ...
            this.titleLabel.updateTitle(compositeId, compositeTitle, types_1.withNullAsUndefined((_a = keybinding) === null || _a === void 0 ? void 0 : _a.getLabel()));
            const toolBar = types_1.assertIsDefined(this.toolBar);
        ...
        collectCompositeActions(composite) {
            ...
            return toolBar.setActions(actions_1.prepareActions(primaryActions), actions_1.prepareActions(secondaryActions));
        }
        getActiveComposite() {
            return this.activeComposite;
        }
