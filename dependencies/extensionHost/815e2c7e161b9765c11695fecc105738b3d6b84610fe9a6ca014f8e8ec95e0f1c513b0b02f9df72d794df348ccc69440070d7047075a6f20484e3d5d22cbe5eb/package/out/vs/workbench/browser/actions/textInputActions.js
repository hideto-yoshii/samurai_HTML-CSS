...
define(["require", "exports", "vs/base/common/actions", "vs/nls", "vs/base/browser/ui/actionbar/actionbar", "vs/workbench/services/layout/browser/layoutService", "vs/platform/contextview/browser/contextView", "vs/base/common/lifecycle", "vs/base/browser/dom", "vs/workbench/common/contributions", "vs/platform/registry/common/platform", "vs/base/common/platform", "vs/platform/clipboard/common/clipboardService"], function (require, exports, actions_1, nls_1, actionbar_1, layoutService_1, contextView_1, lifecycle_1, dom_1, contributions_1, platform_1, platform_2, clipboardService_1) {
    ...
    let TextInputActionsProvider = class TextInputActionsProvider extends lifecycle_1.Disposable {
        ...
        createActions() {
            ...
            // Undo/Redo
            new actions_1.Action('undo', nls_1.localize('undo', "Undo"), undefined, true, () => __awaiter(this, void 0, void 0, function* () { return document.execCommand('undo'); })), new actions_1.Action('redo', nls_1.localize('redo', "Redo"), undefined, true, () => __awaiter(this, void 0, void 0, function* () { return document.execCommand('redo'); })), new actionbar_1.Separator(), 
            // Cut / Copy / Paste
            new actions_1.Action('editor.action.clipboardCutAction', nls_1.localize('cut', "Cut"), undefined, true, () => __awaiter(this, void 0, void 0, function* () { return document.execCommand('cut'); })), new actions_1.Action('editor.action.clipboardCopyAction', nls_1.localize('copy', "Copy"), undefined, true, () => __awaiter(this, void 0, void 0, function* () { return document.execCommand('copy'); })), new actions_1.Action('editor.action.clipboardPasteAction', nls_1.localize('paste', "Paste"), undefined, true, (element) => __awaiter(this, void 0, void 0, function* () {
                ...
                // Web: paste is not supported due to security reasons
                    ...
                    const clipboardText = yield this.clipboardService.readText();
            ...
            // Select All
            new actions_1.Action('editor.action.selectAll', nls_1.localize('selectAll', "Select All"), undefined, true, () => __awaiter(this, void 0, void 0, function* () { return document.execCommand('selectAll'); })));
        }
        registerListeners() {
