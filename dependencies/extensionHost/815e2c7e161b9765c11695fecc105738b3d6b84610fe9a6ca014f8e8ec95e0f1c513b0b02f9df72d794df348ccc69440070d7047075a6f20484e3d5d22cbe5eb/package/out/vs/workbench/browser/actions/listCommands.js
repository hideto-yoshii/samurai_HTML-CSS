...
define(["require", "exports", "vs/platform/keybinding/common/keybindingsRegistry", "vs/base/browser/ui/list/listWidget", "vs/platform/list/browser/listService", "vs/base/browser/ui/list/listPaging", "vs/base/common/arrays", "vs/platform/contextkey/common/contextkey", "vs/base/browser/ui/tree/objectTree", "vs/base/browser/ui/tree/asyncDataTree", "vs/base/browser/ui/tree/dataTree", "vs/platform/commands/common/commands", "vs/base/parts/tree/browser/treeImpl"], function (require, exports, keybindingsRegistry_1, listWidget_1, listService_1, listPaging_1, arrays_1, contextkey_1, objectTree_1, asyncDataTree_1, dataTree_1, commands_1, treeImpl_1) {
    ...
    function listFocusFirst(accessor, options) {
        ...
        // Tree
            ...
            const tree = focused;
            tree.focusFirst({ origin: 'keyboard' }, ((_a = options) === null || _a === void 0 ? void 0 : _a.fromFocused) ? tree.getFocus() : undefined);
            tree.reveal(tree.getFocus());
        }
    }
    keybindingsRegistry_1.KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    function listFocusLast(accessor, options) {
        ...
        // Tree
            ...
            const tree = focused;
            tree.focusLast({ origin: 'keyboard' }, ((_a = options) === null || _a === void 0 ? void 0 : _a.fromFocused) ? tree.getFocus() : undefined);
            tree.reveal(tree.getFocus());
        }
    }
    keybindingsRegistry_1.KeybindingsRegistry.registerCommandAndKeybindingRule({
