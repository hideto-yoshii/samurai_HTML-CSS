...
define(["require", "exports", "vs/nls", "vs/base/common/objects", "vs/base/common/arrays", "vs/base/common/strings", "vs/base/common/types", "vs/platform/registry/common/platform", "vs/base/common/actions", "vs/base/parts/quickopen/browser/quickOpenModel", "vs/workbench/common/editor", "vs/platform/quickOpen/common/quickOpen", "vs/workbench/services/editor/common/editorService"], function (require, exports, nls_1, objects_1, arrays_1, strings_1, types_1, platform_1, actions_1, quickOpenModel_1, editor_1, quickOpen_1, editorService_1) {
    ...
    class QuickOpenRegistry {
        ...
        getQuickOpenHandler(text) {
            return text ? (arrays_1.first(this.handlers, h => strings_1.startsWith(text, h.prefix)) || null) : null;
        }
        getDefaultQuickOpenHandler() {
            return types_1.assertIsDefined(this.defaultHandler);
        }
    }
        ...
        run(mode, context) {
            ...
            if (mode === 1 /* OPEN */ || mode === 2 /* OPEN_IN_BACKGROUND */) {
                ...
                if (input instanceof editor_1.EditorInput) {
                    ...
                    if (opts) {
                        opts = objects_1.mixin(opts, openOptions, true);
                    }
                    else if (openOptions) {
                        opts = editor_1.EditorOptions.create(openOptions);
                    }
                    this.editorService.openEditor(input, types_1.withNullAsUndefined(opts), sideBySide ? editorService_1.SIDE_GROUP : editorService_1.ACTIVE_GROUP);
                }
                else {
                    const resourceInput = input;
                    if (openOptions) {
                        resourceInput.options = objects_1.assign(resourceInput.options || Object.create(null), openOptions);
                    }
