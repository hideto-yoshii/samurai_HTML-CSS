...
define(["require", "exports", "vs/platform/theme/common/themeService", "vs/workbench/browser/part", "vs/base/browser/dom", "vs/base/common/event", "vs/platform/theme/common/colorRegistry", "vs/workbench/services/editor/common/editorGroupsService", "vs/platform/instantiation/common/instantiation", "vs/base/browser/ui/grid/grid", "vs/base/common/map", "vs/workbench/common/theme", "vs/base/common/arrays", "vs/workbench/browser/parts/editor/editor", "vs/workbench/browser/parts/editor/editorGroupView", "vs/platform/configuration/common/configuration", "vs/base/common/lifecycle", "vs/base/common/objects", "vs/platform/storage/common/storage", "vs/workbench/common/editor/editorGroup", "vs/workbench/browser/parts/editor/editorDropTarget", "vs/base/common/color", "vs/base/browser/ui/centered/centeredViewLayout", "vs/base/common/errors", "vs/workbench/services/layout/browser/layoutService", "vs/platform/instantiation/common/extensions", "vs/base/common/types", "vs/workbench/browser/parts/editor/editor.contribution"], function (require, exports, themeService_1, part_1, dom_1, event_1, colorRegistry_1, editorGroupsService_1, instantiation_1, grid_1, map_1, theme_1, arrays_1, editor_1, editorGroupView_1, configuration_1, lifecycle_1, objects_1, storage_1, editorGroup_1, editorDropTarget_1, color_1, centeredViewLayout_1, errors_1, layoutService_1, extensions_1, types_1) {
    ...
    let EditorPart = class EditorPart extends part_1.Part {
        ...
        addGroup(location, direction, options) {
            ...
            if ((_a = options) === null || _a === void 0 ? void 0 : _a.activate) {
        ...
        doCreateGroupView(from) {
            ...
            // Track focus
            let groupDisposables = new lifecycle_1.DisposableStore();
        ...
        mergeGroup(group, target, options) {
            ...
            sourceView.editors.forEach(editor => {
                ...
                if (((_a = options) === null || _a === void 0 ? void 0 : _a.mode) === 0 /* COPY_EDITORS */) {
        ...
        doCreateGridControlWithPreviousState() {
            ...
            if ((_a = uiState) === null || _a === void 0 ? void 0 : _a.serializedGrid) {
                try {
                    // MRU
