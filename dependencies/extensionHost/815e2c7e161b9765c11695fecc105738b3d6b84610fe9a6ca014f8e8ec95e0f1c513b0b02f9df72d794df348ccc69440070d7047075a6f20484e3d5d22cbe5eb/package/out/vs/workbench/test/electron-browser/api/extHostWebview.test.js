...
define(["require", "exports", "assert", "vs/workbench/api/common/extHostWebview", "vs/workbench/test/electron-browser/api/mock", "./testRPCProtocol", "vs/base/common/uri"], function (require, exports, assert, extHostWebview_1, mock_1, testRPCProtocol_1, uri_1) {
    ...
    suite('ExtHostWebview', () => {
        test('Cannot register multiple serializers for the same view type', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            assert.throws(() => extHostWebviews.registerWebviewPanelSerializer(extension, viewType, serializerB), 'Should throw when registering two serializers for the same view');
