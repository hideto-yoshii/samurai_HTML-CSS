...
define(["require", "exports", "vs/base/common/uri", "assert", "vs/base/common/path", "vs/workbench/services/untitled/common/untitledEditorService", "vs/platform/configuration/common/configuration", "vs/workbench/test/workbenchTestServices", "vs/workbench/common/editor/untitledEditorModel", "vs/editor/common/services/modeService", "vs/base/common/async", "vs/workbench/services/textfile/common/textfiles", "vs/editor/common/modes/modesRegistry"], function (require, exports, uri_1, assert, path_1, untitledEditorService_1, configuration_1, workbenchTestServices_1, untitledEditorModel_1, modeService_1, async_1, textfiles_1, modesRegistry_1) {
    ...
    suite('Workbench untitled editors', () => {
        ...
        test('Untitled Editor Service', (done) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('Untitled no longer dirty when content gets empty', () => __awaiter(void 0, void 0, void 0, function* () {
            const service = accessor.untitledEditorService;
        ...
        test('Untitled via loadOrCreate', () => __awaiter(void 0, void 0, void 0, function* () {
            const service = accessor.untitledEditorService;
        ...
        test('Untitled with associated path remains dirty when content gets empty', () => __awaiter(void 0, void 0, void 0, function* () {
            const service = accessor.untitledEditorService;
            const file = uri_1.URI.file(path_1.join('C:\\', '/foo/file.txt'));
        ...
        test('Untitled with initial content is dirty', () => __awaiter(void 0, void 0, void 0, function* () {
            const service = accessor.untitledEditorService;
        ...
        test('Untitled can change mode afterwards', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('encoding change event', () => __awaiter(void 0, void 0, void 0, function* () {
            const service = accessor.untitledEditorService;
            const input = service.createOrGet();
            let counter = 0;
        ...
        test('onDidChangeContent event', () => __awaiter(void 0, void 0, void 0, function* () {
            const service = accessor.untitledEditorService;
            const input = service.createOrGet();
        ...
        test('onDidDisposeModel event', () => __awaiter(void 0, void 0, void 0, function* () {
            const service = accessor.untitledEditorService;
            const input = service.createOrGet();
            let counter = 0;
