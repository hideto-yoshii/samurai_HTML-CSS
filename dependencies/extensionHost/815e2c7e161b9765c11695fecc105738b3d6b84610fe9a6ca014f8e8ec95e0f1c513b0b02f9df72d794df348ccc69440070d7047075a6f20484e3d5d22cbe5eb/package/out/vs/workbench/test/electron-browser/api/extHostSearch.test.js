...
define(["require", "exports", "assert", "vs/base/common/arrays", "vs/base/common/cancellation", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/common/resources", "vs/base/common/uri", "vs/workbench/api/common/extHost.protocol", "vs/workbench/api/node/extHostSearch", "vs/workbench/api/common/extHostTypes", "vs/workbench/services/search/common/search", "vs/workbench/test/electron-browser/api/testRPCProtocol", "vs/platform/log/common/log", "vs/workbench/api/common/extHostUriTransformerService", "vs/workbench/test/electron-browser/api/mock"], function (require, exports, assert, arrays_1, cancellation_1, errors_1, lifecycle_1, resources_1, uri_1, extHost_protocol_1, extHostSearch_1, extHostTypes_1, search_1, testRPCProtocol_1, log_1, extHostUriTransformerService_1, mock_1) {
    ...
    suite('ExtHostSearch', () => {
        ...
        suite('File:', () => {
            ...
            test('no results', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('simple results', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('Search canceled', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('provider returns null', () => __awaiter(void 0, void 0, void 0, function* () {
                yield registerTestFileSearchProvider({
                    provideFileSearchResults(query, options, token) {
                        return null;
                    }
            ...
            test('all provider calls get global include/excludes', () => __awaiter(void 0, void 0, void 0, function* () {
                yield registerTestFileSearchProvider({
                    provideFileSearchResults(query, options, token) {
            ...
            test('global/local include/excludes combined', () => __awaiter(void 0, void 0, void 0, function* () {
                yield registerTestFileSearchProvider({
                    provideFileSearchResults(query, options, token) {
            ...
            test('include/excludes resolved correctly', () => __awaiter(void 0, void 0, void 0, function* () {
                yield registerTestFileSearchProvider({
                    provideFileSearchResults(query, options, token) {
            ...
            test('basic sibling exclude clause', () => __awaiter(void 0, void 0, void 0, function* () {
                const reportedResults = [
                    'file1.ts',
                    'file1.js',
                ];
            ...
            test('multiroot sibling exclude clause', () => __awaiter(void 0, void 0, void 0, function* () {
                yield registerTestFileSearchProvider({
                    provideFileSearchResults(query, options, token) {
                        let reportedResults;
            ...
            test.skip('max results = 1', () => __awaiter(void 0, void 0, void 0, function* () {
                const reportedResults = [
                    resources_1.joinPath(rootFolderA, 'file1.ts'),
                    resources_1.joinPath(rootFolderA, 'file2.ts'),
            ...
            test.skip('max results = 2', () => __awaiter(void 0, void 0, void 0, function* () {
                const reportedResults = [
                    resources_1.joinPath(rootFolderA, 'file1.ts'),
                    resources_1.joinPath(rootFolderA, 'file2.ts'),
                    resources_1.joinPath(rootFolderA, 'file3.ts'),
            ...
            test.skip('provider returns maxResults exactly', () => __awaiter(void 0, void 0, void 0, function* () {
                const reportedResults = [
                    resources_1.joinPath(rootFolderA, 'file1.ts'),
                    resources_1.joinPath(rootFolderA, 'file2.ts'),
                ];
            ...
            test('multiroot max results', () => __awaiter(void 0, void 0, void 0, function* () {
                let cancels = 0;
                yield registerTestFileSearchProvider({
                    provideFileSearchResults(query, options, token) {
                        return __awaiter(this, void 0, void 0, function* () {
            ...
            test('works with non-file schemes', () => __awaiter(void 0, void 0, void 0, function* () {
                const reportedResults = [
        ...
        suite('Text:', () => {
            ...
            test('basic results', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('provider fail', () => __awaiter(void 0, void 0, void 0, function* () {
                yield registerTestTextSearchProvider({
                    provideTextSearchResults(query, options, progress, token) {
            ...
            test('basic sibling clause', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('multiroot sibling clause', () => __awaiter(void 0, void 0, void 0, function* () {
                mockPFS.readdir = (_path) => {
            ...
            test('include pattern applied', () => __awaiter(void 0, void 0, void 0, function* () {
                const providedResults = [
                    makeTextResult(rootFolderA, 'file1.js'),
                    makeTextResult(rootFolderA, 'file1.ts')
                ];
            ...
            test('max results = 1', () => __awaiter(void 0, void 0, void 0, function* () {
                const providedResults = [
                    makeTextResult(rootFolderA, 'file1.ts'),
                    makeTextResult(rootFolderA, 'file2.ts')
                ];
            ...
            test('max results = 2', () => __awaiter(void 0, void 0, void 0, function* () {
                const providedResults = [
                    makeTextResult(rootFolderA, 'file1.ts'),
                    makeTextResult(rootFolderA, 'file2.ts'),
            ...
            test('provider returns maxResults exactly', () => __awaiter(void 0, void 0, void 0, function* () {
                const providedResults = [
                    makeTextResult(rootFolderA, 'file1.ts'),
                    makeTextResult(rootFolderA, 'file2.ts')
                ];
            ...
            test('provider returns early with limitHit', () => __awaiter(void 0, void 0, void 0, function* () {
                const providedResults = [
                    makeTextResult(rootFolderA, 'file1.ts'),
                    makeTextResult(rootFolderA, 'file2.ts'),
                    makeTextResult(rootFolderA, 'file3.ts')
