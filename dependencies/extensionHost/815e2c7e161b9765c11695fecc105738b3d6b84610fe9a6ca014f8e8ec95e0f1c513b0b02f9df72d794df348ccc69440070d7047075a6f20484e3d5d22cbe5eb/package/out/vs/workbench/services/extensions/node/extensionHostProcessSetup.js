...
define(["require", "exports", "net", "fs", "vs/base/parts/ipc/common/ipc.net", "vs/base/parts/ipc/node/ipc.net", "vs/workbench/services/extensions/common/extensionHostProtocol", "vs/workbench/services/extensions/common/extensionHostMain", "vs/base/node/pfs", "vs/base/node/extpath", "vs/base/common/lifecycle", "vs/workbench/api/node/extHost.services"], function (require, exports, net_1, fs_1, ipc_net_1, ipc_net_2, extensionHostProtocol_1, extensionHostMain_1, pfs_1, extpath_1, lifecycle_1) {
    "use strict";
    ...
    let onTerminate = (reason = 'unknown', code) => {
        console.log(`Terminating extension host early, reason: ${reason}`);
        exit(code);
    };
    ...
    function connectToRenderer(protocol) {
        return new Promise((resolve, reject) => {
            ...
            const first = protocol.onMessage(rawMessage => {
                try {
                    console.log('Received initialization message');
                    first.dispose();
            ...
            console.log('Extension host is ready to receive messages');
    ...
    function tryStartExtensionHostProcess() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            onTerminate = (reason = 'unknown', code) => {
                ...
                extensionHostMain.terminate(code);
            };
