...
define(["require", "exports", "vs/nls", "vs/base/common/errors", "vs/base/common/objects", "vs/base/common/event", "vs/base/common/platform", "vs/workbench/services/backup/common/backup", "vs/workbench/services/textfile/common/textfiles", "vs/platform/lifecycle/common/lifecycle", "vs/platform/workspace/common/workspace", "vs/platform/files/common/files", "vs/platform/configuration/common/configuration", "vs/base/common/lifecycle", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/untitled/common/untitledEditorService", "vs/workbench/common/editor/untitledEditorModel", "vs/workbench/services/textfile/common/textFileEditorModelManager", "vs/platform/instantiation/common/instantiation", "vs/base/common/map", "vs/base/common/network", "vs/workbench/services/history/common/history", "vs/platform/contextkey/common/contextkey", "vs/editor/common/model/textModel", "vs/editor/common/services/modelService", "vs/platform/notification/common/notification", "vs/base/common/resources", "vs/platform/dialogs/common/dialogs", "vs/editor/common/services/modeService", "vs/workbench/services/editor/common/editorService", "vs/base/common/arrays", "vs/base/common/strings", "vs/editor/common/services/resourceConfiguration", "vs/editor/common/modes/modesRegistry"], function (require, exports, nls, errors, objects, event_1, platform, backup_1, textfiles_1, lifecycle_1, workspace_1, files_1, configuration_1, lifecycle_2, environmentService_1, untitledEditorService_1, untitledEditorModel_1, textFileEditorModelManager_1, instantiation_1, map_1, network_1, history_1, contextkey_1, textModel_1, modelService_1, notification_1, resources_1, dialogs_1, modeService_1, editorService_1, arrays_1, strings_1, resourceConfiguration_1, modesRegistry_1) {
    ...
    let AbstractTextFileService = class AbstractTextFileService extends lifecycle_2.Disposable {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                switch (reason) {
                    case 1 /* CLOSE */:
                        ...
                        else if ((yield this.getWindowCount()) > 1 || platform.isMacintosh) {
        ...
        readStream(resource, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return Object.assign(Object.assign({}, stream), { encoding: 'utf8', value: yield textModel_1.createTextBufferFactoryFromStream(stream.value, undefined, ((_a = options) === null || _a === void 0 ? void 0 : _a.acceptTextOnly) ? throwOnBinary : undefined) });
            });
        }
        ...
        doRevertAllFiles(resources, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield Promise.all(fileModels.map((model) => __awaiter(this, void 0, void 0, function* () {
                    var _b;
                    try {
                        yield model.revert((_b = options) === null || _b === void 0 ? void 0 : _b.soft);
                        if (!model.isDirty()) {
                            const result = mapResourceToResult.get(model.getResource());
                            if (result) {
                                result.success = true;
    ...
    function promptSave(dialogService, resourcesToConfirm) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { choice } = yield dialogService.show(notification_1.Severity.Warning, message, buttons, {
                cancelId: 2,
