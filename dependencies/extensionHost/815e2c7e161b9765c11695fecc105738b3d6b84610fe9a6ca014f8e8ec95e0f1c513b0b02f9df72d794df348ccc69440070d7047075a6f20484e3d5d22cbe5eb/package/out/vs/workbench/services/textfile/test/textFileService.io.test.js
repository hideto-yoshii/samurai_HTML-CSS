...
define(["require", "exports", "assert", "vs/base/common/uri", "vs/workbench/test/workbenchTestServices", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/untitled/common/untitledEditorService", "vs/platform/files/common/files", "vs/base/common/network", "vs/platform/instantiation/common/serviceCollection", "vs/base/node/pfs", "vs/base/common/lifecycle", "vs/platform/files/common/fileService", "vs/platform/log/common/log", "vs/base/test/node/testUtils", "os", "vs/platform/files/node/diskFileSystemProvider", "vs/base/common/uuid", "vs/base/common/path", "vs/base/common/amd", "vs/base/node/encoding", "vs/workbench/services/textfile/electron-browser/nativeTextFileService", "vs/editor/common/model/textModel", "vs/base/common/platform", "fs", "vs/base/test/node/encoding/encoding.test"], function (require, exports, assert, uri_1, workbenchTestServices_1, textfiles_1, untitledEditorService_1, files_1, network_1, serviceCollection_1, pfs_1, lifecycle_1, fileService_1, log_1, testUtils_1, os_1, diskFileSystemProvider_1, uuid_1, path_1, amd_1, encoding_1, nativeTextFileService_1, textModel_1, platform_1, fs_1, encoding_test_1) {
    ...
    suite('Files - TextFileService i/o', () => {
        ...
        test('create - no encoding - content empty', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('create - no encoding - content provided', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'small_new.txt'));
            yield service.create(resource, 'Hello World');
            assert.equal(yield pfs_1.exists(resource.fsPath), true);
            assert.equal((yield pfs_1.readFile(resource.fsPath)).toString(), 'Hello World');
        }));
        test('create - UTF 16 LE - no content', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('create - UTF 16 LE - content provided', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'small_new.utf16le'));
            yield service.create(resource, 'Hello World');
            assert.equal(yield pfs_1.exists(resource.fsPath), true);
            const detectedEncoding = yield encoding_test_1.detectEncodingByBOM(resource.fsPath);
        ...
        test('create - UTF 16 BE - no content', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('create - UTF 16 BE - content provided', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'small_new.utf16be'));
            yield service.create(resource, 'Hello World');
            assert.equal(yield pfs_1.exists(resource.fsPath), true);
            const detectedEncoding = yield encoding_test_1.detectEncodingByBOM(resource.fsPath);
        ...
        test('create - UTF 8 BOM - no content', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('create - UTF 8 BOM - content provided', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'small_new.utf8bom'));
            yield service.create(resource, 'Hello World');
            assert.equal(yield pfs_1.exists(resource.fsPath), true);
            const detectedEncoding = yield encoding_test_1.detectEncodingByBOM(resource.fsPath);
        ...
        test('create - UTF 8 BOM - empty content - snapshot', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'small_new.utf8bom'));
        ...
        test('create - UTF 8 BOM - content provided - snapshot', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'small_new.utf8bom'));
        ...
        test('write - use encoding (UTF 16 BE) - small content as string', () => __awaiter(void 0, void 0, void 0, function* () {
            yield testEncoding(uri_1.URI.file(path_1.join(testDir, 'small.txt')), encoding_1.UTF16be, 'Hello\nWorld', 'Hello\nWorld');
        }));
        test('write - use encoding (UTF 16 BE) - small content as snapshot', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('write - use encoding (UTF 16 BE) - large content as string', () => __awaiter(void 0, void 0, void 0, function* () {
            yield testEncoding(uri_1.URI.file(path_1.join(testDir, 'lorem.txt')), encoding_1.UTF16be, 'Hello\nWorld', 'Hello\nWorld');
        }));
        test('write - use encoding (UTF 16 BE) - large content as snapshot', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('write - use encoding (cp1252)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('write - use encoding (shiftjis)', () => __awaiter(void 0, void 0, void 0, function* () {
            yield testEncodingKeepsData(uri_1.URI.file(path_1.join(testDir, 'some_shiftjs.txt')), 'shiftjis', '中文abc');
        }));
        test('write - use encoding (gbk)', () => __awaiter(void 0, void 0, void 0, function* () {
            yield testEncodingKeepsData(uri_1.URI.file(path_1.join(testDir, 'some_gbk.txt')), 'gbk', '中国abc');
        }));
        test('write - use encoding (cyrillic)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('write - use encoding (big5)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('write - no encoding - content as string', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('write - no encoding - content as snapshot', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'small.txt'));
            const content = (yield pfs_1.readFile(resource.fsPath)).toString();
        ...
        test('write - encoding preserved (UTF 16 LE) - content as string', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('write - encoding preserved (UTF 16 LE) - content as snapshot', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'some_utf16le.css'));
            const resolved = yield service.readStream(resource);
            assert.equal(resolved.encoding, encoding_1.UTF16le);
        ...
        test('write - UTF8 variations - content as string', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('write - UTF8 variations - content as snapshot', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'index.html'));
            let detectedEncoding = yield encoding_test_1.detectEncodingByBOM(resource.fsPath);
            assert.equal(detectedEncoding, null);
        ...
        test('write - preserve UTF8 BOM - content as string', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('write - ensure BOM in empty file - content as string', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'small.txt'));
            yield service.write(resource, '', { encoding: encoding_1.UTF8_with_bom });
            let detectedEncoding = yield encoding_test_1.detectEncodingByBOM(resource.fsPath);
            assert.equal(detectedEncoding, encoding_1.UTF8);
        }));
        test('write - ensure BOM in empty file - content as snapshot', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'small.txt'));
            yield service.write(resource, textModel_1.TextModel.createFromString('').createSnapshot(), { encoding: encoding_1.UTF8_with_bom });
            let detectedEncoding = yield encoding_test_1.detectEncodingByBOM(resource.fsPath);
            assert.equal(detectedEncoding, encoding_1.UTF8);
        }));
        test('readStream - small text', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'small.txt'));
            yield testReadStream(resource);
        }));
        test('readStream - large text', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('read - small text', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'small.txt'));
            yield testRead(resource);
        }));
        test('read - large text', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'lorem.txt'));
            yield testRead(resource);
        }));
        ...
        test('readStream - encoding picked up (CP1252)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('read - encoding picked up (CP1252)', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'some_small_cp1252.txt'));
            const encoding = 'windows1252';
        ...
        test('read - encoding picked up (binary)', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'some_small_cp1252.txt'));
        ...
        test('read - encoding picked up (base64)', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'some_small_cp1252.txt'));
        ...
        test('readStream - user overrides BOM', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'some_utf16le.css'));
            const result = yield service.readStream(resource, { encoding: 'windows1252' });
            assert.equal(result.encoding, 'windows1252');
        }));
        test('readStream - BOM removed', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'some_utf8_bom.txt'));
            const result = yield service.readStream(resource);
            assert.equal(result.value.getFirstLineText(999999), 'This is some UTF 8 with BOM file.');
        }));
        test('readStream - invalid encoding', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'index.html'));
            const result = yield service.readStream(resource, { encoding: 'superduper' });
            assert.equal(result.encoding, 'utf8');
        }));
        test('readStream - encoding override', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('readStream - large Big5', () => __awaiter(void 0, void 0, void 0, function* () {
            yield testLargeEncoding('big5', '中文abc');
        }));
        test('readStream - large CP1252', () => __awaiter(void 0, void 0, void 0, function* () {
            yield testLargeEncoding('cp1252', 'öäüß');
        }));
        test('readStream - large Cyrillic', () => __awaiter(void 0, void 0, void 0, function* () {
            yield testLargeEncoding('cp866', 'АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя');
        }));
        test('readStream - large GBK', () => __awaiter(void 0, void 0, void 0, function* () {
            yield testLargeEncoding('gbk', '中国abc');
        }));
        test('readStream - large ShiftJS', () => __awaiter(void 0, void 0, void 0, function* () {
            yield testLargeEncoding('shiftjis', '中文abc');
        }));
        test('readStream - large UTF8 BOM', () => __awaiter(void 0, void 0, void 0, function* () {
            yield testLargeEncoding('utf8bom', 'öäüß');
        }));
        test('readStream - large UTF16 LE', () => __awaiter(void 0, void 0, void 0, function* () {
            yield testLargeEncoding('utf16le', 'öäüß');
        }));
        test('readStream - large UTF16 BE', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('readStream - UTF16 LE (no BOM)', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'utf16_le_nobom.txt'));
            const result = yield service.readStream(resource);
            assert.equal(result.encoding, 'utf16le');
        }));
        test('readStream - UTF16 BE (no BOM)', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'utf16_be_nobom.txt'));
            const result = yield service.readStream(resource);
            assert.equal(result.encoding, 'utf16be');
        }));
        test('readStream - autoguessEncoding', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('readStream - FILE_IS_BINARY', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('read - FILE_IS_BINARY', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = uri_1.URI.file(path_1.join(testDir, 'binary.txt'));
            let error = undefined;
            try {
