...
define(["require", "exports", "os", "vs/nls", "vs/workbench/services/textfile/browser/textFileService", "vs/workbench/services/textfile/common/textfiles", "vs/platform/instantiation/common/extensions", "vs/base/common/uri", "vs/platform/files/common/files", "vs/base/common/network", "vs/base/node/pfs", "vs/base/common/path", "vs/base/common/platform", "vs/platform/product/common/productService", "vs/editor/common/services/resourceConfiguration", "vs/platform/workspace/common/workspace", "vs/base/node/encoding", "vs/platform/workspaces/common/workspaces", "vs/base/common/resources", "vs/base/common/lifecycle", "vs/platform/environment/common/environment", "stream", "vs/editor/common/model/textModel", "vs/base/node/stream", "vs/platform/electron/node/electron", "vs/workbench/services/untitled/common/untitledEditorService", "vs/platform/lifecycle/common/lifecycle", "vs/platform/instantiation/common/instantiation", "vs/platform/configuration/common/configuration", "vs/editor/common/services/modeService", "vs/editor/common/services/modelService", "vs/workbench/services/environment/common/environmentService", "vs/platform/notification/common/notification", "vs/workbench/services/backup/common/backup", "vs/workbench/services/history/common/history", "vs/platform/contextkey/common/contextkey", "vs/platform/dialogs/common/dialogs", "vs/workbench/services/editor/common/editorService"], function (require, exports, os_1, nls_1, textFileService_1, textfiles_1, extensions_1, uri_1, files_1, network_1, pfs_1, path_1, platform_1, productService_1, resourceConfiguration_1, workspace_1, encoding_1, workspaces_1, resources_1, lifecycle_1, environment_1, stream_1, textModel_1, stream_2, electron_1, untitledEditorService_1, lifecycle_2, instantiation_1, configuration_1, modeService_1, modelService_1, environmentService_1, notification_1, backup_1, history_1, contextkey_1, dialogs_1, editorService_1) {
    "use strict";
    ...
    let NativeTextFileService = class NativeTextFileService extends textFileService_1.AbstractTextFileService {
        ...
        read(resource, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return Object.assign(Object.assign({}, bufferStream), { encoding: decoder.detected.encoding || encoding_1.UTF8, value: yield stream_2.nodeReadableToString(decoder.stream) });
            });
        }
        readStream(resource, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const [bufferStream, decoder] = yield this.doRead(resource, options);
                return Object.assign(Object.assign({}, bufferStream), { encoding: decoder.detected.encoding || encoding_1.UTF8, value: yield textModel_1.createTextBufferFactoryFromStream(decoder.stream) });
            });
        }
        doRead(resource, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const decoder = yield encoding_1.toDecodeStream(stream_2.streamToNodeReadable(bufferStream.value), {
                    guessEncoding: ((_a = options) === null || _a === void 0 ? void 0 : _a.autoGuessEncoding) || this.textResourceConfigurationService.getValue(resource, 'files.autoGuessEncoding'),
                    overwriteEncoding: detectedEncoding => this.encoding.getReadEncoding(resource, options, detectedEncoding)
                });
                // validate binary
                if (((_b = options) === null || _b === void 0 ? void 0 : _b.acceptTextOnly) && decoder.detected.seemsBinary) {
        ...
        write(resource, value, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    if (((_a = options) === null || _a === void 0 ? void 0 : _a.overwriteReadonly) && resource.scheme === network_1.Schemas.file && (yield pfs_1.exists(resource.fsPath))) {
                ...
                if (((_b = options) === null || _b === void 0 ? void 0 : _b.writeElevated) && resource.scheme === network_1.Schemas.file) {
        ...
        sudoPromptCopy(source, target, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    if ((_a = options) === null || _a === void 0 ? void 0 : _a.overwriteReadonly) {
        ...
        confirmSave(resources) {
            const _super = Object.create(null, {
                confirmSave: { get: () => super.confirmSave }
            });
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return _super.confirmSave.call(this, resources);
            });
        }
    };
    ...
    let EncodingOracle = class EncodingOracle extends lifecycle_1.Disposable {
        ...
        getWriteEncoding(resource, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const overwriteEncoding = (_a = options) === null || _a === void 0 ? void 0 : _a.overwriteEncoding;
        ...
        getReadEncoding(resource, options, detectedEncoding) {
            ...
            if ((_a = options) === null || _a === void 0 ? void 0 : _a.encoding) {
