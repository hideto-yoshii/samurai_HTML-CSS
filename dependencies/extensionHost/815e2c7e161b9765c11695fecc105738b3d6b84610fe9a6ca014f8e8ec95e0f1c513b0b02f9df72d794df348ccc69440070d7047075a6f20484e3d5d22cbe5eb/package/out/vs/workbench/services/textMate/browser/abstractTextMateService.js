...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/common/color", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/resources", "vs/base/common/types", "vs/editor/common/core/token", "vs/editor/common/modes", "vs/editor/common/modes/nullMode", "vs/editor/common/modes/supports/tokenization", "vs/editor/common/services/modeService", "vs/platform/log/common/log", "vs/platform/notification/common/notification", "vs/platform/storage/common/storage", "vs/workbench/services/textMate/common/TMGrammars", "vs/workbench/services/themes/common/workbenchThemeService", "vs/base/common/lifecycle", "vs/platform/configuration/common/configuration", "vs/workbench/services/textMate/common/TMGrammarFactory", "vs/workbench/services/extensionResourceLoader/common/extensionResourceLoader"], function (require, exports, nls, dom, color_1, errors_1, event_1, resources, types, token_1, modes_1, nullMode_1, tokenization_1, modeService_1, log_1, notification_1, storage_1, TMGrammars_1, workbenchThemeService_1, lifecycle_1, configuration_1, TMGrammarFactory_1, extensionResourceLoader_1) {
    ...
    let AbstractTextMateService = class AbstractTextMateService extends lifecycle_1.Disposable {
        ...
        _getOrCreateGrammarFactory() {
            return __awaiter(this, void 0, void 0, function* () {
                if (this._grammarFactory) {
                    return this._grammarFactory;
                }
                const vscodeTextmate = yield this._loadVSCodeTextmate();
        ...
        _registerDefinitionIfAvailable(modeId) {
            ...
            this._tokenizersRegistrations.push(modes_1.TokenizationRegistry.registerPromise(modeId, (() => __awaiter(this, void 0, void 0, function* () {
                try {
                    const grammarFactory = yield this._getOrCreateGrammarFactory();
                    if (!grammarFactory.has(languageId)) {
                        return null;
                    }
                    const r = yield grammarFactory.createGrammar(languageId);
        ...
        createGrammar(modeId) {
            return __awaiter(this, void 0, void 0, function* () {
                const grammarFactory = yield this._getOrCreateGrammarFactory();
                const { grammar } = yield grammarFactory.createGrammar(this._modeService.getLanguageIdentifier(modeId).id);
                return grammar;
            });
        }
