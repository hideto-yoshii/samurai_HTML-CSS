    ...
    class WorkspaceService extends lifecycle_1.Disposable {
        ...
        loadConfiguration(userConfigurationModel, remoteUserConfigurationModel) {
            ...
            return this.loadFolderConfigurations(folders)
                ...
                if (this.initialized) {
                    ...
                    this.triggerConfigurationChange(new configurationModels_1.ConfigurationChangeEvent().change(changedKeys), 4 /* WORKSPACE */);
                }
                else {
                    this._onDidChangeConfiguration.fire(new configurationModels_2.AllKeysConfigurationChangeEvent(this._configuration, 4 /* WORKSPACE */, this.getTargetConfiguration(4 /* WORKSPACE */)));
        ...
        onDefaultConfigurationChanged(keys) {
            ...
            if (this.workspace) {
                ...
                this.triggerConfigurationChange(new configurationModels_1.ConfigurationChangeEvent().change(keys), 6 /* DEFAULT */);
            }
        }
        ...
        onWorkspaceConfigurationChanged() {
            if (this.workspace && this.workspace.configuration) {
                ...
                let configuredFolders = workspace_1.toWorkspaceFolders(this.workspaceConfiguration.getFolders(), this.workspace.configuration);
