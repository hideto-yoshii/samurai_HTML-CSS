 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/platform/files/common/files", "vs/platform/instantiation/common/instantiation", "vs/platform/contextkey/common/contextkey", "vs/base/common/buffer", "vs/base/common/types", "vs/base/common/platform"], function (require, exports, files_1, instantiation_1, contextkey_1, buffer_1, types_1, platform_1) {
    "use strict";
    ...
    class TextFileOperationError extends files_1.FileOperationError {
        constructor(message, textFileOperationResult, options) {
            super(message, 10 /* FILE_OTHER_ERROR */);
    ...
    (function (ModelState) {
         ...
         */
        ModelState[ModelState["PENDING_AUTO_SAVE"] = 3] = "PENDING_AUTO_SAVE";
        /**
         * A model is in conflict mode when changes cannot be saved because the
         * underlying file has changed. Models in conflict mode are always dirty.
         */
        ModelState[ModelState["CONFLICT"] = 4] = "CONFLICT";
        /**
         * A model is in orphan state when the underlying file has been deleted.
         */
        ModelState[ModelState["ORPHAN"] = 5] = "ORPHAN";
        /**
         * Any error that happens during a save that is not causing the CONFLICT state.
         * Models in error mode are always diry.
         */
        ModelState[ModelState["ERROR"] = 6] = "ERROR";
