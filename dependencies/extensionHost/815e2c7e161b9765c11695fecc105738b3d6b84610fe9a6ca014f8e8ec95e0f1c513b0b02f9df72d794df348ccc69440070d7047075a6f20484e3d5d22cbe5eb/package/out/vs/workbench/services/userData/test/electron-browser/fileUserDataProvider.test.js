...
define(["require", "exports", "assert", "os", "vs/base/common/path", "vs/base/common/uuid", "vs/base/node/pfs", "vs/platform/files/common/fileService", "vs/platform/log/common/log", "vs/base/common/network", "vs/base/common/uri", "vs/workbench/services/userData/common/fileUserDataProvider", "vs/base/common/resources", "vs/base/common/buffer", "vs/platform/files/electron-browser/diskFileSystemProvider", "vs/platform/environment/common/environment", "vs/base/common/lifecycle", "vs/workbench/services/environment/browser/environmentService", "vs/base/common/event", "vs/base/common/async"], function (require, exports, assert, os, path, uuid, pfs, fileService_1, log_1, network_1, uri_1, fileUserDataProvider_1, resources_1, buffer_1, diskFileSystemProvider_1, environment_1, lifecycle_1, environmentService_1, event_1, async_1) {
    ...
    suite('FileUserDataProvider', () => {
        ...
        test('exists return false when file does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
            const exists = yield testObject.exists(resources_1.joinPath(userDataResource, 'settings.json'));
            assert.equal(exists, false);
        }));
        test('read file throws error if not exist', () => __awaiter(void 0, void 0, void 0, function* () {
            try {
        ...
        test('read existing file', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('write file creates the file if not exist', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = resources_1.joinPath(userDataResource, 'settings.json');
        ...
        test('write to existing file', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = resources_1.joinPath(userDataResource, 'settings.json');
            yield pfs.writeFile(path.join(userDataPath, 'settings.json'), '{}');
        ...
        test('resolve file', () => __awaiter(void 0, void 0, void 0, function* () {
            yield pfs.writeFile(path.join(userDataPath, 'settings.json'), '');
        ...
        test('exists return false for folder that does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
            const exists = yield testObject.exists(resources_1.joinPath(userDataResource, 'snippets'));
            assert.equal(exists, false);
        }));
        test('exists return true for folder that exists', () => __awaiter(void 0, void 0, void 0, function* () {
            yield pfs.mkdirp(path.join(userDataPath, 'snippets'));
            const exists = yield testObject.exists(resources_1.joinPath(userDataResource, 'snippets'));
            assert.equal(exists, true);
        }));
        test('read file throws error for folder', () => __awaiter(void 0, void 0, void 0, function* () {
            yield pfs.mkdirp(path.join(userDataPath, 'snippets'));
            try {
        ...
        test('read file under folder', () => __awaiter(void 0, void 0, void 0, function* () {
            yield pfs.mkdirp(path.join(userDataPath, 'snippets'));
        ...
        test('read file under sub folder', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('create file under folder that exists', () => __awaiter(void 0, void 0, void 0, function* () {
            yield pfs.mkdirp(path.join(userDataPath, 'snippets'));
            const resource = resources_1.joinPath(userDataResource, 'snippets/settings.json');
            const actual1 = yield testObject.createFile(resource, buffer_1.VSBuffer.fromString('{}'));
            assert.equal(actual1.resource.toString(), resource.toString());
        ...
        test('create file under folder that does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = resources_1.joinPath(userDataResource, 'snippets/settings.json');
            const actual1 = yield testObject.createFile(resource, buffer_1.VSBuffer.fromString('{}'));
            assert.equal(actual1.resource.toString(), resource.toString());
            const actual2 = yield pfs.readFile(path.join(userDataPath, 'snippets', 'settings.json'));
        ...
        test('write to not existing file under container that exists', () => __awaiter(void 0, void 0, void 0, function* () {
            yield pfs.mkdirp(path.join(userDataPath, 'snippets'));
            const resource = resources_1.joinPath(userDataResource, 'snippets/settings.json');
            const actual1 = yield testObject.writeFile(resource, buffer_1.VSBuffer.fromString('{}'));
            assert.equal(actual1.resource.toString(), resource.toString());
        ...
        test('write to not existing file under container that does not exists', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = resources_1.joinPath(userDataResource, 'snippets/settings.json');
            const actual1 = yield testObject.writeFile(resource, buffer_1.VSBuffer.fromString('{}'));
            assert.equal(actual1.resource.toString(), resource.toString());
            const actual = yield pfs.readFile(path.join(userDataPath, 'snippets', 'settings.json'));
        ...
        test('write to existing file under container', () => __awaiter(void 0, void 0, void 0, function* () {
            yield pfs.mkdirp(path.join(userDataPath, 'snippets'));
            yield pfs.writeFile(path.join(userDataPath, 'snippets', 'settings.json'), '{}');
            const resource = resources_1.joinPath(userDataResource, 'snippets/settings.json');
            const actual1 = yield testObject.writeFile(resource, buffer_1.VSBuffer.fromString('{a:1}'));
        ...
        test('write file under sub container', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = resources_1.joinPath(userDataResource, 'snippets/java/settings.json');
            const actual1 = yield testObject.writeFile(resource, buffer_1.VSBuffer.fromString('{}'));
            assert.equal(actual1.resource.toString(), resource.toString());
        ...
        test('delete throws error for folder that does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
            try {
        ...
        test('delete not existing file under container that exists', () => __awaiter(void 0, void 0, void 0, function* () {
            yield pfs.mkdirp(path.join(userDataPath, 'snippets'));
            try {
        ...
        test('delete not existing file under container that does not exists', () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                yield testObject.del(resources_1.joinPath(userDataResource, 'snippets/settings.json'));
                assert.fail('Should fail since file does not exist');
            }
        ...
        test('delete existing file under folder', () => __awaiter(void 0, void 0, void 0, function* () {
            yield pfs.mkdirp(path.join(userDataPath, 'snippets'));
            yield pfs.writeFile(path.join(userDataPath, 'snippets', 'settings.json'), '{}');
            yield testObject.del(resources_1.joinPath(userDataResource, 'snippets/settings.json'));
        ...
        test('resolve folder', () => __awaiter(void 0, void 0, void 0, function* () {
            yield pfs.mkdirp(path.join(userDataPath, 'snippets'));
            yield pfs.writeFile(path.join(userDataPath, 'snippets', 'settings.json'), '{}');
        ...
        test('read backup file', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('create backup file', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('write backup file', () => __awaiter(void 0, void 0, void 0, function* () {
            yield pfs.writeFile(path.join(backupsPath, 'backup.json'), '{}');
        ...
        test('resolve backups folder', () => __awaiter(void 0, void 0, void 0, function* () {
            yield pfs.writeFile(path.join(backupsPath, 'backup.json'), '{}');
    ...
    suite('FileUserDataProvider - Watching', () => {
        ...
        test('event is not triggered if file is not under user data', () => __awaiter(void 0, void 0, void 0, function* () {
