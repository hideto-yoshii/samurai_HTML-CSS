...
define(["require", "exports", "assert", "vs/base/common/platform", "crypto", "os", "fs", "vs/base/common/path", "vs/base/node/pfs", "vs/base/common/uri", "vs/workbench/services/backup/common/backupFileService", "vs/editor/common/model/textModel", "vs/base/test/node/testUtils", "vs/base/common/network", "vs/platform/files/common/fileService", "vs/platform/log/common/log", "vs/platform/files/node/diskFileSystemProvider", "vs/workbench/services/environment/electron-browser/environmentService", "vs/platform/environment/node/argv", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/backup/node/backupFileService", "vs/platform/environment/common/environment", "vs/workbench/services/userData/common/fileUserDataProvider", "vs/base/common/buffer"], function (require, exports, assert, platform, crypto, os, fs, path, pfs, uri_1, backupFileService_1, textModel_1, testUtils_1, network_1, fileService_1, log_1, diskFileSystemProvider_1, environmentService_1, argv_1, textfiles_1, backupFileService_2, environment_1, fileUserDataProvider_1, buffer_1) {
    ...
    class TestBackupEnvironmentService extends environmentService_1.NativeWorkbenchEnvironmentService {
        constructor(backupPath) {
            super(Object.assign(Object.assign({}, argv_1.parseArgs(process.argv, argv_1.OPTIONS)), { backupPath, 'user-data-dir': userdataDir }), process.execPath, 0);
        }
    }
    ...
    suite('BackupFileService', () => {
        ...
        suite('loadBackupResource', () => {
            test('should return whether a backup resource exists', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        suite('backupResource', () => {
            test('text file', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('text file (with version)', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('text file (with meta)', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('untitled file', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('text file (ITextSnapshot)', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('untitled file (ITextSnapshot)', () => __awaiter(void 0, void 0, void 0, function* () {
                const model = textModel_1.TextModel.createFromString('test');
            ...
            test('text file (large file, ITextSnapshot)', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('untitled file (large file, ITextSnapshot)', () => __awaiter(void 0, void 0, void 0, function* () {
                const largeString = (new Array(10 * 1024)).join('Large String\n');
                const model = textModel_1.TextModel.createFromString(largeString);
                yield service.backupResource(untitledFile, model.createSnapshot());
                assert.equal(fs.readdirSync(path.join(workspaceBackupPath, 'untitled')).length, 1);
        ...
        suite('discardAllWorkspaceBackups', () => {
            ...
            test('should disable further backups', () => __awaiter(void 0, void 0, void 0, function* () {
                yield service.discardAllWorkspaceBackups();
                yield service.backupResource(untitledFile, textModel_1.createTextBufferFactory('test').create(1 /* LF */).createSnapshot(false));
        ...
        suite('getWorkspaceFileBackups', () => {
            test('("file") - text file', () => __awaiter(void 0, void 0, void 0, function* () {
                yield service.backupResource(fooFile, textModel_1.createTextBufferFactory('test').create(1 /* LF */).createSnapshot(false));
            ...
            test('("file") - untitled file', () => __awaiter(void 0, void 0, void 0, function* () {
                yield service.backupResource(untitledFile, textModel_1.createTextBufferFactory('test').create(1 /* LF */).createSnapshot(false));
                const textFiles = yield service.getWorkspaceFileBackups();
                assert.deepEqual(textFiles.map(f => f.fsPath), [untitledFile.fsPath]);
            }));
            test('("untitled") - untitled file', () => __awaiter(void 0, void 0, void 0, function* () {
                yield service.backupResource(untitledFile, textModel_1.createTextBufferFactory('test').create(1 /* LF */).createSnapshot(false));
                const textFiles = yield service.getWorkspaceFileBackups();
        ...
        suite('resolveBackupContent', () => {
            test('should restore the original contents (untitled file)', () => __awaiter(void 0, void 0, void 0, function* () {
                const contents = 'test\nand more stuff';
                yield testResolveBackup(untitledFile, contents);
            }));
            test('should restore the original contents (untitled file with metadata)', () => __awaiter(void 0, void 0, void 0, function* () {
                const contents = 'test\nand more stuff';
                const meta = {
                    etag: 'the Etag',
                    size: 666,
            ...
            test('should restore the original contents (text file)', () => __awaiter(void 0, void 0, void 0, function* () {
                const contents = [
                    'Lorem ipsum ',
                    'dolor öäü sit amet ',
                    'consectetur ',
            ...
            test('should restore the original contents (text file - custom scheme)', () => __awaiter(void 0, void 0, void 0, function* () {
                const contents = [
                    'Lorem ipsum ',
                    'dolor öäü sit amet ',
                    'consectetur ',
            ...
            test('should restore the original contents (text file with metadata)', () => __awaiter(void 0, void 0, void 0, function* () {
                const contents = [
                    'Lorem ipsum ',
                    'dolor öäü sit amet ',
                    'adipiscing ßß elit',
            ...
            test('should restore the original contents (text file with metadata changed once)', () => __awaiter(void 0, void 0, void 0, function* () {
                const contents = [
                    'Lorem ipsum ',
                    'dolor öäü sit amet ',
                    'adipiscing ßß elit',
            ...
            test('should restore the original contents (text file with broken metadata)', () => __awaiter(void 0, void 0, void 0, function* () {
                const contents = [
                    'Lorem ipsum ',
                    'dolor öäü sit amet ',
                    'adipiscing ßß elit',
            ...
            test('should restore the original contents (text file with metadata and fragment URI)', () => __awaiter(void 0, void 0, void 0, function* () {
                const contents = [
                    'Lorem ipsum ',
                    'dolor öäü sit amet ',
                    'adipiscing ßß elit',
            ...
            test('should restore the original contents (text file with space in name with metadata)', () => __awaiter(void 0, void 0, void 0, function* () {
                const contents = [
                    'Lorem ipsum ',
                    'dolor öäü sit amet ',
                    'adipiscing ßß elit',
            ...
            test('should restore the original contents (text file with too large metadata to persist)', () => __awaiter(void 0, void 0, void 0, function* () {
                const contents = [
                    'Lorem ipsum ',
                    'dolor öäü sit amet ',
                    'adipiscing ßß elit',
            ...
            test('should throw an error when restoring invalid backup', () => __awaiter(void 0, void 0, void 0, function* () {
                const contents = 'test\nand more stuff';
