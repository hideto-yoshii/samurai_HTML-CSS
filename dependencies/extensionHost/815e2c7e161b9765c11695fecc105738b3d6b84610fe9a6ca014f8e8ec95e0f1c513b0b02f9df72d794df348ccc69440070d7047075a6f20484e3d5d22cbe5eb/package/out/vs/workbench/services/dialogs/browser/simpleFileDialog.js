...
define(["require", "exports", "vs/nls", "vs/base/common/resources", "vs/base/common/objects", "vs/platform/files/common/files", "vs/platform/quickinput/common/quickInput", "vs/base/common/uri", "vs/base/common/platform", "vs/platform/dialogs/common/dialogs", "vs/platform/remote/common/remoteHosts", "vs/platform/label/common/label", "vs/platform/workspace/common/workspace", "vs/platform/notification/common/notification", "vs/editor/common/services/modelService", "vs/editor/common/services/modeService", "vs/editor/common/services/getIconClasses", "vs/base/common/network", "vs/workbench/services/environment/common/environmentService", "vs/workbench/services/remote/common/remoteAgentService", "vs/platform/contextkey/common/contextkey", "vs/base/common/strings", "vs/platform/keybinding/common/keybinding", "vs/base/common/extpath", "vs/workbench/browser/contextkeys", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/async", "vs/workbench/services/textfile/common/textfiles", "vs/workbench/services/editor/common/editorService", "vs/workbench/common/editor", "vs/base/common/labels"], function (require, exports, nls, resources, objects, files_1, quickInput_1, uri_1, platform_1, dialogs_1, remoteHosts_1, label_1, workspace_1, notification_1, modelService_1, modeService_1, getIconClasses_1, network_1, environmentService_1, remoteAgentService_1, contextkey_1, strings_1, keybinding_1, extpath_1, contextkeys_1, event_1, lifecycle_1, async_1, textfiles_1, editorService_1, editor_1, labels_1) {
    "use strict";
    ...
    let SimpleFileDialog = class SimpleFileDialog {
        constructor(fileService, quickInputService, labelService, workspaceContextService, notificationService, fileDialogService, modelService, modeService, environmentService, remoteAgentService, keybindingService, contextKeyService) {
        ...
        showOpenDialog(options = {}) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                this.userHome = yield this.getUserHome();
                const newOptions = yield this.getOptions(options);
                if (!newOptions) {
                    return Promise.resolve(undefined);
                }
        ...
        showSaveDialog(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const newOptions = yield this.getOptions(options, true);
                if (!newOptions) {
                    return Promise.resolve(undefined);
                }
                this.options = newOptions;
        ...
        remoteUriFrom(path) {
            path = path.replace(/\\/g, '/');
            return resources.toLocalResource(uri_1.URI.from({ scheme: this.scheme, path }), this.scheme === network_1.Schemas.file ? undefined : this.remoteAuthority);
        }
        ...
        getRemoteAgentEnvironment() {
            return __awaiter(this, void 0, void 0, function* () {
                if (this.remoteAgentEnvironment === undefined) {
                    this.remoteAgentEnvironment = yield this.remoteAgentService.getEnvironment();
                }
        ...
        getUserHome() {
            return __awaiter(this, void 0, void 0, function* () {
                if (this.scheme !== network_1.Schemas.file) {
                    const env = yield this.getRemoteAgentEnvironment();
                    if (env) {
                        return env.userHome;
                    }
                }
                return uri_1.URI.from({ scheme: this.scheme, path: this.environmentService.userHome });
            });
        }
        pickResource(isSave = false) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.options.defaultUri) {
                    try {
                        stat = yield this.fileService.resolve(this.options.defaultUri);
                    }
                    catch (e) {
                ...
                return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield this.updateItems(homedir, true, this.trailing);
                    if (this.trailing) {
                    ...
                    if (this.isValueChangeFromUser()) {
                        ...
                        if (!strings_1.equalsIgnoreCase(value, this.constructFullUserPath()) && !this.isBadSubpath(value)) {
                            ...
                            if (!resources.isEqual(this.currentFolder, filePickBoxUri, true)) {
                                updated = yield this.tryUpdateItems(value, filePickBoxUri);
                            }
        ...
        onDidAccept() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.filePickBox.activeItems.length === 1) {
                    ...
                    if (item.isFolder) {
                        if (this.trailing) {
                            yield this.updateItems(item.uri, true, this.trailing);
                        }
                        else {
                            ...
                            if (strings_1.startsWithIgnoreCase(newPath, this.filePickBox.value) && (strings_1.equalsIgnoreCase(item.label, resources.basename(item.uri)))) {
                                ...
                                yield this.updateItems(item.uri, true);
                            }
                        }
                    ...
                    if ((yield this.tryUpdateItems(this.filePickBox.value, this.filePickBoxValue())) !== UpdateResult.NotUpdated) {
                        this.filePickBox.busy = false;
                        return;
                    }
                }
                ...
                if ((value.length > 0) && ((value[value.length - 1] === '~') || (value[0] === '~'))) {
                    ...
                    if (stat && stat.isDirectory && (resources.basename(valueUri) !== '.') && this.endsWithSlash(value)) {
                        ...
                        if (!resources.isEqual(resources.removeTrailingPathSeparator(this.currentFolder), inputUriDirname, true)) {
                            ...
                            try {
                                statWithoutTrailing = yield this.fileService.resolve(inputUriDirname);
                            }
                            catch (e) {
                                // do nothing
                            }
                            if (statWithoutTrailing && statWithoutTrailing.isDirectory) {
                                yield this.updateItems(inputUriDirname, false, resources.basename(valueUri));
        ...
        validate(uri) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let statDirname;
                try {
                    statDirname = yield this.fileService.resolve(resources.dirname(uri));
                    stat = yield this.fileService.resolve(uri);
                }
                catch (e) {
                    // do nothing
                }
                if (this.requiresTrailing) { // save
                    ...
                    else if (!(extpath_1.isValidBasename(resources.basename(uri), yield this.isWindowsOS()))) {
        ...
        updateItems(newFolder, force = false, trailing) {
            return __awaiter(this, void 0, void 0, function* () {
                this.busy = true;
                ...
                const updatingPromise = async_1.createCancelablePromise((token) => __awaiter(this, void 0, void 0, function* () {
        ...
        createItems(currentFolder, token) {
            return __awaiter(this, void 0, void 0, function* () {
                const result = [];
                const backDir = this.createBackItem(currentFolder);
                try {
                    const folder = yield this.fileService.resolve(currentFolder);
                    const fileNames = folder.children ? folder.children.map(child => child.name) : [];
                    const items = yield Promise.all(fileNames.map(fileName => this.createItem(fileName, currentFolder, token)));
        ...
        createItem(filename, parent, token) {
            return __awaiter(this, void 0, void 0, function* () {
                if (token.isCancellationRequested) {
                    return undefined;
                }
                ...
                try {
                    const stat = yield this.fileService.resolve(fullPath);
                    if (stat.isDirectory) {
