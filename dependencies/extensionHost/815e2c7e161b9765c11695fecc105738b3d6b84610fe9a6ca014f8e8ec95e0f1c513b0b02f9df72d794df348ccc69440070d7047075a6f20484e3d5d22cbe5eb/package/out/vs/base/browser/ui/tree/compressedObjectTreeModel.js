...
define(["require", "exports", "vs/base/common/iterator", "vs/base/common/event", "vs/base/browser/ui/tree/tree", "vs/base/browser/ui/tree/objectTreeModel"], function (require, exports, iterator_1, event_1, tree_1, objectTreeModel_1) {
    ...
    function splice(treeElement, element, children) {
        ...
        return Object.assign(Object.assign({}, treeElement), { children: iterator_1.Iterator.map(iterator_1.Iterator.from(treeElement.children), e => splice(e, element, children)) });
    }
    // Exported only for test reasons, do not use directly
    class CompressedObjectTreeModel {
        ...
        setChildren(element, children) {
            if (element === null) {
                const compressedChildren = iterator_1.Iterator.map(iterator_1.Iterator.from(children), this.enabled ? compress : noCompress);
        ...
        setCompressionEnabled(enabled) {
            ...
            const rootChildren = iterator_1.Iterator.from(root.children);
            const decompressedRootChildren = iterator_1.Iterator.map(rootChildren, decompress);
            const recompressedRootChildren = iterator_1.Iterator.map(decompressedRootChildren, enabled ? compress : noCompress);
    ...
    class CompressibleObjectTreeModel {
        ...
        getCompressedTreeNode(element) {
            return this.model.getNode(element);
        }
    }
