    ...
    class AsyncDataTree {
        ...
        setInput(input, viewState) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield this._updateChildren(input, true, viewStateContext);
                if (viewStateContext) {
        ...
        updateChildren(element = this.root.element, recursive = true) {
            return __awaiter(this, void 0, void 0, function* () {
                yield this._updateChildren(element, recursive);
            });
        }
        _updateChildren(element = this.root.element, recursive = true, viewStateContext) {
            return __awaiter(this, void 0, void 0, function* () {
