...
define(["require", "exports"], function (require, exports) {
    ...
    function nextCharLength(str, offset) {
        ...
        offset += (codePoint >= 65536 /* UNICODE_SUPPLEMENTARY_PLANE_BEGIN */ ? 2 : 1);
        while (offset < len) {
    ...
    function isUnicodeMark(codePoint) {
        return MarkClassifier.getInstance().isUnicodeMark(codePoint);
    }
    exports.isUnicodeMark = isUnicodeMark;
