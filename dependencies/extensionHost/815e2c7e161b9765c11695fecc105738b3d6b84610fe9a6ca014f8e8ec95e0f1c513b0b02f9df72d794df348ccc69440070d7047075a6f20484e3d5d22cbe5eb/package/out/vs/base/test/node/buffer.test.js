...
define(["require", "exports", "assert", "vs/base/common/buffer", "vs/base/common/async"], function (require, exports, assert, buffer_1, async_1) {
    ...
    suite('Buffer', () => {
        ...
        test('bufferToStream / streamToBuffer', () => __awaiter(void 0, void 0, void 0, function* () {
            const content = 'Hello World';
        ...
        test('bufferWriteableStream - basics (no error)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('bufferWriteableStream - basics (error)', () => __awaiter(void 0, void 0, void 0, function* () {
            const stream = buffer_1.writeableBufferStream();
            let chunks = [];
            stream.on('data', data => {
                chunks.push(data);
        ...
        test('bufferWriteableStream - buffers data when no listener', () => __awaiter(void 0, void 0, void 0, function* () {
            const stream = buffer_1.writeableBufferStream();
            yield async_1.timeout(0);
            stream.write(buffer_1.VSBuffer.fromString('Hello'));
            yield async_1.timeout(0);
        ...
        test('bufferWriteableStream - buffers errors when no listener', () => __awaiter(void 0, void 0, void 0, function* () {
            const stream = buffer_1.writeableBufferStream();
            yield async_1.timeout(0);
            stream.write(buffer_1.VSBuffer.fromString('Hello'));
            yield async_1.timeout(0);
        ...
        test('bufferWriteableStream - buffers end when no listener', () => __awaiter(void 0, void 0, void 0, function* () {
            const stream = buffer_1.writeableBufferStream();
            yield async_1.timeout(0);
            stream.write(buffer_1.VSBuffer.fromString('Hello'));
            yield async_1.timeout(0);
        ...
        test('bufferWriteableStream - nothing happens after end()', () => __awaiter(void 0, void 0, void 0, function* () {
            const stream = buffer_1.writeableBufferStream();
            let chunks = [];
            stream.on('data', data => {
                chunks.push(data);
        ...
        test('bufferWriteableStream - pause/resume (simple)', () => __awaiter(void 0, void 0, void 0, function* () {
            const stream = buffer_1.writeableBufferStream();
            let chunks = [];
            stream.on('data', data => {
                chunks.push(data);
        ...
        test('bufferWriteableStream - pause/resume (pause after first write)', () => __awaiter(void 0, void 0, void 0, function* () {
            const stream = buffer_1.writeableBufferStream();
            let chunks = [];
            stream.on('data', data => {
                chunks.push(data);
        ...
        test('bufferWriteableStream - pause/resume (error)', () => __awaiter(void 0, void 0, void 0, function* () {
            const stream = buffer_1.writeableBufferStream();
            let chunks = [];
            stream.on('data', data => {
                chunks.push(data);
        ...
        test('bufferWriteableStream - destroy', () => __awaiter(void 0, void 0, void 0, function* () {
            const stream = buffer_1.writeableBufferStream();
            let chunks = [];
            stream.on('data', data => {
                chunks.push(data);
