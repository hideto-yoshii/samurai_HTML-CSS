...
define(["require", "exports", "assert", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/errors", "vs/base/common/async"], function (require, exports, assert, event_1, lifecycle_1, Errors, async_1) {
    ...
    suite('Event utils', () => {
        ...
        suite('fromPromise', () => {
            test('should emit when done', () => __awaiter(void 0, void 0, void 0, function* () {
                let count = 0;
            ...
            test('should emit when done - setTimeout', () => __awaiter(void 0, void 0, void 0, function* () {
                let count = 0;
        ...
        suite('buffer', () => {
            ...
            test('should buffer events on next tick', () => __awaiter(void 0, void 0, void 0, function* () {
                const result = [];
                const emitter = new event_1.Emitter();
                const event = emitter.event;
