...
define(["require", "exports", "assert", "vs/base/browser/ui/list/rangeMap", "vs/base/common/range"], function (require, exports, assert, rangeMap_1, range_1) {
    ...
    suite('RangeMap', () => {
        ...
        test('intersection', () => {
            assert.deepEqual(range_1.Range.intersect({ start: 0, end: 0 }, { start: 0, end: 0 }), { start: 0, end: 0 });
            assert.deepEqual(range_1.Range.intersect({ start: 0, end: 0 }, { start: 5, end: 5 }), { start: 0, end: 0 });
            assert.deepEqual(range_1.Range.intersect({ start: 0, end: 1 }, { start: 5, end: 6 }), { start: 0, end: 0 });
            assert.deepEqual(range_1.Range.intersect({ start: 5, end: 6 }, { start: 0, end: 1 }), { start: 0, end: 0 });
            assert.deepEqual(range_1.Range.intersect({ start: 0, end: 5 }, { start: 2, end: 2 }), { start: 0, end: 0 });
            assert.deepEqual(range_1.Range.intersect({ start: 0, end: 1 }, { start: 0, end: 1 }), { start: 0, end: 1 });
            assert.deepEqual(range_1.Range.intersect({ start: 0, end: 10 }, { start: 0, end: 5 }), { start: 0, end: 5 });
            assert.deepEqual(range_1.Range.intersect({ start: 0, end: 5 }, { start: 0, end: 10 }), { start: 0, end: 5 });
            assert.deepEqual(range_1.Range.intersect({ start: 0, end: 10 }, { start: 5, end: 10 }), { start: 5, end: 10 });
            assert.deepEqual(range_1.Range.intersect({ start: 5, end: 10 }, { start: 0, end: 10 }), { start: 5, end: 10 });
            assert.deepEqual(range_1.Range.intersect({ start: 0, end: 10 }, { start: 2, end: 8 }), { start: 2, end: 8 });
            assert.deepEqual(range_1.Range.intersect({ start: 2, end: 8 }, { start: 0, end: 10 }), { start: 2, end: 8 });
            assert.deepEqual(range_1.Range.intersect({ start: 0, end: 10 }, { start: 5, end: 15 }), { start: 5, end: 10 });
            assert.deepEqual(range_1.Range.intersect({ start: 5, end: 15 }, { start: 0, end: 10 }), { start: 5, end: 10 });
        });
        test('multiIntersect', () => {
