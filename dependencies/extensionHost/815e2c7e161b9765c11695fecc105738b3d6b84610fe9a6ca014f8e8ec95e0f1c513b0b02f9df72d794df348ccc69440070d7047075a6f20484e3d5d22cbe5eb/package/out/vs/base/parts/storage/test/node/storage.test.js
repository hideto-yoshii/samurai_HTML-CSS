...
define(["require", "exports", "vs/base/parts/storage/node/storage", "vs/base/parts/storage/common/storage", "vs/base/common/uuid", "vs/base/common/path", "os", "assert", "vs/base/node/pfs", "vs/base/common/async", "vs/base/common/event", "vs/base/common/platform"], function (require, exports, storage_1, storage_2, uuid_1, path_1, os_1, assert_1, pfs_1, async_1, event_1, platform_1) {
    ...
    suite('Storage Library', () => {
        ...
        test('external changes', () => __awaiter(void 0, void 0, void 0, function* () {
            const storageDir = uniqueStorageDir();
            yield pfs_1.mkdirp(storageDir);
        ...
        test('close flushes data', () => __awaiter(void 0, void 0, void 0, function* () {
            const storageDir = uniqueStorageDir();
            yield pfs_1.mkdirp(storageDir);
        ...
        test('conflicting updates', () => __awaiter(void 0, void 0, void 0, function* () {
            const storageDir = uniqueStorageDir();
            yield pfs_1.mkdirp(storageDir);
            let storage = new storage_2.Storage(new storage_1.SQLiteStorageDatabase(path_1.join(storageDir, 'storage.db')));
            yield storage.init();
        ...
        test('corrupt DB recovers', () => __awaiter(void 0, void 0, void 0, function* () {
            const storageDir = uniqueStorageDir();
            yield pfs_1.mkdirp(storageDir);
    ...
    suite('SQLite Storage Library', () => {
        ...
        test('basics (open multiple times)', () => __awaiter(void 0, void 0, void 0, function* () {
            const storageDir = uniqueStorageDir();
            yield pfs_1.mkdirp(storageDir);
            yield testDBBasics(path_1.join(storageDir, 'storage.db'));
            yield testDBBasics(path_1.join(storageDir, 'storage.db'));
        ...
        test('basics (corrupt DB falls back to empty DB)', () => __awaiter(void 0, void 0, void 0, function* () {
            const storageDir = uniqueStorageDir();
            yield pfs_1.mkdirp(storageDir);
        ...
        test('basics (corrupt DB restores from previous backup)', () => __awaiter(void 0, void 0, void 0, function* () {
            const storageDir = uniqueStorageDir();
            yield pfs_1.mkdirp(storageDir);
        ...
        test('basics (corrupt DB falls back to empty DB if backup is corrupt)', () => __awaiter(void 0, void 0, void 0, function* () {
            const storageDir = uniqueStorageDir();
            yield pfs_1.mkdirp(storageDir);
            const storagePath = path_1.join(storageDir, 'storage.db');
            let storage = new storage_1.SQLiteStorageDatabase(storagePath);
        ...
        test('basics (DB that becomes corrupt during runtime stores all state from cache on close)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('multiple concurrent writes execute in sequence', () => __awaiter(void 0, void 0, void 0, function* () {
            const storageDir = uniqueStorageDir();
            yield pfs_1.mkdirp(storageDir);
        ...
        test('lots of INSERT & DELETE (below inline max)', () => __awaiter(void 0, void 0, void 0, function* () {
            const storageDir = uniqueStorageDir();
            yield pfs_1.mkdirp(storageDir);
        ...
        test('lots of INSERT & DELETE (above inline max)', () => __awaiter(void 0, void 0, void 0, function* () {
            const storageDir = uniqueStorageDir();
            yield pfs_1.mkdirp(storageDir);
            const storage = new storage_1.SQLiteStorageDatabase(path_1.join(storageDir, 'storage.db'));
            const items = new Map();
