...
define(["require", "exports", "vs/base/common/event", "vs/base/common/async", "vs/base/common/map", "vs/base/common/path", "vs/base/node/pfs", "vs/base/common/arrays"], function (require, exports, event_1, async_1, map_1, path_1, pfs_1, arrays_1) {
    "use strict";
    ...
    class SQLiteStorageDatabase {
        ...
        getItems() {
            return __awaiter(this, void 0, void 0, function* () {
                const connection = yield this.whenConnected;
                const items = new Map();
                const rows = yield this.all(connection, 'SELECT * FROM ItemTable');
        ...
        checkIntegrity(full) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const connection = yield this.whenConnected;
                const row = yield this.get(connection, full ? 'PRAGMA integrity_check' : 'PRAGMA quick_check');
        ...
        connect(path, retryOnBusy = true) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    return yield this.doConnect(path);
                }
                catch (error) {
                    ...
                    if (error.code === 'SQLITE_BUSY' && retryOnBusy) {
                        yield async_1.timeout(SQLiteStorageDatabase.BUSY_OPEN_TIMEOUT);
                    ...
                    //
                    try {
                        yield pfs_1.unlink(path);
                        yield pfs_1.renameIgnoreError(this.toBackupPath(path), path);
                        return yield this.doConnect(path);
                    }
                    catch (error) {
