...
define(["require", "exports", "electron", "vs/base/common/objects", "vs/base/common/platform", "vs/platform/product/common/product", "vs/platform/environment/node/argvHelper", "vs/platform/environment/node/waitMarkerFile", "vs/base/node/pfs", "vs/code/node/paths", "vs/platform/lifecycle/electron-main/lifecycleMainService", "vs/base/parts/ipc/node/ipc.net", "vs/base/parts/ipc/node/ipc", "vs/platform/instantiation/common/instantiationService", "vs/platform/instantiation/common/serviceCollection", "vs/platform/instantiation/common/descriptors", "vs/platform/log/common/log", "vs/platform/state/node/stateService", "vs/platform/state/node/state", "vs/platform/environment/common/environment", "vs/platform/environment/node/environmentService", "vs/platform/configuration/common/configuration", "vs/platform/configuration/node/configurationService", "vs/platform/request/common/request", "vs/platform/request/electron-main/requestMainService", "fs", "vs/code/electron-main/app", "vs/nls", "vs/base/common/labels", "vs/platform/log/node/spdlogService", "vs/platform/log/common/bufferLog", "vs/base/common/errors", "vs/platform/theme/electron-main/themeMainService", "vs/base/common/functional", "vs/platform/sign/common/sign", "vs/platform/sign/node/signService", "vs/platform/diagnostics/node/diagnosticsIpc", "vs/platform/update/common/update.config.contribution"], function (require, exports, electron_1, objects_1, platform_1, product_1, argvHelper_1, waitMarkerFile_1, pfs_1, paths_1, lifecycleMainService_1, ipc_net_1, ipc_1, instantiationService_1, serviceCollection_1, descriptors_1, log_1, stateService_1, state_1, environment_1, environmentService_1, configuration_1, configurationService_1, request_1, requestMainService_1, fs, app_1, nls_1, labels_1, spdlogService_1, bufferLog_1, errors_1, themeMainService_1, functional_1, sign_1, signService_1, diagnosticsIpc_1) {
    ...
    class CodeMain {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    yield instantiationService.invokeFunction((accessor) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const configurationService = accessor.get(configuration_1.IConfigurationService);
                        const mainIpcServer = yield this.doStartup(logService, environmentService, lifecycleMainService, instantiationService, true);
        ...
        doStartup(logService, environmentService, lifecycleMainService, instantiationService, retry) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    if (environmentService.args.status) {
                        return instantiationService.invokeFunction((accessor) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            const mainProcessInfo = yield launchService.getMainProcessInfo();
                            const remoteDiagnostics = yield launchService.getRemoteDiagnostics({ includeProcesses: true, includeWorkspaceMetadata: true });
                    ...
                    if (platform_1.isWindows) {
                        yield this.windowsAllowSetForegroundWindow(launchService, logService);
                    }
                    // Send environment over...
                    logService.trace('Sending env to running instance...');
                    yield launchService.start(environmentService.args, process.env);
                    // Cleanup
                    client.dispose();
        ...
        windowsAllowSetForegroundWindow(launchService, logService) {
            return __awaiter(this, void 0, void 0, function* () {
                if (platform_1.isWindows) {
                    const processId = yield launchService.getMainProcessId();
