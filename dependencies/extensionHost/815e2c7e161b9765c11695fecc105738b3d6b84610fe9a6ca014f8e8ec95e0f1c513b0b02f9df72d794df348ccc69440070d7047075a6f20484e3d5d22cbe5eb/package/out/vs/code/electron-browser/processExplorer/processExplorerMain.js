    ...
    function createCloseListener() {
        ...
        window.addEventListener('keydown', e => {
            ...
            if (cmdOrCtrlKey && e.keyCode === 87) {
                electron_1.ipcRenderer.send('vscode:closeProcessExplorer');
            }
        });
    }
