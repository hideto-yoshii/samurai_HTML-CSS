        ...
        run(argv) {
            return __awaiter(this, void 0, void 0, function* () {
                if (argv['install-source']) {
                    ...
                    yield this.installExtensions(argv['install-extension'], !!argv['force']);
                }
                else if (argv['uninstall-extension']) {
                    yield this.uninstallExtension(argv['uninstall-extension']);
                }
                else if (argv['locate-extension']) {
                    yield this.locateExtension(argv['locate-extension']);
                }
