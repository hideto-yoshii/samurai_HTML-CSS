...
define(["require", "exports", "os", "fs", "child_process", "vs/platform/environment/node/argv", "vs/platform/environment/node/argvHelper", "vs/platform/environment/node/waitMarkerFile", "vs/platform/product/common/product", "vs/base/common/path", "vs/base/node/pfs", "vs/base/node/ports", "vs/base/node/encoding", "vs/base/common/platform", "vs/base/common/types"], function (require, exports, os, fs, child_process_1, argv_1, argvHelper_1, waitMarkerFile_1, product_1, paths, pfs_1, ports_1, encoding_1, platform_1, types_1) {
    "use strict";
                ...
                if (stdinWithoutTty) {
                    ...
                    if (args._.length === 0 && readFromStdin) {
                        ...
                        if (!stdinFileError) {
                            ...
                            encoding_1.resolveTerminalEncoding(verbose).then((encoding) => __awaiter(this, void 0, void 0, function* () {
                                const iconv = yield new Promise((resolve_1, reject_1) => { require(['iconv-lite'], resolve_1, reject_1); });
