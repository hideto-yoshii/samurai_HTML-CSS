...
define(["require", "exports", "vs/nls", "vs/base/common/async", "vs/base/common/keyCodes", "vs/base/common/lifecycle", "vs/editor/browser/editorExtensions", "vs/editor/common/controller/cursorMoveCommands", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/editorContextKeys", "vs/editor/common/model", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/editor/contrib/find/findController", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/platform/contextkey/common/contextkey"], function (require, exports, nls, async_1, keyCodes_1, lifecycle_1, editorExtensions_1, cursorMoveCommands_1, range_1, selection_1, editorContextKeys_1, model_1, textModel_1, modes_1, findController_1, colorRegistry_1, themeService_1, contextkey_1) {
    ...
    class MultiCursorSession {
        ...
        _getNextMatch() {
            ...
            const nextMatch = this._editor.getModel().findNextMatch(this.searchText, lastAddedSelection.getEndPosition(), false, this.matchCase, this.wholeWord ? this._editor.getOption(91 /* wordSeparators */) : null, false);
            if (!nextMatch) {
                return null;
            }
        ...
        _getPreviousMatch() {
            ...
            const allSelections = this._editor.getSelections();
            const lastAddedSelection = allSelections[allSelections.length - 1];
            const previousMatch = this._editor.getModel().findPreviousMatch(this.searchText, lastAddedSelection.getStartPosition(), false, this.matchCase, this.wholeWord ? this._editor.getOption(91 /* wordSeparators */) : null, false);
            if (!previousMatch) {
                return null;
            }
        ...
        selectAll() {
            ...
            this.findController.highlightFindOptions();
            return this._editor.getModel().findMatches(this.searchText, true, false, this.matchCase, this.wholeWord ? this._editor.getOption(91 /* wordSeparators */) : null, false, 1073741824 /* MAX_SAFE_SMALL_INTEGER */);
        }
    }
    ...
    class MultiCursorSelectionController extends lifecycle_1.Disposable {
        ...
        selectAll(findController) {
            ...
            if (findState.isRevealed && findState.searchString.length > 0 && findState.isRegex) {
                matches = this._editor.getModel().findMatches(findState.searchString, true, findState.isRegex, findState.matchCase, findState.wholeWord ? this._editor.getOption(91 /* wordSeparators */) : null, false, 1073741824 /* MAX_SAFE_SMALL_INTEGER */);
            }
            else {
                this._beginSessionIfNeeded(findController);
                if (!this._session) {
    ...
    class SelectionHighlighter extends lifecycle_1.Disposable {
        constructor(editor) {
            super();
            this.editor = editor;
            this._isEnabled = editor.getOption(77 /* selectionHighlight */);
            this.decorations = [];
        ...
        static _createState(isEnabled, editor) {
            ...
            return new SelectionHighlighterState(r.searchText, r.matchCase, r.wholeWord ? editor.getOption(91 /* wordSeparators */) : null);
        }
        _setState(state) {
