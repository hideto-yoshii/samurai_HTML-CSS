        ...
        resolveRenameLocation(token) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (firstProvider.resolveRenameLocation) {
                    res = types_1.withNullAsUndefined(yield firstProvider.resolveRenameLocation(this.model, this.position, token));
                }
                if (!res) {
    ...
    let RenameController = class RenameController {
        ...
        run() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const newNameOrFocusFlag = yield this._renameInputField.getValue().getInput(loc.range, loc.text, selectionStart, selectionEnd);
                ...
                this.editor.focus();
                const renameOperation = async_1.raceCancellation(skeleton.provideRenameEdits(newNameOrFocusFlag, 0, [], this._cts.token), this._cts.token).then((renameResult) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const editResult = yield this._bulkEditService.apply(renameResult, { editor: this.editor });
                    // alert
