...
define(["require", "exports", "vs/base/browser/markdownRenderer", "vs/platform/opener/common/opener", "vs/editor/common/services/modeService", "vs/base/common/uri", "vs/base/common/errors", "vs/editor/common/modes/textToHtmlTokenizer", "vs/platform/instantiation/common/instantiation", "vs/base/common/event", "vs/base/common/lifecycle", "vs/editor/common/modes"], function (require, exports, markdownRenderer_1, opener_1, modeService_1, uri_1, errors_1, textToHtmlTokenizer_1, instantiation_1, event_1, lifecycle_1, modes_1) {
    "use strict";
            ...
            return {
                codeBlockRenderer: (languageAlias, value) => {
                    ...
                    return Promise.resolve(true).then(_ => {
                        ...
                        return `<span style="font-family: ${this._editor.getOption(31 /* fontInfo */).fontFamily}">${code}</span>`;
                    });
                },
                ...
                actionHandler: {
                    callback: (content) => {
                        ...
                        if (uri && this._openerService) {
                            this._openerService.open(uri, { fromUserGesture: true }).catch(errors_1.onUnexpectedError);
                        }
                    },
                    disposeables
                }
