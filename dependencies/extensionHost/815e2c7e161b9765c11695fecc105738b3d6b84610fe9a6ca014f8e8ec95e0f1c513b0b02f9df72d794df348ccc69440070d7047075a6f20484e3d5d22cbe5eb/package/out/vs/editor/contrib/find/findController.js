...
define(["require", "exports", "vs/nls", "vs/base/common/async", "vs/base/common/lifecycle", "vs/base/common/strings", "vs/editor/browser/editorExtensions", "vs/editor/common/editorContextKeys", "vs/editor/contrib/find/findModel", "vs/editor/contrib/find/findOptionsWidget", "vs/editor/contrib/find/findState", "vs/editor/contrib/find/findWidget", "vs/platform/clipboard/common/clipboardService", "vs/platform/contextkey/common/contextkey", "vs/platform/contextview/browser/contextView", "vs/platform/instantiation/common/instantiation", "vs/platform/keybinding/common/keybinding", "vs/platform/storage/common/storage", "vs/platform/theme/common/themeService", "vs/platform/notification/common/notification"], function (require, exports, nls, async_1, lifecycle_1, strings, editorExtensions_1, editorContextKeys_1, findModel_1, findOptionsWidget_1, findState_1, findWidget_1, clipboardService_1, contextkey_1, contextView_1, instantiation_1, keybinding_1, storage_1, themeService_1, notification_1) {
    ...
    let CommonFindController = class CommonFindController extends lifecycle_1.Disposable {
            ...
            this._register(this._editor.onDidChangeModel(() => {
                ...
                if (shouldRestartFind) {
                    this._start({
                        ...
                        seedSearchStringFromSelection: false && this._editor.getOption(26 /* find */).seedSearchStringFromSelection,
        ...
        getGlobalBufferTerm() {
            if (this._editor.getOption(26 /* find */).globalFindClipboard
    ...
    let FindController = class FindController extends CommonFindController {
        ...
        _start(opts) {
            ...
            switch (this._editor.getOption(26 /* find */).autoFindInSelection) {
                case 'always':
    ...
    FindController = __decorate([
        ...
        __param(7, instantiation_1.optional(clipboardService_1.IClipboardService))
    ], FindController);
    ...
    class StartFindAction extends editorExtensions_1.EditorAction {
        ...
        run(accessor, editor) {
            ...
            if (controller) {
                controller.start({
                    forceRevealReplace: false,
                    seedSearchStringFromSelection: editor.getOption(26 /* find */).seedSearchStringFromSelection,
                    seedSearchStringFromGlobalClipboard: editor.getOption(26 /* find */).globalFindClipboard,
    ...
    class MatchFindAction extends editorExtensions_1.EditorAction {
        run(accessor, editor) {
            ...
            if (controller && !this._run(controller)) {
                controller.start({
                    forceRevealReplace: false,
                    seedSearchStringFromSelection: (controller.getState().searchString.length === 0) && editor.getOption(26 /* find */).seedSearchStringFromSelection,
    ...
    class StartFindReplaceAction extends editorExtensions_1.EditorAction {
        ...
        run(accessor, editor) {
            if (!editor.hasModel() || editor.getOption(64 /* readOnly */)) {
                return;
            }
            let controller = CommonFindController.get(editor);
            ...
            let seedSearchStringFromSelection = !currentSelection.isEmpty()
                && currentSelection.startLineNumber === currentSelection.endLineNumber && editor.getOption(26 /* find */).seedSearchStringFromSelection
                && !findInputFocused;
            /*
            ...
            if (controller) {
                controller.start({
                    ...
                    seedSearchStringFromGlobalClipboard: editor.getOption(26 /* find */).seedSearchStringFromSelection,
