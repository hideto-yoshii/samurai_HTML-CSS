...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/browser/ui/aria/aria", "vs/base/browser/ui/checkbox/checkbox", "vs/base/browser/ui/sash/sash", "vs/base/browser/ui/widget", "vs/base/common/async", "vs/base/common/errors", "vs/base/common/lifecycle", "vs/base/common/platform", "vs/base/common/strings", "vs/editor/common/core/range", "vs/editor/contrib/find/findModel", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/platform/browser/contextScopedHistoryWidget", "vs/css!./findWidget"], function (require, exports, nls, dom, aria_1, checkbox_1, sash_1, widget_1, async_1, errors_1, lifecycle_1, platform, strings, range_1, findModel_1, colorRegistry_1, themeService_1, contextScopedHistoryWidget_1) {
    ...
    class FindWidget extends widget_1.Widget {
        constructor(codeEditor, controller, state, contextViewProvider, keybindingService, contextKeyService, themeService, storageService, notificationService) {
            ...
            this._register(this._codeEditor.onDidChangeConfiguration((e) => {
                if (e.hasChanged(64 /* readOnly */)) {
                    if (this._codeEditor.getOption(64 /* readOnly */)) {
                ...
                if (e.hasChanged(26 /* find */)) {
                    const addExtraSpaceOnTop = this._codeEditor.getOption(26 /* find */).addExtraSpaceOnTop;
            ...
            if (this._codeEditor.getOption(26 /* find */).addExtraSpaceOnTop) {
        ...
        _onStateChanged(e) {
            ...
            if (e.isReplaceRevealed) {
                if (this._state.isReplaceRevealed) {
                    if (!this._codeEditor.getOption(64 /* readOnly */) && !this._isReplaceVisible) {
        ...
        _updateButtons() {
            ...
            let canReplace = !this._codeEditor.getOption(64 /* readOnly */);
        ...
        _reveal() {
            if (!this._isVisible) {
                ...
                switch (this._codeEditor.getOption(26 /* find */).autoFindInSelection) {
                    case 'always':
                        this._toggleSelectionFind.checked = true;
                        break;
                    case 'never':
                ...
                if (this._codeEditor.getOption(26 /* find */).seedSearchStringFromSelection && selection) {
