            ...
            for (let i = 0; i < source.length; i++) {
                ...
                if (wordLen === 0) {
                    ...
                    if (wordPos >= wordLen) {
                        ...
                        if (strings_1.compareIgnoreCase(item.completion.filterText, item.completion.label) === 0) {
                            ...
                            item.score = filters_1.anyScore(word, wordLow, wordPos, item.completion.label, item.labelLow, 0);
