...
define(["require", "exports", "vs/base/common/arrays", "vs/base/common/cancellation", "vs/base/common/keyCodes", "vs/base/common/lifecycle", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/common/core/characterClassifier", "vs/editor/common/core/range", "vs/editor/common/editorContextKeys", "vs/editor/common/modes", "vs/editor/common/services/editorWorkerService", "vs/editor/contrib/format/format", "vs/editor/contrib/format/formattingEdit", "vs/nls", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey", "vs/platform/instantiation/common/instantiation", "vs/base/common/errors"], function (require, exports, arrays_1, cancellation_1, keyCodes_1, lifecycle_1, editorExtensions_1, codeEditorService_1, characterClassifier_1, range_1, editorContextKeys_1, modes_1, editorWorkerService_1, format_1, formattingEdit_1, nls, commands_1, contextkey_1, instantiation_1, errors_1) {
    ...
    let FormatOnType = class FormatOnType {
        ...
        _update() {
            ...
            // we are disabled
            if (!this._editor.getOption(36 /* formatOnType */)) {
                return;
            }
            // no model
    ...
    let FormatOnPaste = class FormatOnPaste {
        ...
        _update() {
            ...
            this._callOnModel.clear();
            // we are disabled
            if (!this.editor.getOption(35 /* formatOnPaste */)) {
                return;
            }
            // no model
        ...
        run(accessor, editor) {
            return __awaiter(this, void 0, void 0, function* () {
                if (editor.hasModel()) {
                    ...
                    yield instaService.invokeFunction(format_1.formatDocumentWithSelectedProvider, editor, 1 /* Explicit */, cancellation_1.CancellationToken.None);
                }
            });
        }
    }
    class FormatSelectionAction extends editorExtensions_1.EditorAction {
        ...
        run(accessor, editor) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield instaService.invokeFunction(format_1.formatDocumentRangeWithSelectedProvider, editor, range, 1 /* Explicit */, cancellation_1.CancellationToken.None);
            });
        }
    }
