...
define(["require", "exports", "vs/base/common/arrays", "vs/base/common/async", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/lifecycle", "vs/editor/common/core/selection", "vs/editor/common/modes", "./completionModel", "./suggest", "vs/editor/contrib/snippet/snippetController2", "vs/base/common/cancellation", "vs/editor/contrib/suggest/wordDistance"], function (require, exports, arrays_1, async_1, errors_1, event_1, lifecycle_1, selection_1, modes_1, completionModel_1, suggest_1, snippetController2_1, cancellation_1, wordDistance_1) {
    ...
    class SuggestModel {
        ...
        _updateQuickSuggest() {
            this._quickSuggestDelay = this._editor.getOption(63 /* quickSuggestionsDelay */);
        ...
        _updateTriggerCharacters() {
            lifecycle_1.dispose(this._triggerCharacterListener);
            if (this._editor.getOption(64 /* readOnly */)
                || !this._editor.hasModel()
                || !this._editor.getOption(87 /* suggestOnTriggerCharacters */)) {
                return;
            }
        ...
        _onCursorChange(e) {
            ...
            if (this._state === 0 /* Idle */) {
                if (this._editor.getOption(62 /* quickSuggestions */) === false) {
                    // not enabled
                    return;
                }
                ...
                if (this._editor.getOption(84 /* suggest */).snippetsPreventQuickSuggestions && snippetController2_1.SnippetController2.get(this._editor).isInSnippet()) {
                ...
                this._triggerQuickSuggest.cancelAndSet(() => {
                    ...
                    const quickSuggestions = this._editor.getOption(62 /* quickSuggestions */);
        ...
        trigger(context, retrigger = false, onlyFrom, existingItems) {
            ...
            const snippetSuggestions = this._editor.getOption(81 /* snippetSuggestions */);
            ...
            Promise.all([items, wordDistance]).then(([items, wordDistance]) => {
                ...
                }, wordDistance, this._editor.getOption(84 /* suggest */), this._editor.getOption(81 /* snippetSuggestions */));
        ...
        static _createItemKindFilter(editor) {
            ...
            // snippet setting
            const snippetSuggestions = editor.getOption(81 /* snippetSuggestions */);
            if (snippetSuggestions === 'none') {
                result.add(25 /* Snippet */);
            }
            // type setting
            const suggestOptions = editor.getOption(84 /* suggest */);
