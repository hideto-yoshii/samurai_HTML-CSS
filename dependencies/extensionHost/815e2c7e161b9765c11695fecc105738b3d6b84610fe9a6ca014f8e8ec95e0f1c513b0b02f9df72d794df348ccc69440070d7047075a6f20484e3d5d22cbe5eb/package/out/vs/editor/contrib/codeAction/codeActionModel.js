 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/async", "vs/base/common/event", "vs/base/common/lifecycle", "vs/editor/common/core/range", "vs/editor/common/modes", "vs/platform/contextkey/common/contextkey", "./codeAction", "vs/base/common/resources"], function (require, exports, async_1, event_1, lifecycle_1, range_1, modes_1, contextkey_1, codeAction_1, resources_1) {
    "use strict";
    ...
    class CodeActionModel extends lifecycle_1.Disposable {
        ...
        _update() {
            ...
            if (model
                ...
                && !this._editor.getOption(64 /* readOnly */)) {
                ...
                this._codeActionOracle.value = new CodeActionOracle(this._editor, this._markerService, trigger => {
                    ...
                    const actions = async_1.createCancelablePromise(token => codeAction_1.getCodeActions(model, trigger.selection, trigger.trigger, token));
