 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/common/cancellation", "vs/base/common/color", "vs/base/common/htmlContent", "vs/base/common/lifecycle", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/editor/contrib/colorPicker/color", "vs/editor/contrib/colorPicker/colorDetector", "vs/editor/contrib/colorPicker/colorPickerModel", "vs/editor/contrib/colorPicker/colorPickerWidget", "vs/editor/contrib/hover/getHover", "vs/editor/contrib/hover/hoverOperation", "vs/editor/contrib/hover/hoverWidgets", "vs/editor/contrib/markdown/markdownRenderer", "vs/base/common/arrays", "vs/platform/markers/common/markers", "vs/base/common/resources", "vs/base/common/errors", "vs/platform/opener/common/opener", "vs/editor/contrib/gotoError/gotoError", "vs/base/common/async", "vs/editor/contrib/codeAction/codeAction", "vs/editor/contrib/codeAction/codeActionCommands", "vs/editor/contrib/codeAction/codeActionTrigger"], function (require, exports, nls, dom, cancellation_1, color_1, htmlContent_1, lifecycle_1, position_1, range_1, textModel_1, modes_1, color_2, colorDetector_1, colorPickerModel_1, colorPickerWidget_1, getHover_1, hoverOperation_1, hoverWidgets_1, markdownRenderer_1, arrays_1, markers_1, resources_1, errors_1, opener_1, gotoError_1, async_1, codeAction_1, codeActionCommands_1, codeActionTrigger_1) {
    "use strict";
    ...
    class ModesContentHoverWidget extends hoverWidgets_1.ContentHoverWidget {
        constructor(editor, markerDecorationsService, _themeService, _keybindingService, _modeService, _openerService = opener_1.NullOpenerService) {
            ...
            this._hoverOperation = new hoverOperation_1.HoverOperation(this._computer, result => this._withResult(result, true), null, result => this._withResult(result, false), this._editor.getOption(41 /* hover */).delay);
            ...
            this._register(editor.onDidChangeConfiguration((e) => {
                this._hoverOperation.setHoverTime(this._editor.getOption(41 /* hover */).delay);
            }));
        }
        dispose() {
        ...
        _renderMessages(renderRange, messages) {
            ...
            messages.forEach((msg) => {
                ...
                if (msg instanceof ColorHover) {
                    ...
                    const widget = new colorPickerWidget_1.ColorPickerWidget(fragment, model, this._editor.getOption(100 /* pixelRatio */), this._themeService);
        ...
        getCodeActions(marker) {
            return async_1.createCancelablePromise(cancellationToken => {
                return codeAction_1.getCodeActions(this._editor.getModel(), new range_1.Range(marker.startLineNumber, marker.startColumn, marker.endLineNumber, marker.endColumn), { type: 'manual', filter: { kind: codeActionTrigger_1.CodeActionKind.QuickFix } }, cancellationToken);
            });
        }
