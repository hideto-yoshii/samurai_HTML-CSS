...
define(["require", "exports", "vs/nls", "vs/base/browser/dom", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/hash", "vs/base/common/lifecycle", "vs/base/common/network", "vs/editor/browser/config/configuration", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/browser/view/viewImpl", "vs/editor/browser/view/viewOutgoingEvents", "vs/editor/common/controller/cursor", "vs/editor/common/controller/cursorCommon", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/editorAction", "vs/editor/common/editorCommon", "vs/editor/common/editorContextKeys", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/editor/common/view/editorColorRegistry", "vs/platform/theme/common/colorRegistry", "vs/editor/common/viewModel/viewModelImpl", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey", "vs/platform/instantiation/common/instantiation", "vs/platform/instantiation/common/serviceCollection", "vs/platform/notification/common/notification", "vs/platform/theme/common/themeService", "vs/platform/accessibility/common/accessibility", "vs/base/common/types", "vs/css!./media/editor"], function (require, exports, nls, dom, errors_1, event_1, hash_1, lifecycle_1, network_1, configuration_1, editorExtensions_1, codeEditorService_1, viewImpl_1, viewOutgoingEvents_1, cursor_1, cursorCommon_1, position_1, range_1, selection_1, editorAction_1, editorCommon, editorContextKeys_1, textModel_1, modes, editorColorRegistry_1, colorRegistry_1, viewModelImpl_1, commands_1, contextkey_1, instantiation_1, serviceCollection_1, notification_1, themeService_1, accessibility_1, types_1) {
    ...
    let CodeEditorWidget = class CodeEditorWidget extends lifecycle_1.Disposable {
        ...
        pushUndoStop() {
            ...
            if (this._configuration.options.get(64 /* readOnly */)) {
        ...
        getLineDecorations(lineNumber) {
            ...
            return this._modelData.model.getLineDecorations(lineNumber, this._id, this._configuration.options.get(64 /* readOnly */));
        }
        ...
        getScrolledVisiblePosition(rawPosition) {
            ...
            return {
                top: top,
                left: left,
                height: options.get(46 /* lineHeight */)
            };
        }
        ...
        applyFontInfo(target) {
            configuration_1.Configuration.applyFontInfoSlow(target, this._configuration.options.get(31 /* fontInfo */));
        }
        _attachModel(model) {
            if (!model) {
                this._modelData = null;
    ...
    class EditorContextKeysManager extends lifecycle_1.Disposable {
        ...
        _updateFromConfig() {
            ...
            this._editorTabMovesFocus.set(options.get(101 /* tabFocusMode */));
            this._editorReadonly.set(options.get(64 /* readOnly */));
        }
    ...
    class EditorModeContext extends lifecycle_1.Disposable {
        constructor(_editor, _contextKeyService) {
            ...
            this._isInWalkThrough = editorContextKeys_1.EditorContextKeys.isInEmbeddedEditor.bindTo(_contextKeyService);
