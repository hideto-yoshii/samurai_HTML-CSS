...
define(["require", "exports", "vs/base/browser/browser", "vs/editor/browser/editorDom", "vs/editor/browser/view/viewPart", "vs/editor/browser/viewParts/lines/viewLine", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/controller/cursorCommon"], function (require, exports, browser, editorDom_1, viewPart_1, viewLine_1, position_1, range_1, cursorCommon_1) {
    ...
    class HitTestContext {
        constructor(context, viewHelper, lastViewCursorsRenderData) {
            ...
            this.layoutInfo = options.get(102 /* layoutInfo */);
            this.viewDomNode = viewHelper.viewDomNode;
            this.lineHeight = options.get(46 /* lineHeight */);
            this.typicalHalfwidthCharacterWidth = options.get(31 /* fontInfo */).typicalHalfwidthCharacterWidth;
    ...
    class HitTestRequest extends BareHitTestRequest {
        ...
        fulfill(type, position = null, range = null, detail = null) {
            ...
            if (position && position.column < this._ctx.model.getLineMaxColumn(position.lineNumber)) {
                ...
                mouseColumn = cursorCommon_1.CursorColumns.visibleColumnFromColumn(this._ctx.model.getLineContent(position.lineNumber), position.column, this._ctx.model.getOptions().tabSize) + 1;
            }
    ...
    class MouseTargetFactory {
        ...
        getMouseColumn(editorPos, pos) {
            ...
            return MouseTargetFactory._getMouseColumn(mouseContentHorizontalOffset, options.get(31 /* fontInfo */).typicalHalfwidthCharacterWidth);
        }
