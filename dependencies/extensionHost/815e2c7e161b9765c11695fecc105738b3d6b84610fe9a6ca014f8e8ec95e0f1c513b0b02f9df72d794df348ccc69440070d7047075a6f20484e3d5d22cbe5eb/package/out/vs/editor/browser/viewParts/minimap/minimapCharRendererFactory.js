 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/editor/browser/viewParts/minimap/minimapCharRenderer", "vs/editor/browser/viewParts/minimap/minimapCharSheet"], function (require, exports, minimapCharRenderer_1, minimapCharSheet_1) {
    "use strict";
    ...
    class MinimapCharRendererFactory {
        ...
        static create(scale, fontFamily) {
            ...
            const factory = MinimapCharRendererFactory.createFromSampleData(MinimapCharRendererFactory.createSampleData(fontFamily).data, scale);
