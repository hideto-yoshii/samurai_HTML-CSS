    ...
    class MouseHandler extends viewEventHandler_1.ViewEventHandler {
        constructor(context, viewController, viewHelper) {
            ...
            const onMouseWheel = (browserEvent) => {
                ...
                if (!this._context.configuration.options.get(54 /* mouseWheelZoom */)) {
                    return;
                }
        ...
        _onMouseDown(e) {
            ...
            const selectOnLineNumbers = this._context.configuration.options.get(78 /* selectOnLineNumbers */);
