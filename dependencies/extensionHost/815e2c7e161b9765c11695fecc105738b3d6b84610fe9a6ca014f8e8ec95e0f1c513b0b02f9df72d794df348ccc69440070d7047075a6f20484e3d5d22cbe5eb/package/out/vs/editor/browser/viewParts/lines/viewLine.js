...
define(["require", "exports", "vs/base/browser/browser", "vs/base/browser/fastDomNode", "vs/base/common/platform", "vs/editor/browser/viewParts/lines/rangeUtil", "vs/editor/common/view/renderingContext", "vs/editor/common/viewLayout/lineDecorations", "vs/editor/common/viewLayout/viewLineRenderer", "vs/platform/theme/common/themeService", "vs/editor/common/config/editorOptions"], function (require, exports, browser, fastDomNode_1, platform, rangeUtil_1, renderingContext_1, lineDecorations_1, viewLineRenderer_1, themeService_1, editorOptions_1) {
    ...
    class ViewLineOptions {
        constructor(config, themeType) {
            ...
            this.renderWhitespace = options.get(69 /* renderWhitespace */);
            this.renderControlCharacters = options.get(65 /* renderControlCharacters */);
            this.spaceWidth = fontInfo.spaceWidth;
            this.useMonospaceOptimizations = (fontInfo.isMonospace
                && !options.get(21 /* disableMonospaceOptimizations */));
            this.canUseHalfwidthRightwardsArrow = fontInfo.canUseHalfwidthRightwardsArrow;
            this.lineHeight = options.get(46 /* lineHeight */);
            this.stopRenderingLineAfter = options.get(83 /* stopRenderingLineAfter */);
            this.fontLigatures = options.get(32 /* fontLigatures */);
        }
        equals(other) {
