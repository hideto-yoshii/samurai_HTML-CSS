    ...
    suite('Editor Controller - Cursor', () => {
        ...
        test('combining marks', () => {
            testCodeEditor_1.withTestCodeEditor([
                ...
                cursor.setSelections('test', [new selection_1.Selection(2, 1, 2, 1)]);
                moveRight(cursor);
                assertCursor(cursor, new position_1.Position(2, 3));
                moveLeft(cursor);
                assertCursor(cursor, new position_1.Position(2, 1));
                cursor.setSelections('test', [new selection_1.Selection(3, 1, 3, 1)]);
                moveRight(cursor);
                assertCursor(cursor, new position_1.Position(3, 4));
                moveLeft(cursor);
                assertCursor(cursor, new position_1.Position(3, 1));
                cursor.setSelections('test', [new selection_1.Selection(4, 1, 4, 1)]);
                moveRight(cursor);
                assertCursor(cursor, new position_1.Position(4, 3));
                moveLeft(cursor);
                assertCursor(cursor, new position_1.Position(4, 1));
                cursor.setSelections('test', [new selection_1.Selection(1, 3, 1, 3)]);
                moveDown(cursor);
                assertCursor(cursor, new position_1.Position(2, 5));
                moveDown(cursor);
                assertCursor(cursor, new position_1.Position(3, 4));
                moveUp(cursor);
                assertCursor(cursor, new position_1.Position(2, 5));
                moveUp(cursor);
                assertCursor(cursor, new position_1.Position(1, 3));
            });
        });
    ...
    suite('Editor Controller - Regression tests', () => {
        ...
        test('issue #74722: Pasting whole line does not replace selection', () => {
            usingCursor({
                ...
                cursor.setSelections('test', [new selection_1.Selection(2, 6, 2, 9)]);
                cursorCommand(cursor, H.Paste, { text: 'line1\n', pasteOnNewLine: true });
                assert.equal(model.getLineContent(1), 'line1');
    ...
    suite('Editor Controller - Cursor Configuration', () => {
        ...
        test('issue #40695: maintain cursor position when copying lines using ctrl+c, ctrl+v', () => {
            ...
            testCodeEditor_1.withTestCodeEditor(null, { model: model }, (editor, cursor) => {
                ...
                assertCursor(cursor, new position_1.Position(5, 10));
            });
            model.dispose();
        });
    ...
    suite('autoClosingPairs', () => {
        ...
        test('issue #37315 - overtypes only those characters that it inserted', () => {
            ...
            usingCursor({
                ...
                assert.strictEqual(model.getLineContent(1), 'x=(asd)');
                // do not overtype!
                cursor.setSelections('test', [new selection_1.Selection(2, 4, 2, 4)]);
                cursorCommand(cursor, H.Type, { text: ')' }, 'keyboard');
        ...
        test('issue #78527 - does not close quote on odd count', () => {
            ...
            usingCursor({
                ...
                cursor.setSelections('test', [new selection_1.Selection(1, 29, 1, 29)]);
                cursorCommand(cursor, H.Type, { text: '[' }, 'keyboard');
        ...
        test('issue #78975 - Parentheses swallowing does not work when parentheses are inserted by autocomplete', () => {
            ...
            usingCursor({
                ...
                cursor.setSelections('test', [new selection_1.Selection(1, 8, 1, 8)]);
                cursor.executeEdits('snippet', [{ range: new range_1.Range(1, 6, 1, 8), text: 'id=""' }], () => [new selection_1.Selection(1, 10, 1, 10)]);
        ...
        test('issue #53357: Over typing ignores characters after backslash', () => {
            ...
            usingCursor({
                ...
                cursor.setSelections('test', [new selection_1.Selection(1, 13, 1, 13)]);
                cursorCommand(cursor, H.Type, { text: '\'' }, 'keyboard');
