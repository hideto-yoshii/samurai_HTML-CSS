define(["require", "exports", "assert", "vs/editor/common/controller/cursorCommon"], function (require, exports, assert, cursorCommon_1) {
    ...
    suite('CursorMove', () => {
        test('nextRenderTabStop', () => {
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(0, 4), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(1, 4), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(2, 4), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(3, 4), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(4, 4), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(5, 4), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(6, 4), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(7, 4), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(8, 4), 12);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(0, 2), 2);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(1, 2), 2);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(2, 2), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(3, 2), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(4, 2), 6);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(5, 2), 6);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(6, 2), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(7, 2), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(8, 2), 10);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(0, 1), 1);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(1, 1), 2);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(2, 1), 3);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(3, 1), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(4, 1), 5);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(5, 1), 6);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(6, 1), 7);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(7, 1), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextRenderTabStop(8, 1), 9);
        });
        ...
        test('toStatusbarColumn', () => {
            function t(text, tabSize, column, expected) {
                assert.equal(cursorCommon_1.CursorColumns.toStatusbarColumn(text, column, tabSize), expected, `<<t('${text}', ${tabSize}, ${column}, ${expected})>>`);
            }
            t('    spaces', 4, 1, 1);
            t('    spaces', 4, 2, 2);
            t('    spaces', 4, 3, 3);
