    ...
    suite('ViewModelDecorations', () => {
        test('getDecorationsViewportData', () => {
            ...
            testViewModel_1.testViewModel(text, opts, (viewModel, model) => {
                ...
                assert.deepEqual(inlineDecorations1, [
                    ...
                    {
                        range: new range_1.Range(1, 2, 3, 13),
                    ...
                    {
                        range: new range_1.Range(2, 1, 3, 13),
                    ...
                    {
                        range: new range_1.Range(2, 3, 3, 13),
                ...
                assert.deepEqual(inlineDecorations2, [
                    ...
                    {
                        range: new range_1.Range(3, 13, 3, 13),
        ...
        test('issue #17208: Problem scrolling in 1.8.0', () => {
            ...
            testViewModel_1.testViewModel(text, opts, (viewModel, model) => {
                ...
                let decorations = viewModel.getDecorationsInViewport(new range_1.Range(2, viewModel.getLineMinColumn(2), 3, viewModel.getLineMaxColumn(3)));
