...
define(["require", "exports", "assert", "vs/base/common/strings", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model/textModel", "vs/editor/test/common/editorTestUtils"], function (require, exports, assert, strings_1, position_1, range_1, textModel_1, editorTestUtils_1) {
    ...
    suite('Editor Model - TextModel', () => {
        ...
        test('issue #71480: validatePosition handle floats', () => {
            let m = textModel_1.TextModel.createFromString('line one\nline two');
            assert.deepEqual(m.validatePosition(new position_1.Position(0.2, 1)), new position_1.Position(1, 1), 'a');
            assert.deepEqual(m.validatePosition(new position_1.Position(1.2, 1)), new position_1.Position(1, 1), 'b');
            assert.deepEqual(m.validatePosition(new position_1.Position(1.5, 2)), new position_1.Position(1, 2), 'c');
            assert.deepEqual(m.validatePosition(new position_1.Position(1.8, 3)), new position_1.Position(1, 3), 'd');
            assert.deepEqual(m.validatePosition(new position_1.Position(1, 0.3)), new position_1.Position(1, 1), 'e');
            assert.deepEqual(m.validatePosition(new position_1.Position(2, 0.8)), new position_1.Position(2, 1), 'f');
            assert.deepEqual(m.validatePosition(new position_1.Position(1, 1.2)), new position_1.Position(1, 1), 'g');
            assert.deepEqual(m.validatePosition(new position_1.Position(2, 1.5)), new position_1.Position(2, 1), 'h');
        });
        function assertValidatePosition(m, lineNumber, column, expectedColumn) {
            const input = new position_1.Position(lineNumber, column);
            const actual = m.validatePosition(input);
            const expected = new position_1.Position(lineNumber, expectedColumn);
            assert.deepEqual(actual, expected, `validatePosition for ${input}, got ${actual}, expected ${expected}`);
        }
        function assertValidateRange(m, input, expected) {
        ...
        test('combining marks', () => {
            const m = textModel_1.TextModel.createFromString([
                'abcabc',
                'ãããããã',
                '辻󠄀辻󠄀辻󠄀',
                'புபுபு',
            ...
            assertValidateRange(m, new range_1.Range(2, 1, 2, 1), new range_1.Range(2, 1, 2, 1));
            assertValidateRange(m, new range_1.Range(2, 1, 2, 2), new range_1.Range(2, 1, 2, 3));
            assertValidateRange(m, new range_1.Range(2, 1, 2, 3), new range_1.Range(2, 1, 2, 3));
            assertValidateRange(m, new range_1.Range(2, 1, 2, 4), new range_1.Range(2, 1, 2, 5));
            assertValidateRange(m, new range_1.Range(2, 1, 2, 5), new range_1.Range(2, 1, 2, 5));
            assertValidateRange(m, new range_1.Range(2, 2, 2, 2), new range_1.Range(2, 1, 2, 1));
            assertValidateRange(m, new range_1.Range(2, 2, 2, 3), new range_1.Range(2, 1, 2, 3));
            assertValidateRange(m, new range_1.Range(2, 2, 2, 4), new range_1.Range(2, 1, 2, 5));
            assertValidateRange(m, new range_1.Range(2, 2, 2, 5), new range_1.Range(2, 1, 2, 5));
            assertValidateRange(m, new range_1.Range(3, 1, 3, 1), new range_1.Range(3, 1, 3, 1));
            assertValidateRange(m, new range_1.Range(3, 1, 3, 2), new range_1.Range(3, 1, 3, 4));
            assertValidateRange(m, new range_1.Range(3, 1, 3, 3), new range_1.Range(3, 1, 3, 4));
            assertValidateRange(m, new range_1.Range(3, 1, 3, 4), new range_1.Range(3, 1, 3, 4));
            assertValidateRange(m, new range_1.Range(3, 1, 3, 5), new range_1.Range(3, 1, 3, 7));
            assertValidateRange(m, new range_1.Range(3, 1, 3, 6), new range_1.Range(3, 1, 3, 7));
            assertValidateRange(m, new range_1.Range(3, 1, 3, 7), new range_1.Range(3, 1, 3, 7));
            assertValidateRange(m, new range_1.Range(3, 2, 3, 2), new range_1.Range(3, 1, 3, 1));
            assertValidateRange(m, new range_1.Range(3, 2, 3, 3), new range_1.Range(3, 1, 3, 4));
            assertValidateRange(m, new range_1.Range(3, 2, 3, 4), new range_1.Range(3, 1, 3, 4));
            assertValidateRange(m, new range_1.Range(3, 2, 3, 5), new range_1.Range(3, 1, 3, 7));
            assertValidateRange(m, new range_1.Range(3, 2, 3, 6), new range_1.Range(3, 1, 3, 7));
            assertValidateRange(m, new range_1.Range(3, 2, 3, 7), new range_1.Range(3, 1, 3, 7));
            m.dispose();
        });
        test('issue #71480: validateRange handle floats', () => {
            let m = textModel_1.TextModel.createFromString('line one\nline two');
            assert.deepEqual(m.validateRange(new range_1.Range(0.2, 1.5, 0.8, 2.5)), new range_1.Range(1, 1, 1, 1));
            assert.deepEqual(m.validateRange(new range_1.Range(1.2, 1.7, 1.8, 2.2)), new range_1.Range(1, 1, 1, 2));
        });
