 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/token", "vs/base/common/uint", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/editor/common/modes/nullMode", "vs/editor/common/viewModel/characterHardWrappingLineMapper", "vs/editor/common/viewModel/prefixSumComputer", "vs/editor/common/viewModel/splitLinesCollection", "vs/editor/test/common/mocks/testConfiguration"], function (require, exports, assert, position_1, range_1, token_1, uint_1, textModel_1, modes, nullMode_1, characterHardWrappingLineMapper_1, prefixSumComputer_1, splitLinesCollection_1, testConfiguration_1) {
    "use strict";
    ...
    suite('Editor ViewModel - SplitLinesCollection', () => {
        ...
        function withSplitLinesCollection(text, callback) {
            ...
            const wrappingInfo = config.options.get(103 /* wrappingInfo */);
            const fontInfo = config.options.get(31 /* fontInfo */);
            const wordWrapBreakAfterCharacters = config.options.get(93 /* wordWrapBreakAfterCharacters */);
            const wordWrapBreakBeforeCharacters = config.options.get(94 /* wordWrapBreakBeforeCharacters */);
            const wordWrapBreakObtrusiveCharacters = config.options.get(95 /* wordWrapBreakObtrusiveCharacters */);
            const wrappingIndent = config.options.get(98 /* wrappingIndent */);
            const hardWrappingLineMapperFactory = new characterHardWrappingLineMapper_1.CharacterHardWrappingLineMapperFactory(wordWrapBreakBeforeCharacters, wordWrapBreakAfterCharacters, wordWrapBreakObtrusiveCharacters);
            ...
            const linesCollection = new splitLinesCollection_1.SplitLinesCollection(model, hardWrappingLineMapperFactory, model.getOptions().tabSize, wrappingInfo.wrappingColumn, fontInfo.typicalFullwidthCharacterWidth / fontInfo.typicalHalfwidthCharacterWidth, wrappingIndent);
    ...
    suite('SplitLinesCollection', () => {
        ...
        function withSplitLinesCollection(model, wordWrap, wordWrapColumn, callback) {
            ...
            const wrappingInfo = configuration.options.get(103 /* wrappingInfo */);
            const fontInfo = configuration.options.get(31 /* fontInfo */);
            const wordWrapBreakAfterCharacters = configuration.options.get(93 /* wordWrapBreakAfterCharacters */);
            const wordWrapBreakBeforeCharacters = configuration.options.get(94 /* wordWrapBreakBeforeCharacters */);
            const wordWrapBreakObtrusiveCharacters = configuration.options.get(95 /* wordWrapBreakObtrusiveCharacters */);
            const wrappingIndent = configuration.options.get(98 /* wrappingIndent */);
            const factory = new characterHardWrappingLineMapper_1.CharacterHardWrappingLineMapperFactory(wordWrapBreakBeforeCharacters, wordWrapBreakAfterCharacters, wordWrapBreakObtrusiveCharacters);
            const linesCollection = new splitLinesCollection_1.SplitLinesCollection(model, factory, model.getOptions().tabSize, wrappingInfo.wrappingColumn, fontInfo.typicalFullwidthCharacterWidth / fontInfo.typicalHalfwidthCharacterWidth, wrappingIndent);
