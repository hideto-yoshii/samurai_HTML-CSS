 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/modes/supports/characterPair", "vs/editor/test/common/modesTestUtils", "vs/base/common/arrays"], function (require, exports, assert, characterPair_1, modesTestUtils_1, arrays_1) {
    "use strict";
    ...
    suite('CharacterPairSupport', () => {
        ...
        function findAutoClosingPair(characterPairSupport, character) {
            return arrays_1.find(characterPairSupport.getAutoClosingPairs(), autoClosingPair => autoClosingPair.open === character);
        }
