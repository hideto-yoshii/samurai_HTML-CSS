...
define(["require", "exports", "assert", "vs/editor/common/core/token", "vs/editor/common/modes", "vs/editor/common/modes/textToHtmlTokenizer", "vs/editor/test/common/core/viewLineToken", "vs/editor/test/common/mocks/mockMode"], function (require, exports, assert, token_1, modes_1, textToHtmlTokenizer_1, viewLineToken_1, mockMode_1) {
    ...
    suite('Editor Modes - textToHtmlTokenizer', () => {
        ...
        test('tokenizeLineToHTML', () => {
            ...
            assert.equal(textToHtmlTokenizer_1.tokenizeLineToHTML(text, lineTokens, colorMap, 0, 17, 4, true), [
                '<div>',
            ...
            assert.equal(textToHtmlTokenizer_1.tokenizeLineToHTML(text, lineTokens, colorMap, 0, 12, 4, true), [
                '<div>',
                '<span style="color: #ff0000;font-style: italic;font-weight: bold;">Ciao</span>',
                '<span style="color: #000000;">&nbsp;</span>',
                '<span style="color: #00ff00;">hello</span>',
            ...
            assert.equal(textToHtmlTokenizer_1.tokenizeLineToHTML(text, lineTokens, colorMap, 0, 11, 4, true), [
                '<div>',
                '<span style="color: #ff0000;font-style: italic;font-weight: bold;">Ciao</span>',
                '<span style="color: #000000;">&nbsp;</span>',
                '<span style="color: #00ff00;">hello</span>',
            ...
            assert.equal(textToHtmlTokenizer_1.tokenizeLineToHTML(text, lineTokens, colorMap, 1, 11, 4, true), [
                '<div>',
            ...
            assert.equal(textToHtmlTokenizer_1.tokenizeLineToHTML(text, lineTokens, colorMap, 4, 11, 4, true), [
                '<div>',
                '<span style="color: #000000;">&nbsp;</span>',
                '<span style="color: #00ff00;">hello</span>',
                '<span style="color: #000000;">&nbsp;</span>',
            ...
            assert.equal(textToHtmlTokenizer_1.tokenizeLineToHTML(text, lineTokens, colorMap, 5, 11, 4, true), [
                '<div>',
                '<span style="color: #00ff00;">hello</span>',
                '<span style="color: #000000;">&nbsp;</span>',
                '</div>'
            ].join(''));
            assert.equal(textToHtmlTokenizer_1.tokenizeLineToHTML(text, lineTokens, colorMap, 5, 10, 4, true), [
                '<div>',
                '<span style="color: #00ff00;">hello</span>',
                '</div>'
            ].join(''));
            assert.equal(textToHtmlTokenizer_1.tokenizeLineToHTML(text, lineTokens, colorMap, 6, 9, 4, true), [
                '<div>',
        ...
        test('tokenizeLineToHTML handle spaces #35954', () => {
            ...
            const colorMap = [null, '#000000', '#ffffff', '#ff0000', '#00ff00', '#0000ff'];
            assert.equal(textToHtmlTokenizer_1.tokenizeLineToHTML(text, lineTokens, colorMap, 0, 21, 4, true), [
                '<div>',
                '<span style="color: #000000;">&nbsp;&nbsp;</span>',
                '<span style="color: #ff0000;font-style: italic;font-weight: bold;">Ciao</span>',
                '<span style="color: #000000;">&nbsp;&nbsp;&nbsp;</span>',
            ...
            assert.equal(textToHtmlTokenizer_1.tokenizeLineToHTML(text, lineTokens, colorMap, 0, 3, 4, true), [
                '<div>',
                '<span style="color: #000000;">&nbsp;&nbsp;</span>',
