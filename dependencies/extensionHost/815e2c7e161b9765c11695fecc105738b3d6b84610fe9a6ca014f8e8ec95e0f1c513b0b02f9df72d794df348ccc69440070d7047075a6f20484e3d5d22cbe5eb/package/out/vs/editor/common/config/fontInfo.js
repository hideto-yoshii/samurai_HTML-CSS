...
define(["require", "exports", "vs/base/common/platform", "vs/editor/common/config/editorOptions", "vs/editor/common/config/editorZoom"], function (require, exports, platform, editorOptions_1, editorZoom_1) {
    ...
    class BareFontInfo {
        ...
        static createFromValidatedSettings(options, zoomLevel, ignoreEditorZoom) {
            const fontFamily = options.get(30 /* fontFamily */);
            const fontWeight = options.get(34 /* fontWeight */);
            const fontSize = options.get(33 /* fontSize */);
            const fontFeatureSettings = options.get(32 /* fontLigatures */);
            const lineHeight = options.get(46 /* lineHeight */);
            const letterSpacing = options.get(43 /* letterSpacing */);
