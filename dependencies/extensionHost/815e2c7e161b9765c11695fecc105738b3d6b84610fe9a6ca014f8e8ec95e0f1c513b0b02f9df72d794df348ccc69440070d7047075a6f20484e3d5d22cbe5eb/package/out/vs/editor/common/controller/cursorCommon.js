...
define(["require", "exports", "vs/base/common/errors", "vs/base/common/strings", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/model/textModel", "vs/editor/common/modes/languageConfigurationRegistry"], function (require, exports, errors_1, strings, position_1, range_1, selection_1, textModel_1, languageConfigurationRegistry_1) {
    ...
    class CursorConfiguration {
        constructor(languageIdentifier, modelOptions, configuration) {
            ...
            this.readOnly = options.get(64 /* readOnly */);
            this.tabSize = modelOptions.tabSize;
            this.indentSize = modelOptions.indentSize;
            this.insertSpaces = modelOptions.insertSpaces;
            this.lineHeight = options.get(46 /* lineHeight */);
            this.pageSize = Math.max(1, Math.floor(layoutInfo.height / this.lineHeight) - 2);
            this.useTabStops = options.get(90 /* useTabStops */);
            this.wordSeparators = options.get(91 /* wordSeparators */);
            this.emptySelectionClipboard = options.get(23 /* emptySelectionClipboard */);
            this.copyWithSyntaxHighlighting = options.get(13 /* copyWithSyntaxHighlighting */);
            this.multiCursorMergeOverlapping = options.get(55 /* multiCursorMergeOverlapping */);
            this.multiCursorPaste = options.get(57 /* multiCursorPaste */);
            this.autoClosingBrackets = options.get(4 /* autoClosingBrackets */);
            this.autoClosingQuotes = options.get(6 /* autoClosingQuotes */);
            this.autoClosingOvertype = options.get(5 /* autoClosingOvertype */);
            this.autoSurround = options.get(9 /* autoSurround */);
            this.autoIndent = options.get(7 /* autoIndent */);
        ...
        static shouldRecreate(e) {
            return (e.hasChanged(102 /* layoutInfo */)
                || e.hasChanged(91 /* wordSeparators */)
                || e.hasChanged(23 /* emptySelectionClipboard */)
                || e.hasChanged(55 /* multiCursorMergeOverlapping */)
                || e.hasChanged(57 /* multiCursorPaste */)
                || e.hasChanged(4 /* autoClosingBrackets */)
                || e.hasChanged(6 /* autoClosingQuotes */)
                || e.hasChanged(5 /* autoClosingOvertype */)
                || e.hasChanged(9 /* autoSurround */)
                || e.hasChanged(90 /* useTabStops */)
                || e.hasChanged(46 /* lineHeight */)
                || e.hasChanged(64 /* readOnly */));
        }
        get electricChars() {
