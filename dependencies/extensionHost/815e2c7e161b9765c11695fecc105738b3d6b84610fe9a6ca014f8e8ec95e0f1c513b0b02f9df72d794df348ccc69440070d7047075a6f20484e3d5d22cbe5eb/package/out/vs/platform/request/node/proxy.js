    ...
    function getProxyAgent(rawRequestURL, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return requestURL.protocol === 'http:'
                ? new (yield new Promise((resolve_1, reject_1) => { require(['http-proxy-agent'], resolve_1, reject_1); }))(opts)
                : new (yield new Promise((resolve_2, reject_2) => { require(['https-proxy-agent'], resolve_2, reject_2); }))(opts);
        });
    }
