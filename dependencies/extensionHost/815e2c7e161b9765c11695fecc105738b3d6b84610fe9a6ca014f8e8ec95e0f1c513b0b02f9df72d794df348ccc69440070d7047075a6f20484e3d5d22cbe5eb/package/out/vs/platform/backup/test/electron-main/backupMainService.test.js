...
define(["require", "exports", "assert", "vs/base/common/platform", "fs", "os", "vs/base/common/path", "vs/base/node/pfs", "vs/base/common/uri", "vs/platform/environment/node/environmentService", "vs/platform/environment/node/argv", "vs/platform/backup/electron-main/backupMainService", "vs/platform/files/common/files", "vs/platform/configuration/test/common/testConfigurationService", "vs/platform/log/common/log", "crypto", "vs/base/test/node/testUtils", "vs/base/common/network"], function (require, exports, assert, platform, fs, os, path, pfs, uri_1, environmentService_1, argv_1, backupMainService_1, files_1, testConfigurationService_1, log_1, crypto_1, testUtils_1, network_1) {
    ...
    suite('BackupMainService', () => {
        ...
        const environmentService = new environmentService_1.EnvironmentService(argv_1.parseArgs(process.argv, argv_1.OPTIONS), process.execPath);
        ...
        suite('migrate path to URI', () => {
            test('migration folder path to URI makes sure to preserve existing backups', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('migrate storage file', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        suite('loadSync', () => {
            ...
            test('getFolderBackupPaths() should return [] when workspaces.json is not properly formed JSON', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('getFolderBackupPaths() should return [] when folderWorkspaces in workspaces.json is absent', () => __awaiter(void 0, void 0, void 0, function* () {
                fs.writeFileSync(backupWorkspacesPath, '{}');
                yield service.initialize();
                assertEqualUris(service.getFolderBackupPaths(), []);
            }));
            test('getFolderBackupPaths() should return [] when folderWorkspaces in workspaces.json is not a string array', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('getFolderBackupPaths() should return [] when files.hotExit = "onExitAndWindowClose"', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('getWorkspaceBackups() should return [] when workspaces.json is not properly formed JSON', () => __awaiter(void 0, void 0, void 0, function* () {
                fs.writeFileSync(backupWorkspacesPath, '');
                yield service.initialize();
                assert.deepEqual(service.getWorkspaceBackups(), []);
                fs.writeFileSync(backupWorkspacesPath, '{]');
            ...
            test('getWorkspaceBackups() should return [] when folderWorkspaces in workspaces.json is absent', () => __awaiter(void 0, void 0, void 0, function* () {
                fs.writeFileSync(backupWorkspacesPath, '{}');
                yield service.initialize();
                assert.deepEqual(service.getWorkspaceBackups(), []);
            }));
            test('getWorkspaceBackups() should return [] when rootWorkspaces in workspaces.json is not a object array', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('getWorkspaceBackups() should return [] when rootURIWorkspaces in workspaces.json is not a object array', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('getWorkspaceBackups() should return [] when files.hotExit = "onExitAndWindowClose"', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('getEmptyWorkspaceBackupPaths() should return [] when workspaces.json is not properly formed JSON', () => __awaiter(void 0, void 0, void 0, function* () {
                fs.writeFileSync(backupWorkspacesPath, '');
                yield service.initialize();
                assert.deepEqual(service.getEmptyWindowBackupPaths(), []);
                fs.writeFileSync(backupWorkspacesPath, '{]');
            ...
            test('getEmptyWorkspaceBackupPaths() should return [] when folderWorkspaces in workspaces.json is absent', () => __awaiter(void 0, void 0, void 0, function* () {
                fs.writeFileSync(backupWorkspacesPath, '{}');
                yield service.initialize();
                assert.deepEqual(service.getEmptyWindowBackupPaths(), []);
            }));
        ...
        suite('dedupeFolderWorkspaces', () => {
            test('should ignore duplicates (folder workspace)', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            test('should ignore duplicates on Windows and Mac (folder workspace)', () => __awaiter(void 0, void 0, void 0, function* () {
                yield ensureFolderExists(existingTestFolder1);
                const workspacesJson = {
                    rootURIWorkspaces: [],
            ...
            test('should ignore duplicates on Windows and Mac (root workspace)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        suite('registerWindowForBackups', () => {
            test('should persist paths to workspaces.json (folder workspace)', () => __awaiter(void 0, void 0, void 0, function* () {
                service.registerFolderBackupSync(fooFile);
                service.registerFolderBackupSync(barFile);
            ...
            test('should persist paths to workspaces.json (root workspace)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        suite('removeBackupPathSync', () => {
            ...
            test('should fail gracefully when removing a path that doesn\'t exist', () => __awaiter(void 0, void 0, void 0, function* () {
