...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/event", "vs/platform/log/common/log", "vs/platform/storage/common/storage", "vs/base/parts/storage/node/storage", "vs/base/parts/storage/common/storage", "vs/base/common/performance", "vs/base/common/path", "vs/base/node/pfs", "vs/platform/environment/common/environment", "vs/platform/workspaces/common/workspaces", "vs/base/common/errors", "vs/base/common/types"], function (require, exports, lifecycle_1, event_1, log_1, storage_1, storage_2, storage_3, performance_1, path_1, pfs_1, environment_1, workspaces_1, errors_1, types_1) {
    "use strict";
    ...
    let NativeStorageService = class NativeStorageService extends lifecycle_1.Disposable {
        ...
        initializeWorkspaceStorage(payload) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    try {
                        yield this.createWorkspaceStorage(useInMemoryStorage ? storage_2.SQLiteStorageDatabase.IN_MEMORY_PATH : path_1.join(result.path, NativeStorageService.WORKSPACE_STORAGE_NAME), result.wasCreated ? storage_3.StorageHint.STORAGE_DOES_NOT_EXIST : undefined).init();
                    }
                    finally {
        ...
        close() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                // Do it
                yield Promise.all([
                    this.getStorage(0 /* GLOBAL */).close(),
                    this.getStorage(1 /* WORKSPACE */).close()
                ]);
            });
        }
        getStorage(scope) {
        ...
        logStorage() {
            return __awaiter(this, void 0, void 0, function* () {
                const [workspaceStorage, workspaceStoragePath] = types_1.assertAllDefined(this.workspaceStorage, this.workspaceStoragePath);
                const result = yield Promise.all([
                    this.globalStorage.items,
                    workspaceStorage.items
                ]);
                storage_1.logStorage(result[0], result[1], this.environmentService.globalStorageHome, workspaceStoragePath);
            });
        }
        migrate(toWorkspace) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.getStorage(1 /* WORKSPACE */).close();
                ...
                yield pfs_1.copy(types_1.assertIsDefined(this.workspaceStoragePath), newWorkspaceStoragePath);
