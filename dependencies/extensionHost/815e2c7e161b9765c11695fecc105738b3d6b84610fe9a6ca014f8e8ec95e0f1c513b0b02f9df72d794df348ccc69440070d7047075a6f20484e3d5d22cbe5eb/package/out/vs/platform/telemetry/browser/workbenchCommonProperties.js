...
define(["require", "exports", "vs/base/common/platform", "vs/base/common/uuid", "vs/platform/telemetry/common/telemetryUtils", "vs/base/common/objects"], function (require, exports, Platform, uuid, telemetryUtils_1, objects_1) {
    "use strict";
    ...
    function resolveWorkbenchCommonProperties(storageService, commit, version, remoteAuthority, resolveAdditionalProperties) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let machineId = storageService.get(exports.machineIdKey, 0 /* GLOBAL */);
            if (!machineId) {
                machineId = uuid.generateUuid();
                storageService.store(exports.machineIdKey, machineId, 0 /* GLOBAL */);
            }
            /**
