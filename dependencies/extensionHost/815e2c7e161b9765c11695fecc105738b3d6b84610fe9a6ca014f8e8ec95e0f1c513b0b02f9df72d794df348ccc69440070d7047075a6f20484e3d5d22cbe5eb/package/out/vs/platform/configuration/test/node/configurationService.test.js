...
define(["require", "exports", "assert", "os", "vs/base/common/path", "fs", "vs/platform/registry/common/platform", "vs/platform/configuration/node/configurationService", "vs/base/common/uuid", "vs/platform/configuration/common/configurationRegistry", "vs/base/test/node/utils", "vs/base/common/uri"], function (require, exports, assert, os, path, fs, platform_1, configurationService_1, uuid, configurationRegistry_1, utils_1, uri_1) {
    ...
    suite('ConfigurationService - Node', () => {
        test('simple', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('config gets flattened', () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield utils_1.testFile('config', 'config.json');
        ...
        test('error case does not explode', () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield utils_1.testFile('config', 'config.json');
        ...
        test('missing file does not explode', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('trigger configuration change event', () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield utils_1.testFile('config', 'config.json');
            const service = new configurationService_1.ConfigurationService(uri_1.URI.file(res.testFile));
            yield service.initialize();
        ...
        test('reloadConfiguration', () => __awaiter(void 0, void 0, void 0, function* () {
            const res = yield utils_1.testFile('config', 'config.json');
            fs.writeFileSync(res.testFile, '{ "foo": "bar" }');
            const service = new configurationService_1.ConfigurationService(uri_1.URI.file(res.testFile));
            yield service.initialize();
        ...
        test('model defaults', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return utils_1.testFile('config', 'config.json').then((res) => __awaiter(void 0, void 0, void 0, function* () {
                fs.writeFileSync(res.testFile, '{ "testworkbench.editor.tabs": true }');
                const service = new configurationService_1.ConfigurationService(uri_1.URI.file(res.testFile));
        ...
        test('lookup with null', () => __awaiter(void 0, void 0, void 0, function* () {
            const configurationRegistry = platform_1.Registry.as(configurationRegistry_1.Extensions.Configuration);
            configurationRegistry.registerConfiguration({
                'id': '_testNull',
                'type': 'object',
