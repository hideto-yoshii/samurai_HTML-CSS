...
define(["require", "exports", "vs/nls", "vs/base/common/platform", "vs/platform/environment/common/environment", "electron", "vs/platform/windows/common/windows", "vs/platform/configuration/common/configuration", "vs/platform/telemetry/common/telemetry", "vs/platform/update/common/update", "vs/platform/product/common/product", "vs/base/common/async", "vs/platform/log/common/log", "vs/base/common/labels", "vs/platform/windows/electron-main/windows", "vs/platform/workspaces/electron-main/workspacesHistoryMainService", "vs/platform/menubar/node/menubar", "vs/base/common/uri", "vs/platform/state/node/state", "vs/platform/lifecycle/electron-main/lifecycleMainService", "vs/platform/electron/electron-main/electronMainService"], function (require, exports, nls, platform_1, environment_1, electron_1, windows_1, configuration_1, telemetry_1, update_1, product_1, async_1, log_1, labels_1, windows_2, workspacesHistoryMainService_1, menubar_1, uri_1, state_1, lifecycleMainService_1, electronMainService_1) {
    ...
    let Menubar = class Menubar {
        ...
        addFallbackHandlers() {
            // File Menu Items
            this.fallbackMenuHandlers['workbench.action.files.newUntitledFile'] = () => this.windowsMainService.openEmptyWindow(2 /* MENU */);
            this.fallbackMenuHandlers['workbench.action.newWindow'] = () => this.windowsMainService.openEmptyWindow(2 /* MENU */);
        ...
        install() {
            ...
            if (platform_1.isMacintosh && !this.appMenuInstalled) {
                ...
                dockMenu.append(new electron_1.MenuItem({ label: this.mnemonicLabel(nls.localize({ key: 'miNewWindow', comment: ['&& denotes a mnemonic'] }, "New &&Window")), click: () => this.windowsMainService.openEmptyWindow(1 /* DOCK */) }));
            ...
            const quit = new electron_1.MenuItem(this.likeAction('workbench.action.quit', {
                label: nls.localize('miQuit', "Quit {0}", product_1.default.nameLong), click: () => {
                    ...
                    if (this.windowsMainService.getWindowCount() === 0 || // allow to quit when no more windows are open
                     ...
                     ((_a = lastActiveWindow) === null || _a === void 0 ? void 0 : _a.isMinimized()) // allow to quit when window has no focus but is minimized (https://github.com/Microsoft/vscode/issues/63000)
                    ) {
        ...
        runActionInRenderer(invocation) {
            ...
            if (!activeBrowserWindow) {
                const lastActiveWindow = this.windowsMainService.getLastActiveWindow();
                if ((_a = lastActiveWindow) === null || _a === void 0 ? void 0 : _a.isMinimized()) {
            ...
            if (activeWindow) {
                ...
                if (invocation.type === 'commandId') {
                    activeWindow.sendWhenReady('vscode:runAction', { id: invocation.commandId, from: 'menu' });
                }
                else {
                    activeWindow.sendWhenReady('vscode:runKeybinding', { userSettingsLabel: invocation.userSettingsLabel });
                }
            }
            else {
        ...
        withKeybinding(commandId, options) {
            ...
            if ((_a = binding) === null || _a === void 0 ? void 0 : _a.label) {
